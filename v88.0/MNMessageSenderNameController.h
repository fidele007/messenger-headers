...
@class MNMessageSenderNameLabel, NSString;

@interface MNMessageSenderNameController : NSObject <MNMessageCellElementController> {

	MNMessageSenderNameLabel* _nameLabel;
