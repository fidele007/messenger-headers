...
@interface FBMemMediaUploadedByUserMediaSet : FBWildeMemModelObject <FBQueriedNodeFieldsProtocol, FBQueriedEntityFieldsProtocol, FBQueriedMediaSetFieldsProtocol>
@end
