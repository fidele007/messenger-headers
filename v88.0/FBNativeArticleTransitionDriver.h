...
+(SCD_Struct_FB94)transitionAnimationConfiguration;
...
-(void)_finishTransitionForStoryBlock:(id)arg1 withTrackingVelocity:(CGPoint*)arg2 animation:(SCD_Struct_FB94)arg3 ;
...
-(SCD_Struct_FB94)_transitionAnimationConfigurationForStoryBlock:(id)arg1 withVelocity:(double)arg2 ;
...
-(void)performTransitionToPresentationAttributes:(id)arg1 onBlock:(id)arg2 animation:(SCD_Struct_FB94)arg3 ;
