...
@interface FNFPlayerLayer : CAEAGLLayer <FNFDecompressionSessionDelegate, FNFPlayerDisplayEngine, FNFAVPlayerLayer> {
	...
	SCD_Struct_FB20 _bufferTimes[60];
...
-(id)initWithConfigs:(SCD_Struct_FB497)arg1 ;
...
-(void)_addBuffer:(CVBufferRef)arg1 presentationTimeStamp:(SCD_Struct_FB20)arg2 iFrameEnqueued:(unsigned long long)arg3 ;
-(void)display:(CVBufferRef)arg1 presentationTimeStamp:(SCD_Struct_FB20)arg2 presentationDuration:(SCD_Struct_FB20)arg3 iFrameEnqueued:(unsigned long long)arg4 ;
