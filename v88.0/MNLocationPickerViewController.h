...
@interface MNLocationPickerViewController : FBContainerViewController <MNLocationPickerViewDelegate, MNLocationPickerNearbyPlacesViewControllerDelegate, UISearchDisplayDelegate, FBKeyboardObserverDelegate, UISearchBarDelegate, FBClassProvidable, MNLocationPickerViewControlling> {
