...
@interface MNEmptySecureThreadService : NSObject <MNSecureThreadServiceControlling, MNSecureImageRequesting, MNSecureMessagingDeviceInformation, MNSecureMessagingCapabilityManualOverriding>
