...
-(BOOL)trySubscribeToRemoteVideoStream:(id)arg1 isPinned:(BOOL)arg2 ;
...
-(void)startPausedLiveWithCallWithBroadcastId:(id)arg1 callabilityStatus:(id)arg2 isLandscape:(BOOL)arg3 analyticsExtra:(id)arg4 ;
