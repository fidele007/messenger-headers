...
@class NSMutableSet, FBExceptionHandler, NSMutableDictionary, NSString;

@interface FBPublishingStatusCrashReportLogger : NSObject <FBComposerPublisherStatusListener> {

	NSMutableSet* _completedPublicationsAwaitingRemoval;
	FBExceptionHandler* _exceptionHandler;
	NSMutableDictionary* _recentEventsByPublicationIdentifier;
