...
-(id)initWithVideoRecorder:(id)arg1 orientationTracker:(id)arg2 messengerCodeManager:(id)arg3 loggedInUserInfoManager:(id)arg4 modalPresenter:(id)arg5 applicationName:(id)arg6 soundController:(id)arg7 analytics:(id)arg8 ;
