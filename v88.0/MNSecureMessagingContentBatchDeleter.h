...
@class MNSecureMessagingStore, MNBouncedMessageTracker;
...
-(id)initWithSecureMessagingStore:(id)arg1 bouncedMessageTracker:(id)arg2 secureThreadListener:(id)arg3 ;
@end
