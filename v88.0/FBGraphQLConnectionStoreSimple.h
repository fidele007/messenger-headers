...
-(id)initWithConnectionStore:(id)arg1 consistentLookasideCache:(id)arg2 edgeHandler:(id)arg3 deleteController:(id)arg4 initialNodes:(id)arg5 fieldSet:(const FBGraphQLFieldSetRef)arg6 ;
