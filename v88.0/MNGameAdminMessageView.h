...
@class FBLazyCreator, MNGenericFoldableAdminMessageView, MNCDNProfileImageDownloader, FBMMessageKey, NSString;
...
-(id)initWithFrame:(CGRect)arg1 gamePresenterProvider:(id)arg2 profileImageDownloader:(id)arg3 imageDownloader:(id)arg4 ;
