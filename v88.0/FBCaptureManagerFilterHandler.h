...
@protocol FBVideoCreativeToolsApplier, OS_dispatch_queue, FBVideoCreativeToolsApplierVideoOutputDelegate;
...
@interface FBCaptureManagerFilterHandler : NSObject <FBCaptureManagerFilterHandlerProtocol, FBVideoCreativeToolsApplier> {
	...
	id<FBVideoCreativeToolsApplier> _filterApplier;
...
-(id)initWithSession:(id)arg1 filterApplier:(id)arg2 ;
