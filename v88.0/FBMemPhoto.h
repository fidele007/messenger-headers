...
@interface FBMemPhoto : FBWildeMemModelObject <FBRichStoryEntityMediaProtocol, FBDisplayableMedia, FBFeedbackTargetProtocol, FBPhotoTaggingAssetProtocol, FBSearchPivotsSource, FBShareable, FBQueriedNodeFieldsProtocol, FBQueriedEntityFieldsProtocol, FBQueriedMediaFieldsProtocol, FBQueriedProfileOverlayableMediaFieldsProtocol, FBQueriedSearchResultFieldsProtocol, FBQueriedGoodwillThrowbackAccentImageFieldsProtocol, FBQueriedSearchCombinedResultFieldsProtocol>
