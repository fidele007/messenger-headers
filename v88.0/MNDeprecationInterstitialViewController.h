...
@class MNDeprecationInterstitialView, MNDeprecationInterstitialViewModel, NSString;

@interface MNDeprecationInterstitialViewController : UIViewController <MNDeprecationInterstitialViewDelegate, FBClassProvidable> {
