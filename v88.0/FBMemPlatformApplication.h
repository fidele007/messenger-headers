...
@interface FBMemPlatformApplication : FBWildeMemModelObject <FBAvatarProtocol, FBQueriedNodeFieldsProtocol, FBQueriedEntityFieldsProtocol, FBQueriedProfileFieldsProtocol, FBQueriedSearchableFieldsProtocol, FBQueriedSearchResultFieldsProtocol, FBQueriedPayProfileFieldsProtocol, FBQueriedSearchCombinedResultFieldsProtocol>
+(id)graphQLTypeName;
-(id)iOSAppStoreID;
-(id)entityURL;
