...
@interface FBPushNotificationInputPushNotification : FBGraphQLInput {
...
@property (o,nonatomic,copy) NSNumber * o;                        //@synthesize o=_o - In the implementation block
@property (nonatomic,copy) NSNumber * href;                       //@synthesize href=_href - In the implementation block
...
-(NSNumber *)o;
-(void)setO:(NSNumber *)arg1 ;
-(NSNumber *)href;
-(void)setHref:(NSNumber *)arg1 ;
-(NSNumber *)uid;
