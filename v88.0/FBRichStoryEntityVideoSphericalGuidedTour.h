...
#import <Messenger/FBRichStoryEntitySphericalVideoGuidedTourProtocol.h>

@class NSArray;

@interface FBRichStoryEntityVideoSphericalGuidedTour : NSObject <FBRichStoryEntitySphericalVideoGuidedTourProtocol> {
