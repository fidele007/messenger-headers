...
@class FBUserSession, NSString, FBScenePath, FBFontFoundry, NSDictionary, FBFeedCustomizationSet, FBFeedSecondaryActionContext;
...
-(id)initWithSession:(id)arg1 navigationCoordinator:(id)arg2 intentHandler:(id)arg3 layoutIdiom:(unsigned long long)arg4 analyticsModule:(id)arg5 scenePath:(id)arg6 fontFoundry:(id)arg7 optionalDependencies:(id)arg8 feedCustomizationSet:(id)arg9 ;
