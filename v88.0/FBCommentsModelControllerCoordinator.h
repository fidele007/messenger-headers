...
@class FBCommentsModelControllerCoordinatorListenerAnnouncer, FBCommentsModelControllerCoordinatorAnalyticsListenerAnnouncer, FBMemModelObject, FBCommentAuthorFetchController, FBCKStreamLoadResult, FBCKCommentsStore, FBCKStream, FBCommentPublisher, FBCommentEditor, FBCommentDeleter, FBCommentUnhider, FBCommentsRefresher, FBScenePath, FBCommentsModelControllerConfiguration, FBUserSession, NSArray, NSString;

@interface FBCommentsModelControllerCoordinator : NSObject <FBCKCommentsStoreDelegate, FBStreamListener, FBCommentPublisherDelegate, FBCommentEditorDelegate, FBCommentDeleterDelegate, FBCommentUnhiderDelegate, FBCommentsRefresherDelegate, FBCKStreamResponseHandlerProcessingDelegate> {
	...
	SCD_Struct_FB103 _requiredFetchLimit;
...
@property (nonatomic,readonly) SCD_Struct_FB103 requiredFetchLimit;                                                          //@synthesize requiredFetchLimit=_requiredFetchLimit - In the implementation block
...
-(SCD_Struct_FB103)requiredFetchLimit;
-(void)setLifecycleManager:(id<FBCommentsModelControllerCoordinatorLifecycleManaging>)arg1 ;
-(void)registerRequiredFetchLimit:(SCD_Struct_FB103)arg1 ;
