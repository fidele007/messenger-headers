...
@interface MNPaymentsSendMoneyViewController : UIViewController <FBModalWebFlowDelegate, FBKeyboardObserverDelegate, FBPaymentsExpandableViewControllerExpandingDelegate, FBPaymentsNavigationDelegate, FBPaymentsUpdateListener, FBPaymentsPurchaseInfoExtensionControllerDelegate, FBPaymentsOrderSummaryControllingDelegate, FBPaymentsCheckoutOtherButtonHandlingDelegate, MNPaymentsThemeViewControllerDelegate, FBPaymentsCheckoutExplanationInfoViewDelegate, MNPaymentsTwoActionTabViewDelegate, FBPaymentsExpandableItem, FBPaymentsCheckoutRequestHandlingPaymentProcessingDelegate> {
