...
@interface MNMultiPeoplePickerViewController : FBContainerViewController <MNMultiPeoplePickerViewDelegate, MNPeoplePickerSearchBarViewControllerDelegate, MNPeoplePickerSearchBarViewControllerActionButtonDelegate, MNProfileImageListViewControllerDelegate, FBKeyboardObserverDelegate, MNPeoplePickerSearchBarViewControllerSearchBarDataSource, FBClassProvidable> {
