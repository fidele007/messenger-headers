...
@interface FBVideoCommentUploadListener : NSObject <FBComposerPublisherStatusListener> {

	PromiseEither<NSError *, NSString *>* _promise;
...
-(id)initWithPromise:(PromiseEither<NSError *, NSString *>*)arg1 ;
@end
