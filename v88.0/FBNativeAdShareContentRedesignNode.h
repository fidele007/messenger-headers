...
@class FBNativeAdShareContentRedesignNodeMetrics, FBNativeAdCTAButtonNodeMetrics, UIImageView, ASDisplayNode, ASTextNode, ASNetworkImageNode, FBNativeAdRedesignFooterNode, FBNativeAdRedesignTwoStepFooterNode, NSString;
