...
@class FBVideoPlaybackItem, FBMultiresolutionImageNode, FBVideoPlaybackController, ASDisplayNode, NSTimer, NSMapTable, FBUserSession, FB360VideoCamera, NSString;
