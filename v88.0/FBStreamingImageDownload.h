...
-(id)initWithURL:(id)arg1 scenePath:(id)arg2 priority:(long long)arg3 options:(unsigned long long)arg4 desiredImageFlag:(unsigned long long)arg5 imageFlagsToBeNotified:(unsigned long long)arg6 analyticsTags:(id)arg7 callbackQueue:(id)arg8 streamingBlock:(/*^block*/id)arg9 withLastImageFlagFix:(BOOL)arg10 ;
