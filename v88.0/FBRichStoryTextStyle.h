...
@interface FBRichStoryTextStyle : NSObject {
	...
	SCD_Struct_FB301 _innerPadding;
	SCD_Struct_FB301 _margins;
...
@property (assign,nonatomic) SCD_Struct_FB301 innerPadding;                       //@synthesize innerPadding=_innerPadding - In the implementation block
@property (assign,nonatomic) SCD_Struct_FB301 margins;                            //@synthesize margins=_margins - In the implementation block
...
+(id)styleWithFontName:(id)arg1 color:(id)arg2 backgroundColor:(id)arg3 alignment:(long long)arg4 innerPadding:(SCD_Struct_FB301)arg5 margins:(SCD_Struct_FB301)arg6 displayStyle:(unsigned long long)arg7 borders:(FBBorderMetrics*)arg8 capitalizationStyle:(unsigned long long)arg9 underlineStyle:(unsigned long long)arg10 fontSizeMultiplier:(double)arg11 lineHeightMultiplier:(double)arg12 ;
-(unsigned long long)underlineStyle;
-(SCD_Struct_FB301)innerPadding;
-(void)setInnerPadding:(SCD_Struct_FB301)arg1 ;
...
-(SCD_Struct_FB301)margins;
-(void)setMargins:(SCD_Struct_FB301)arg1 ;
