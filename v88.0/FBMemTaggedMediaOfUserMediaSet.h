...
@interface FBMemTaggedMediaOfUserMediaSet : FBWildeMemModelObject <FBQueriedNodeFieldsProtocol, FBQueriedEntityFieldsProtocol, FBQueriedMediaSetFieldsProtocol>
-(id)canViewerEdit;
