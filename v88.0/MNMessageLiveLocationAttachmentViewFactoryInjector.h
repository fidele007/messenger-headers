...
@class FBProviderMapData, FBUserSession, MNMessageLiveLocationUpdater, MNMessageLiveLocationConfigManager, MNDateFormatter, NSString;
...
@property (nonatomic,readonly) MNMessageLiveLocationUpdater * messageLiveLocationUpdater;              //@synthesize messageLiveLocationUpdater=_messageLiveLocationUpdater - In the implementation block
...
-(MNMessageLiveLocationUpdater *)messageLiveLocationUpdater;
