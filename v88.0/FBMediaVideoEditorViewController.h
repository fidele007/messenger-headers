...
@property (assign,nonatomic) SCD_Struct_FB20 videoMinLength; 
@property (assign,nonatomic) SCD_Struct_FB20 videoMaxLength; 
...
-(id)initWithVideoManager:(id)arg1 sessionId:(id)arg2 source:(id)arg3 rightBarButtonTitle:(id)arg4 style:(unsigned long long)arg5 ;
