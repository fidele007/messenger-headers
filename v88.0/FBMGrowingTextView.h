...
@class FBMTextViewInternal, FBGrowingTextViewHeightCalculator, NSArray, NSString, NSAttributedString, UITextView, UIColor, UIFont;

@interface FBMGrowingTextView : UIView <MNComposerTextViewConfiguring, FBMTextViewInternalDelegate, UITextViewDelegate> {
...
@property (assign,nonatomic) unsigned long long minNumberOfLines; 
