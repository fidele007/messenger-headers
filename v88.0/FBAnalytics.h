...
#import <Messenger/FBGraphQLPagedDownloadingAnalytics.h>
...
+(void)logEmailCTASelectionUpdateEvent:(id)arg1 ;
+(void)logEmailCTARevealEvent:(id)arg1 ;
+(void)logEmailCTAListExpansionEvent:(BOOL)arg1 ctaID:(id)arg2 ;
...
-(void)logEvent:(id)arg1 module:(id)arg2 extra:(id)arg3 timestamp:(double)arg4 contextType:(unsigned long long)arg5 ;
