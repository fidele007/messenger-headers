...
@property (nonatomic,retain) Class eventClass;                                     //@synthesize eventClass=_eventClass - In the implementation block
@property (nonatomic,copy) NSString * eventType;                                   //@synthesize eventType=_eventType - In the implementation block
@property (assign,nonatomic) BOOL eventBubbles;                                    //@synthesize eventBubbles=_eventBubbles - In the implementation block
...
-(void)onChangeDispatchEventOfClass:(Class)arg1 eventType:(id)arg2 bubbles:(BOOL)arg3 ;
...
-(void)setEventBubbles:(BOOL)arg1 ;
