...
-(id)initWithAllowTagging:(BOOL)arg1 allowFaceDetection:(BOOL)arg2 maxPhotosSelected:(unsigned long long)arg3 requireSquarePhoto:(BOOL)arg4 allowFullScreenPhotoViewing:(BOOL)arg5 allowPhotoEditing:(BOOL)arg6 cpuFiltersEnabled:(BOOL)arg7 autoNavigationEnabled:(BOOL)arg8 longPressToBringUpGalleryView:(BOOL)arg9 postSelectionAction:(unsigned long long)arg10 actionButtonTitle:(id)arg11 maxVideoLength:(unsigned long long)arg12 maxVideoSize:(unsigned long long)arg13 stickersAllowed:(BOOL)arg14 textOnPhotosAllowed:(BOOL)arg15 doodlesOnPhotosAllowed:(BOOL)arg16 canSelectMultiplePhotosAndVideos:(BOOL)arg17 canShowMovies:(BOOL)arg18 minVideoResolution:(CGSize)arg19 allowVideoAutoplay:(BOOL)arg20 allowVideoTagging:(BOOL)arg21 allowVideoFaceDetection:(BOOL)arg22 forceShowingCheckMarkForThumbnails:(BOOL)arg23 showPreviewForPhotoAfterCamera:(BOOL)arg24 hasMediaAttachmentsNotIncludedInMediaPicker:(BOOL)arg25 allowProductTagging:(BOOL)arg26 allowVideoEditing:(BOOL)arg27 lightWeightCropEnabled:(BOOL)arg28 canShowMagicStories:(BOOL)arg29 livePhotoAllowed:(BOOL)arg30 tapToBringUpGalleryView:(BOOL)arg31 initialToolForMediaGallery:(unsigned long long)arg32 forceHighQualityVideo:(BOOL)arg33 showCropAfterSelectingPhoto:(BOOL)arg34 allowPaging:(BOOL)arg35 allowFixedCropFrameForMediaGallery:(BOOL)arg36 showCropAfterCamera:(BOOL)arg37 showPreviewForVideoAfterCamera:(BOOL)arg38 ctaType:(unsigned long long)arg39 analyticsSource:(id)arg40 usePushNavigationForCamera:(BOOL)arg41 capturePosition:(long long)arg42 support360Video:(BOOL)arg43 annotate360Photos:(BOOL)arg44 supports360Photos:(BOOL)arg45 supportsAnimatedGIFs:(BOOL)arg46 switchIconsForCameraButton:(BOOL)arg47 infinitelyLoopingIconsForCameraButton:(BOOL)arg48 multiSelectEnabled:(BOOL)arg49 showBackButton:(BOOL)arg50 shouldUseProfilePictureAsLoggerSource:(BOOL)arg51 ;
