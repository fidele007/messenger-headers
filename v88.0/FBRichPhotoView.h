...
@class UIButton, FBTagDecorator, NSDate, NSMutableSet, UIView, FBZoomingPhotoView, FBPhotosConsumptionReferrer, FBUserSession, FBPhotoLoadingProgressView, UIActivityIndicatorView, FBWebLivePhotoSupportingView, FBLivePhotoBadgeView, FBMemPhoto, FBScenePath, NSTimer, FBMemModelObject, NSString, FBPhotoTaggingSearchController, FBWebPhotoView, UIImage, NSSet;
