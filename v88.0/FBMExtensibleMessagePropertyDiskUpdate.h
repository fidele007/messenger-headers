...
@class FBMSyncedThreadKey, FBMMessageKey, FBMExtensibleMessagePropertyDiskUpdateData;
...
-(id)initWithSyncedThreadKey:(id)arg1 messageKey:(id)arg2 jobData:(id)arg3 ;
