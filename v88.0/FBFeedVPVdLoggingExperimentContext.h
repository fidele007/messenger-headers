...
@property (nonatomic,readonly) BOOL isRetryingItemViewStateRecordingEnabled;              //@synthesize isRetryingItemViewStateRecordingEnabled=_isRetryingItemViewStateRecordingEnabled - In the implementation block
...
-(BOOL)isRetryingItemViewStateRecordingEnabled;
