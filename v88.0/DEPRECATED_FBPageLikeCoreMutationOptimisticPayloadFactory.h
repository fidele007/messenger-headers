...
#import <Messenger/FBPageLikeMutationOptimisticPayloadFactoryProtocol.h>

@class FBMemPage, NSString;

@interface DEPRECATED_FBPageLikeCoreMutationOptimisticPayloadFactory : NSObject <FBPageLikeMutationOptimisticPayloadFactoryProtocol> {
