...
@property (assign,nonatomic) SCD_Struct_FB22 timeRange;                                           //@synthesize timeRange=_timeRange - In the implementation block
...
-(SCD_Struct_FB20)_timeForFrameIndex:(unsigned long long)arg1 ;
...
-(void)setTimeRange:(SCD_Struct_FB22)arg1 ;
-(double)framerate;
