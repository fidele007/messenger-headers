...
@interface MQFaceNodeBase : SCNNode {
	...
	SCD_Struct_MQ1063* _vertices;
	NSData* _indicesData;
	NSData* _verticesData;

}

@property (assign,nonatomic) SCD_Struct_MQ1063* vertices;              //@synthesize vertices=_vertices - In the implementation block
...
-(void)dealloc;
-(void)setVertices:(SCD_Struct_MQ1063*)arg1 ;
-(SCD_Struct_MQ1063*)vertices;
