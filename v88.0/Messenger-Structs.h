...
@class CKComponent, NSDictionary, FBInlineVoiceSwitcherViewModel, FBUFITheme, NSString, <FBDisplayableMediaViewProvider>, UIColor, UIImage, NSMutableDictionary, FBNativeArticleController, FBMemModelObject<FBQueriedNodeFieldsProtocol>, NSError, FBScenePath, NSArray, <FBWebImageViewLayoutDelegate>, FBGraphQLLiveQuery, FBDisplayableMediaViewProviderContext, CAMediaTimingFunction, UIFont, FBImageDownloader, NSAttributedString, CKComponentScopeRoot, <NSObject>, NSCharacterSet, <NSLayoutManagerDelegate>, FBVideoAssetEdits, FBVideoExportConfig, AVAssetReader, AVAssetTrack, AVAssetReaderOutput, AVAssetWriterInput, AVAssetWriter, NSURL, <MNServiceControllable>, NSURLRequest, NSData, FBRtmpSession, FBAACEncoder, <FBVideoEncoder>, FBAACPacketizer, FBH264Packetizer, FBDiskVideoRecorder, NSObject<OS_dispatch_queue>, NSNumber;
...
typedef struct MontageComposerMobileConfig {
	BOOL enabled;
	BOOL livePreviewEnabled;
	BOOL blurrySearchBarBackground;
	double initialBackgroundAlpha;
	double extraHeight;
} MontageComposerMobileConfig;

typedef struct MontageComposerConfig {
	BOOL enabled;
...
typedef union GLKMatrix4 {
	SCD_Struct_FB17 field1;
	float m[16];
} GLKMatrix4;

typedef struct {
	SCD_Struct_FB16 field1;
	SCD_Struct_FB16 field2;
} SCD_Struct_FB19;
...
typedef union GLKVector3 {
	SCD_Struct_FB107 field1;
	SCD_Struct_FB107 field2;
	SCD_Struct_FB107 field3;
	float v[3];
} GLKVector3;
...
typedef union GLKQuaternion {
	SCD_Struct_FB109 field1;
	SCD_Struct_FB110 field2;
	float q[4];
} GLKQuaternion;
...
typedef struct LiveQuerySubscriber {
	/*function pointer*/void* _vptr$Subscriber;
...
typedef struct {
	SCD_Struct_FB300 top;
	SCD_Struct_FB300 left;
	SCD_Struct_FB300 bottom;
	SCD_Struct_FB300 right;
} SCD_Struct_FB301;
...
typedef struct {
	SCD_Struct_AS383 field1;
	SCD_Struct_AS383 field2;
} SCD_Struct_AS384;
...
typedef struct EventBase {
	...
	list<folly::EventBase::LoopCallback, boost::intrusive::constant_time_size<false>, void, void, void> runAfterDrainCallbacks_;
...
typedef struct FBMediaAttachmentUploadQualityPolicy {
	unsigned long long quality;
	BOOL forceQuality;
} FBMediaAttachmentUploadQualityPolicy;
...
typedef struct FBCaptureManagerConfiguration {
	...
	BOOL trackFramePerformance;
	BOOL useAnalyticsPerfLogger;
} FBCaptureManagerConfiguration;

typedef struct FBCameraActionPerformanceLoggingConfiguration {
	BOOL logWithAnalyticsPerformanceLogger;
	BOOL logWithQuickPerformanceLogger;
} FBCameraActionPerformanceLoggingConfiguration;
...
typedef union GLKVector2 {
	SCD_Struct_FB634 field1;
	SCD_Struct_FB634 field2;
	float v[2];
} GLKVector2;
...
typedef struct {
	compressed_pair<double *, std::__1::allocator<double> > field1;
	FBAudioStreamingConfig field2;
	FBAdaptiveBitrateConfig field3;
	FBVideoStreamingConfig field4;
	SCD_Struct_FB816 field5;
	SCD_Struct_FB828 field6;
	SCD_Struct_FB859 field7;
	BOOL field8;
	int field9;
	BOOL field10;
} SCD_Struct_FB873;
...
typedef struct {
	SCD_Struct_FB20 field1;
	SCD_Struct_FB20 field2;
	SCD_Struct_FB20 field3;
	SCD_Struct_FB20 field4;
	double field5;
	double field6;
	unsigned long long field7;
	unsigned long long field8;
	SCD_Struct_FB20 field9;
...
typedef struct FNFPlayerState {
	...
	SCD_Struct_FB20 latestEnqueuedVideoPts;
	SCD_Struct_FB20 latestEnqueuedAudioPts;
	SCD_Struct_FB20 latestEnqueuedAudioDts;
	id playbackTimeObserverForAsset;
	id durationTimerForAsset;
	id stallTimerObserver;
	id sampleBufferFlushTimerObserver;
	SCD_Struct_FB20 backgroundPauseTime;
...
typedef struct FBFramePerformanceTrackerConfig {
	...
	unsigned long long singleFrameTime;
...
typedef struct FBAnimationPerformanceTrackerConfiguration {
...
} FBAnimationPerformanceTrackerConfiguration;
