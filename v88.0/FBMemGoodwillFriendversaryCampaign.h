...
@interface FBMemGoodwillFriendversaryCampaign : FBWildeMemModelObject <FBQueriedNodeFieldsProtocol, FBQueriedEntityFieldsProtocol, FBQueriedGoodwillCampaignFieldsProtocol>
-(id)photoAttachments;
-(id)campaignID;
