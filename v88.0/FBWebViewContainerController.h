...
#import <Messenger/FBMinimizableModalViewController.h>

@protocol FBNuxBannerViewController, FBCancelable, FBBrowserSurface, FBMinimizableModalViewControllerDelegate, FBWebViewContainerControllerDelegate, FBBrowserScrollViewDelegate, FBWebViewContainerControllerBannerProvider, FBIntentHandler;
