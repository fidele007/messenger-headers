...
#import <Messenger/FBRichStoryEntitySphericalVideoGuidedTourKeyframeProtocol.h>

@interface FBRichStoryEntityVideoSphericalGuidedTourKeyframe : NSObject <FBRichStoryEntitySphericalVideoGuidedTourKeyframeProtocol> {
