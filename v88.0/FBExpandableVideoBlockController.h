...
-(void)_setAnnotationsVisible:(BOOL)arg1 withAnimationConfiguration:(SCD_Struct_FB94)arg2 ;
...
-(void)_showLoadingIndicatorWithAnimationConfiguration:(SCD_Struct_FB94)arg1 ;
-(SCD_Struct_FB94)_fadeAnimationConfiguration;
...
-(void)_hideLoadingIndicatorWithAnimationConfiguration:(SCD_Struct_FB94)arg1 ;
