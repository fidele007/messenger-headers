...
@interface MNMessageSendAutoRetryConfiguration : FBValueObject <NSCopying> {
	...
	/*^block*/id _allowsInfiniteRetryBlock;
...
@property (nonatomic,readonly) id allowsInfiniteRetryBlock;                                    //@synthesize allowsInfiniteRetryBlock=_allowsInfiniteRetryBlock - In the implementation block
