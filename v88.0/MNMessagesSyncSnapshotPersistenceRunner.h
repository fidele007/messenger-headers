...
-(id)initWithPersistenceCoordinator:(id)arg1 threadSummaryListCacheFilter:(id)arg2 threadListContinuityTracker:(id)arg3 inMemoryThreadMessageCache:(id)arg4 persistenceJobBuilderBlock:(/*^block*/id)arg5 ;
@end
