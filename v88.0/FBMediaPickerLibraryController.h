...
@class FBMediaPickerSession, NSMutableDictionary, UICollectionView, FBMagicStoriesPreviewViewController, FBKVOController, UIView, FBPinchGestureRecognizer, FBAnimationPerformanceLogger, FBMagicStoryPickerCollectionDataSource, FBMediaPickerThumbnailDownloaderFactory, UILabel, FBScrollViewVideoCoordinator, NSMutableArray, MNVideoTrimExperimentContext, UIImage, FBLibraryThumbnailView, FBAssetsRankedDataSource, NSArray, NSString;
...
@interface FBMediaPickerLibraryController : NSObject <UICollectionViewDataSource, UICollectionViewDelegate, FBLibraryThumbnailViewDelegate, UICollectionViewDelegateFlowLayout, FBMagicStoriesPreviewViewControllerDelegate, FBVideoCoordinatorDataSource> {
	...
	MNVideoTrimExperimentContext* _videoTrimContext;
