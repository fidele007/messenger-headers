...
@interface FBMemTaggedMediaOfFamilyMemberMediaSet : FBWildeMemModelObject <FBQueriedNodeFieldsProtocol, FBQueriedEntityFieldsProtocol, FBQueriedMediaSetFieldsProtocol>
-(id)canViewerEdit;
