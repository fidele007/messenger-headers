...
@class FBUserSession, FBMGlobalMuter, NSNumber, MNUserSettings, OrcaPushRegistrar, MNErrorToastFactory, MNGlobalMutePicker, MNSettingsView, NSArray, MNSettingsOptionSelectorViewController, FBMobileConfigContextManager, NSString;
