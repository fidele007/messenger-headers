...
@interface FBMSPApprovalModeDeltaHandler : NSObject <FBViewerContextClassProvidable, MNMessagesSyncIrisDeltaProcessing> {
...
-(void)_processApprovalModeDelta:(id)arg1 completion:(/*^block*/id)arg2 ;
