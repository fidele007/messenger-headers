...
@interface FBSearchPerfConfig : FBExperimentContext {
	...
	unsigned long long _SERPRequestHardTimeout;
...
@property (setter=ERPRequestHardTimeout,nonatomic,readonly) unsigned long long SERPRequestHardTimeout;              //@synthesize SERPRequestHardTimeout=_SERPRequestHardTimeout - In the implementation block
+(id)universeName;
+(id)parameterConfigurations;
-(BOOL)useGlobalSuggestionCache;
-(BOOL)useRecentSearchesInBootstrap;
-(unsigned long long)SERPRequestHardTimeout;
@end
