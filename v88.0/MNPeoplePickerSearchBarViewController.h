...
#import <Messenger/MNPeopleCellActionButtonsStateCoordinatorDelegate.h>
...
-(void)peopleCellActionButtonsStateCoordinator:(id)arg1 didUpdateAllActionButtonsToNormalState:(BOOL)arg2 ;
-(void)beginSearching;
