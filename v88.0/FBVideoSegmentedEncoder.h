...
@interface FBVideoSegmentedEncoder : NSObject {
	...
	SCD_Struct_FB20 _segmentDuration;
	BOOL _cancelled;
...
-(id)initWithAssetWriter:(id)arg1 assetReader:(id)arg2 assetInput:(id)arg3 assetOutput:(id)arg4 mediaProcessor:(id)arg5 segmentDuration:(SCD_Struct_FB20)arg6 queue:(id)arg7 ;
-(void)cancelEncoding;
