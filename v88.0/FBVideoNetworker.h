...
-(id)_buildDownloaderWithDataKey:(id)arg1 url:(id)arg2 prefetchURL:(id)arg3 videoID:(id)arg4 scenePath:(id)arg5 priority:(long long)arg6 limitRequestLength:(BOOL)arg7 bypassCaching:(BOOL)arg8 isAudio:(BOOL)arg9 analyticsTags:(id)arg10 ;
