...
@protocol MNAuthenticationManager, FBMNetworkFetchParsedResultMerging, FBMMoreThreadsFetchedListening, OS_dispatch_queue;
@class FBUserSession, MNGraphQLQueryConfigGenerator, MNMessagingRegionHeaderHelper, MNThreadListFetchConfiguration, FBAnalytics, NSObject, NSString;
