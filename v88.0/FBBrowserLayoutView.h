...
#import <Messenger/FBBrowserFooterViewDelegate.h>
...
@interface FBBrowserLayoutView : UIView <UIScrollViewDelegate, FBBrowserFooterViewDelegate> {
	...
	id<FBBrowserLayoutViewDelegate> _browerLayoutViewDelegate;
...
-(void)setSuggestedStories:(id)arg1 ;
...
-(id)initWithWebView:(id)arg1 scrollView:(id)arg2 webViewContentInsetTracker:(id)arg3 browserSurface:(id)arg4 layoutConfig:(id)arg5 browerLayoutViewDelegate:(id)arg6 session:(id)arg7 ;
