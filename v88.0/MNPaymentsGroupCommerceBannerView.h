...
@class MNPaymentsGroupCommerceItemTextView, MNPaymentsGroupCommerceBannerActionsView, UIView, UIButton, MNPaymentsGroupCommerceBannerViewModel, NSString;

@interface MNPaymentsGroupCommerceBannerView : UIView <MNPaymentsView> {

	MNPaymentsGroupCommerceItemTextView* _itemTextView;
