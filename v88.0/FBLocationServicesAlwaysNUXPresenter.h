...
@class FBUserSession, FBFNTopFriendsSharingDataController, FBLocationServicesAlwaysNUXController, NSString, NSDictionary;

@interface FBLocationServicesAlwaysNUXPresenter : NSObject <FBNuxPresenter, FBSelfPresentingNux> {

	FBUserSession* _session;
	FBFNTopFriendsSharingDataController* _dataController;
	FBLocationServicesAlwaysNUXController* _nuxController;
