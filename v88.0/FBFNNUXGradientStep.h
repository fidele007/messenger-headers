...
@class FBUserSession, FBFNNuxAppearanceConfiguration, FBMemPrivacyOption, FBMemPrivacyOptionsLocationConnection, FBFNNUXGradientView;

@interface FBFNNUXGradientStep : FBNuxInterstitial <FBFNNUXStep, FBFNNUXPrivacyOptionsProtocol> {

	FBFNNUXGradientView* _gradientView;
...
-(id)initWithSession:(id)arg1 appearanceConfiguration:(id)arg2 upsellDataSource:(id)arg3 nuxMode:(unsigned long long)arg4 nuxType:(unsigned long long)arg5 ;
