...
@class FBUserSession, MNContactsRetrieverSimpleLogger, MNInvitesCooldownController, MNMultiPeoplePickerViewController, MNInviteListSelectableContactsRetriever, MNAddressBookContactSyncPolicy, MNInvitesViewControllerConfiguration, MNInvitesHeaderView, MNInvitesView, NSString;
