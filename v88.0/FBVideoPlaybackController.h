...
-(void)_safeSeekToTime:(SCD_Struct_FB20)arg1 completionHandler:(/*^block*/id)arg2 ;
...
-(SCD_Struct_FB155)_fetchVideoMetadataForVideoNetworkerAnalysis;
...
-(void)_periodicTimeObserverCallback:(SCD_Struct_FB20)arg1 ;
