...
@class FBUserSession, FBWebRTCCallButtonsExperimentContext, FBWebRTCInCallActivityExperimentContext, FBWebRTCVoicemailButtonActivatedExperimentContext, NSNumber, FBWebRTCButtonPanel, FBWebRTCNavigationBarView, UIButton, FBWebRTCInCallActivityView, NSString;
...
@property (nonatomic,readonly) FBWebRTCInCallActivityView * inCallActivityView;                                  //@synthesize inCallActivityView=_inCallActivityView - In the implementation block
...
-(void)inCallActivityView:(id)arg1 didShowExtendedView:(BOOL)arg2 ;
...
-(FBWebRTCInCallActivityView *)inCallActivityView;
