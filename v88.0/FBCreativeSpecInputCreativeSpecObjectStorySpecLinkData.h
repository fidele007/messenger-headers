...
@class NSArray, NSString, FBCreativeSpecInputCreativeSpecObjectStorySpecLinkDataCallToAction;

@interface FBCreativeSpecInputCreativeSpecObjectStorySpecLinkData : FBGraphQLInput {
	...
	FBCreativeSpecInputCreativeSpecObjectStorySpecLinkDataCallToAction* _callToAction;
...
@property (nonatomic,copy) FBCreativeSpecInputCreativeSpecObjectStorySpecLinkDataCallToAction * callToAction;              //@synthesize callToAction=_callToAction - In the implementation block
...
-(FBCreativeSpecInputCreativeSpecObjectStorySpecLinkDataCallToAction *)callToAction;
...
-(void)setCallToAction:(FBCreativeSpecInputCreativeSpecObjectStorySpecLinkDataCallToAction *)arg1 ;
