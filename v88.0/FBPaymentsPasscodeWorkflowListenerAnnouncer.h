...
#import <Messenger/FBPaymentsPasscodeWorkflowListener.h>

@class NSString;

@interface FBPaymentsPasscodeWorkflowListenerAnnouncer : FBAnnouncerBase <FBPaymentsPasscodeWorkflowListener>
