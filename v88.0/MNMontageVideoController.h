...
@class FBUserSession, MNAppMessage, MNVideoAttachmentViewModel, MNMontageMuteController, FBLazyCreator, FBVideoViewManager, NSString;
...
-(id)initWithMessage:(id)arg1 videoAttachment:(id)arg2 session:(id)arg3 montageMuteController:(id)arg4 ;
-(id)messageView;
