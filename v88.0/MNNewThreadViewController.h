...
-(id)initWithAuthenticationManager:(id)arg1 threadMessengerSender:(id)arg2 composeViewControllerProvider:(id)arg3 messagesViewControllerProvider:(id)arg4 messagesViewPresenter:(id)arg5 messagesViewByDescriptorPresentationStrategyProvider:(id)arg6 canonicalGroupFetcherProvider:(id)arg7 peoplePickerViewControllerProvider:(id)arg8 navigationCoordinator:(id)arg9 keyboardResettingTracker:(id)arg10 userSettings:(id)arg11 threadStore:(id)arg12 threadParticipantFilter:(id)arg13 messageSendAnnouncer:(id)arg14 pendingThreadAnnouncer:(id)arg15 session:(id)arg16 errorToastFactory:(id)arg17 messageSendPerfLogger:(id)arg18 coefficientSuggestedContactsRetriever:(id)arg19 userStore:(id)arg20 actionSheetPresenterProvider:(id)arg21 messageSendNotEligibleAlertController:(id)arg22 omnipickerGating:(id)arg23 flowersBorderComposeControlExtension:(id)arg24 pendingThreadQuerier:(id)arg25 secureMessagingCapabilityQuerier:(id)arg26 composerInteractionCoordinator:(id)arg27 addressBookContactSyncPolicy:(id)arg28 newThreadTopBannerCoordinator:(id)arg29 smsParticipantUserCacheCoordinator:(id)arg30 newThreadAlertCoordinator:(id)arg31 peoplePickerAccessoryDataSource:(id)arg32 contactSyncPermissionChecker:(id)arg33 contactSyncController:(id)arg34 inviteListAddressBookContactsRetriever:(id)arg35 keyCommandHandler:(id)arg36 ;
