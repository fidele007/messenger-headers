...
@interface FBMemEvent : FBWildeMemModelObject <FBQueriedNodeFieldsProtocol, FBQueriedEntityFieldsProtocol, FBQueriedMessagingActorFieldsProtocol, FBQueriedPlaceFieldsProtocol, FBQueriedProfileFieldsProtocol, FBQueriedSearchableFieldsProtocol, FBQueriedSearchResultFieldsProtocol, FBQueriedEventCalenderableFieldsProtocol, FBQueriedSearchCombinedResultFieldsProtocol>
@end
