...
@interface FBMemSyntheticActor : FBWildeMemModelObject <FBAvatarProtocol, FBQueriedNodeFieldsProtocol, FBQueriedEntityFieldsProtocol, FBQueriedActorFieldsProtocol>
-(id)entityURL;
@end
