...
@interface FBMultiPickerVideoAttachment : NSObject <FBVideoAttachmentProtocol, NSCoding, NSCopying> {
	...
	NSURL* _trimmedURL;
	SCD_Struct_FB496 _editsValue;
	SCD_Struct_FB497 _allowEditingValue;
	...
	FBMediaAttachmentUploadQualityPolicy _qualityPolicy;
...
@property (nonatomic,readonly) FBMediaAttachmentUploadQualityPolicy qualityPolicy;                     //@synthesize qualityPolicy=_qualityPolicy - In the implementation block
...
-(id)initWithFBVideoAsset:(id)arg1 dataSourceID:(id)arg2 indexHint:(unsigned long long)arg3 creationDate:(id)arg4 metadata:(id)arg5 qualityPolicy:(FBMediaAttachmentUploadQualityPolicy)arg6 isAnimatedGIF:(BOOL)arg7 ;
-(id)initWithFBVideoAsset:(id)arg1 dataSourceID:(id)arg2 indexHint:(unsigned long long)arg3 creationDate:(id)arg4 metadata:(id)arg5 qualityPolicy:(FBMediaAttachmentUploadQualityPolicy)arg6 isAnimatedGIF:(BOOL)arg7 trimmedURL:(id)arg8 extraUploadParameters:(id)arg9 appGroupContainerURL:(id)arg10 videoURLForExporterOption:(id)arg11 edits:(id)arg12 copyrightState:(id)arg13 ;
...
-(CGSize)assetSize;
-(void)_exportVideoDataWithProgress:(/*^block*/id)arg1 completion:(/*^block*/id)arg2 fileURL:(id)arg3 videoExportConfig:(id)arg4 errorSimulation:(id)arg5 timeRange:(SCD_Struct_FB22)arg6 ;
