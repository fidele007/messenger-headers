...
#import <Messenger/FBFriendRequestCancelMutationOptimisticPayloadFactoryProtocol.h>

@class FBMemPerson, NSString;

@interface DEPRECATED_FBUserFriendRequestCancelCoreMutationOptimisticPayloadFactory : NSObject <FBFriendRequestCancelMutationOptimisticPayloadFactoryProtocol> {
