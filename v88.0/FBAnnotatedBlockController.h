...
@class FBAnnotationOverlayController, FBAnnotationUnderlayController, NSArray, NSMapTable, FBAnnotatedCompositeNode, ASDisplayNode, FBOrientationState, FBRichStoryBlockDisplayContext, FBRichStoryBlock, FBUserSession, FBNABlockAnalyticsLogger, FBTransitionFrameSetter, NSDictionary, NSSet, NSString;
...
-(void)setVisibleOverlayAnnotations:(id)arg1 withAnimation:(SCD_Struct_FB94)arg2 ;
-(BOOL)wantsRotation;
