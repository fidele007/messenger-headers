...
@interface FBEndSessionsData : FBGraphQLInput {
...
@property (nonatomic,copy) NSArray * sessionIds;                          //@synthesize sessionIds=_sessionIds - In the implementation block
...
-(NSArray *)sessionIds;
-(void)setSessionIds:(NSArray *)arg1 ;
