...
#import <Messenger/FBPaymentsCheckoutValidatorFactory.h>
...
@interface MNPaymentsPeerToPeerCheckoutValidatorFactory : NSObject <FBPaymentsCheckoutValidatorFactory> {
