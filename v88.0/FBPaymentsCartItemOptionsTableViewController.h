...
@class FBPaymentsCartItemQuantitySelectionSection, FBPaymentsFormTableViewSection, FBPaymentsCartInfo, FBPaymentsCartItem;

@interface FBPaymentsCartItemOptionsTableViewController : FBPaymentsSectionBasedTableViewController {

	FBPaymentsCartItemQuantitySelectionSection* _quantitySelectionSection;
	FBPaymentsFormTableViewSection* _editablePriceFormSection;
