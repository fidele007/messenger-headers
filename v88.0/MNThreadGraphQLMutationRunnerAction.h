...
@class FBMGroupThreadKey, FBMThreadJoinableGroupInfoClientUpdate, FBStringWithRedactedDescription;
...
-(void)matchUpdateJoinableGroupInfo:(/*^block*/id)arg1 updateThreadDescription:(/*^block*/id)arg2 ;
