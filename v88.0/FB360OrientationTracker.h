...
@interface FB360OrientationTracker : NSObject {
	...
	BOOL _disableVelocityAnimation;
	BOOL _paused;
...
@property (assign,nonatomic) BOOL disableVelocityAnimation;                                    //@synthesize disableVelocityAnimation=_disableVelocityAnimation - In the implementation block
...
-(BOOL)disableVelocityAnimation;
-(void)setDisableVelocityAnimation:(BOOL)arg1 ;
