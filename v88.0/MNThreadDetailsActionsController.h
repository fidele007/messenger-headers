...
@protocol MNSecureMessageSending, MNSecureMessagingDeviceInformation;
...
@interface MNThreadDetailsActionsController : NSObject <FBClassInjectable, MNThreadMutePickerDelegate, UIAlertViewDelegate, MNThreadMembersUpdaterDelegate, MNThreadPhotoEditControllerDelegate, MNThreadCustomizationModalPickerControllerDelegate, MNEphemeralMessageLifeTimePickerDelegate, MNThreadEphemeralitySetterDelegate, MNThreadPhotosViewControllerDelegate, MNThreadDetailsSecureCodenameEditControllerDelegate, MNThreadDetailsViewControllerDelegate, MNThreadDetailsContactViewControllerDelegate> {
...
-(void)_handleDismissBotReviewViewController:(id)arg1 ;
...
-(void)_navigateToBlockOrReportViewForUser:(id)arg1 isReportable:(BOOL)arg2 fromViewController:(id)arg3 ;
