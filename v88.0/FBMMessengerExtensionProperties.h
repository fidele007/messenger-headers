...
-(id)initWithResumeShoppingURLString:(id)arg1 resumeShoppingBannerText:(id)arg2 paymentPrivacyPolicyURLString:(id)arg3 horizontalCTAs:(id)arg4 isStructuredMenuTypeMessageHidden:(BOOL)arg5 ;
