...
@protocol MNSecureMessagingServiceManipulating, MNSimulatedSecureThreadInitiating, MNSecureMessagingRegisteredDeviceStatusUpdateRunning, MNSecureMessagingDeviceInformation;
