...
@interface FBVideoEditingViewController : UIViewController <FBVideoTrimViewDelegate, FBVideoEditingPlaybackViewDelegate, FBVideoVolumeControlViewDelegate, FBAudioSessionManagerClient, UIScrollViewDelegate, FBVideoCreativeToolsApplier, FBVideoFilterViewsUpdateProtocol, FBVideoScrubberViewDelegate> {
	...
	SCD_Struct_FB20 _videoMinLength;
	SCD_Struct_FB20 _videoMaxLength;
	SCD_Struct_FB20 _frameOffset;
	SCD_Struct_FB20 _keyTime;
...
@property (assign,nonatomic) SCD_Struct_FB20 keyTime;                                                                     //@synthesize keyTime=_keyTime - In the implementation block
...
@property (assign,nonatomic) SCD_Struct_FB20 frameOffset;                                                                 //@synthesize frameOffset=_frameOffset - In the implementation block
...
@property (assign,nonatomic) SCD_Struct_FB20 videoMinLength;                                                              //@synthesize videoMinLength=_videoMinLength - In the implementation block
@property (assign,nonatomic) SCD_Struct_FB20 videoMaxLength;                                                              //@synthesize videoMaxLength=_videoMaxLength - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_FB20 videoPosition; 
...
-(void)setVideoMinLength:(SCD_Struct_FB20)arg1 ;
...
-(void)setKeyTime:(SCD_Struct_FB20)arg1 ;
-(SCD_Struct_FB20)keyTime;
-(void)setFrameOffset:(SCD_Struct_FB20)arg1 ;
...
-(void)_trimValueChanged:(id)arg1 autoplay:(BOOL)arg2 fromScrubTime:(SCD_Struct_FB20)arg3 ;
...
-(void)_continuePlayingAfterUserInteractionFromScrubTime:(SCD_Struct_FB20)arg1 ;
