...
-(id)initWithExtensionIdentifier:(id)arg1 title:(id)arg2 accessibilityIdentifier:(id)arg3 iconImage:(id)arg4 selectedIconImage:(id)arg5 tooltipText:(id)arg6 tooltipIdentifier:(id)arg7 otherTooltipIdentifiers:(id)arg8 primaryExtensionType:(long long)arg9 ;
