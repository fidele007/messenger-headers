...
@interface FBGroupSelfPostNotifyMembersData : FBGraphQLInput {
...
@property (nonatomic,copy) NSArray * selectedMembers;                //@synthesize selectedMembers=_selectedMembers - In the implementation block
