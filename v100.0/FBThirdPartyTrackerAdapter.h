...
@class FBMemDocumentWebviewElement, NSString;

@interface FBThirdPartyTrackerAdapter : NSObject <FBViewModelAdapter> {

	FBMemDocumentWebviewElement* _webViewElement;
...
-(id)initWithWebviewElement:(id)arg1 ;
-(id)viewModel;
@end
