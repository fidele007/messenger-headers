...
#import <Messenger/MQPlaneModelBridgedExports.h>
#import <Messenger/MQPlaneModelExports.h>
#import <Messenger/MSQMaterialReferrerProtocol.h>

@class MSQModelUndoablePrimitive, NSString, MSQModelDocumentContext, NSArray;

@interface MQPlaneModel : MQSceneObjectModel <MQPlaneModelBridgedExports, MQPlaneModelExports, MSQMaterialReferrerProtocol> {
