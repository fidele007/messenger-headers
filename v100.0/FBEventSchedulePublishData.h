...
@interface FBEventSchedulePublishData : FBGraphQLInput {

	NSString* _clientMutationId;
	NSString* _actorId;
	NSString* _eventId;
	NSNumber* _schedulePublishTimestamp;
...
@property (nonatomic,copy) NSNumber * schedulePublishTimestamp;              //@synthesize schedulePublishTimestamp=_schedulePublishTimestamp - In the implementation block
...
-(NSNumber *)schedulePublishTimestamp;
-(void)setSchedulePublishTimestamp:(NSNumber *)arg1 ;
