...
@class FBProviderMapData, MNThreadStore, FBMobileConfigContextManager, NSString;

@interface MNGroupsRoomDiscoveryStatusRefreshHandlerInjector : NSObject <FBViewerContextInjecting> {
