...
@interface FBPostNotifyFriendsData : FBGraphQLInput {
...
@property (nonatomic,copy) NSArray * recipientIds;                   //@synthesize recipientIds=_recipientIds - In the implementation block
