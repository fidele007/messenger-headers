...
#import <Messenger/FBCollectionViewDisplayCellListener.h>

@class NSString;

@interface FBCollectionViewDisplayCellListenerAnnouncer : FBAnnouncerBase <FBCollectionViewDisplayCellListener>
