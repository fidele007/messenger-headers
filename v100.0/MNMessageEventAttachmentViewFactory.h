...
@class FBUserSession, MNCalendarStore, NSString;

@interface MNMessageEventAttachmentViewFactory : NSObject <MNAttachmentStyleViewFactory, FBViewerContextClassProvidable> {
