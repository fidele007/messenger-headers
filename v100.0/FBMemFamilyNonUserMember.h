...
@interface FBMemFamilyNonUserMember : FBWildeMemModelObject <FBQueriedActorFieldsProtocol, FBQueriedEntityFieldsProtocol, FBQueriedNodeFieldsProtocol, FBQueriedProfileFieldsProtocol, FBQueriedSearchableFieldsProtocol>
-(id)firstNameForSort;
-(id)lastNameForSort;
@end
