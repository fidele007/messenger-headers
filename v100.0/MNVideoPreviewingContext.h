...
@class MNVideoPreviewingData, NSArray;

@interface MNVideoPreviewingContext : FBValueObject <NSCopying> {

	MNVideoPreviewingData* _previewingData;
...
@property (nonatomic,copy,readonly) MNVideoPreviewingData * previewingData;              //@synthesize previewingData=_previewingData - In the implementation block
...
-(MNVideoPreviewingData *)previewingData;
