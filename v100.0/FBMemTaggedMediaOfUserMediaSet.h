...
@interface FBMemTaggedMediaOfUserMediaSet : FBWildeMemModelObject <FBQueriedEntityFieldsProtocol, FBQueriedMediaSetFieldsProtocol, FBQueriedNodeFieldsProtocol>
-(id)canViewerEdit;
