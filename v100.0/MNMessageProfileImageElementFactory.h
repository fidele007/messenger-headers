...
@protocol FBProvider, FBWebImageDownloaderFactoryProtocol, MNProfileImageBadgeFactory, MNBadgedProfileImagePlaceholderFactory;
@class MNBadgedProfileImageBackgroundFactory, NSString;
