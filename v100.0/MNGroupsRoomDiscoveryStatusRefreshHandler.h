...
@class MNGroupsRoomDiscoveryStatusRefreshHandlerInjector, NSString;

@interface MNGroupsRoomDiscoveryStatusRefreshHandler : NSObject <FBClassInjectable, MNMessagesAppearanceEventListener> {

	MNGroupsRoomDiscoveryStatusRefreshHandlerInjector* _injector;
