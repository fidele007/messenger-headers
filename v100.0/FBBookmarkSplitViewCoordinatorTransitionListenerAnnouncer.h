...
#import <Messenger/FBBookmarkSplitViewCoordinatorTransitionListener.h>

@class NSString;

@interface FBBookmarkSplitViewCoordinatorTransitionListenerAnnouncer : FBAnnouncerBase <FBBookmarkSplitViewCoordinatorTransitionListener>
