...
@interface FBNuxCoordinator : NSObject <FBNuxDelegate, FBInvalidating> {
	...
	BOOL _devMode;
	BOOL _alwaysReloadLegacyMegaphones;
	BOOL _valid;
...
@property (assign,nonatomic) BOOL alwaysReloadLegacyMegaphones;                                         //@synthesize alwaysReloadLegacyMegaphones=_alwaysReloadLegacyMegaphones - In the implementation block
...
-(id)lastFetchModeForEligibilityRunner;
-(void)setDevMode:(BOOL)arg1 ;
-(void)setForceFetchingWithGraphQL:(BOOL)arg1 ;
-(void)setAlwaysReloadLegacyMegaphones:(BOOL)arg1 ;
...
-(BOOL)devMode;
-(BOOL)alwaysReloadLegacyMegaphones;
