...
@class FBMemDateTimeFormField, FBPageComponentFlowComponentContext;

@interface FBPageComponentFlowDateTimeFormFieldComponent : CKCompositeComponent {

	FBMemDateTimeFormField* _model;
	FBPageComponentFlowComponentContext* _context;

}

@property (nonatomic,readonly) FBMemDateTimeFormField * model;                             //@synthesize model=_model - In the implementation block
