...
@class FBUserSession, MNEventsReminderLogger, NSString;

@interface MNEventAttachmentViewModelCreator : NSObject <MNAttachmentStyleViewModelCreator, FBViewerContextClassProvidable> {
...
-(id)viewModelForDemo;
-(BOOL)_shouldUpsellPlanWithEvent:(id)arg1 ;
