...
+(id)newWithChildren:(const vector<FBCollageLayoutComponentChild, std::__1::allocator<FBCollageLayoutComponentChild> >*)arg1 style:(const FBCollageLayoutComponentStyle*)arg2 size:(const CKComponentSize*)arg3 ;
