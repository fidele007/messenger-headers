...
#import <Messenger/FBVideoNodeAudioSessionManagerDelegate.h>
...
@interface FBVideoNode : ASDisplayNode <FBVideoPlaybackEventListener, FBAudioSessionClientProvider, FBVideoNodeAudioSessionManagerDelegate, FBMultiresolutionImageNodeDelegate, UIGestureRecognizerDelegate> {
