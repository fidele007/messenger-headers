...
@interface FBSearchWildeAppSpecificConfig : NSObject <FBSearchBaseAppSpecificConfigProtocol> {
	...
	BOOL _shouldEnableScopeSearchEmptyViewButton;
...
@property (assign,nonatomic) BOOL shouldEnableScopeSearchEmptyViewButton;                    //@synthesize shouldEnableScopeSearchEmptyViewButton=_shouldEnableScopeSearchEmptyViewButton - In the implementation block
...
-(void)setShouldEnableScopeSearchEmptyViewButton:(BOOL)arg1 ;
...
-(BOOL)shouldEnableScopeSearchEmptyViewButton;
-(id)init;
