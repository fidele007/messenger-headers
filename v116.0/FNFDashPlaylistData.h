...
@interface FNFDashPlaylistData : NSObject {
	...
	SCD_Struct_FB180 _playlistDuration;

}

@property (assign,nonatomic) BOOL isParsed;                                        //@synthesize isParsed=_isParsed - In the implementation block
@property (assign,nonatomic) SCD_Struct_FB180 playlistDuration;                    //@synthesize playlistDuration=_playlistDuration - In the implementation block
...
-(int)videoFetchIndex;
-(SCD_Struct_FB180)playlistDuration;
...
-(void)setPlaylistDuration:(SCD_Struct_FB180)arg1 ;
