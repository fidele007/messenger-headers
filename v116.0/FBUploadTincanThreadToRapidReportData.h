...
@property (nonatomic,copy) NSString * rapidReportingPromptNodeToken; 
@property (nonatomic,copy) NSString * srtJobId; 
@property (nonatomic,copy) NSArray * tincanThreadData; 
@property (nonatomic,copy) NSString * clientThreadId; 
@property (nonatomic,copy) NSString * clientDeviceId; 
