...
@interface MNPaymentsTransferAttachmentViewModelCreator : NSObject <FBViewerContextClassProvidable, MNAttachmentStyleViewModelCreator> {
...
-(id)viewModelForDemo;
-(void)_logAttachmentImpressionWithEventName:(id)arg1 transferId:(id)arg2 ;
