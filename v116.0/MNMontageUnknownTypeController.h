...
@class FBLazyCreator, MNMontageViewMessageWrapper, MNMontagePlaybackTimer, NSString;

@interface MNMontageUnknownTypeController : NSObject <MNMontagePlaybackTimerDelegate, MNMontageMessageController> {

	FBLazyCreator* _viewCreator;
...
-(id)initWithMessageWrapper:(id)arg1 ;
