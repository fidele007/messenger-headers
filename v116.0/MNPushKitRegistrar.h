...
@class MNPushKitRegistrarInjector, NSString;

@interface MNPushKitRegistrar : NSObject <FBClassInjectable, MNPushKitRegistering> {

	MNPushKitRegistrarInjector* _injector;
