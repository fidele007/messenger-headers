...
@class MNAlohaFavoritesHandlerInjector, MNMultiPeoplePickerViewController, UINavigationController, NSString;

@interface MNAlohaFavoritesHandler : NSObject <FBClassInjectable, MNMultiPeoplePickerViewControllerDelegate> {

	MNAlohaFavoritesHandlerInjector* _injector;
