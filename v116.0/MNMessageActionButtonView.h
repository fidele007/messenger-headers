...
@class UIImageView, UILabel, MNMessageActionButtonViewModel;
...
-(void)_updateActionButtonImageViewWithActionButtonViewModel:(id)arg1 ;
-(void)_updateDescriptionLabelWithActionButtonViewModel:(id)arg1 ;
-(void)_updateDescriptionLabelForActionButtonViewStyleVersion4;
