...
@interface MNRichShareAttachmentViewFactory : NSObject <MNAttachmentStyleViewFactory, FBViewerContextClassProvidable> {

	id<FBProvider> _richShareHandlerProvider;
