...
#import <Messenger/FBAccountRecoveryFDRFlowControlling.h>
...
@interface FBAccountRecoveryFDRFlowController : NSObject <FBAccountRecoveryFDRFlowControlling, FBAuthRecoveryControllingDelegate, FBAuthRecoveryControlling> {
