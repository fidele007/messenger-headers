...
@protocol FBCommentBubbleControllerProtocol, FBNuxBannerViewController, FBCancelable, FBMinimizableModalViewControllerDelegate_DEPRECATED, FBWebViewContainerControllerDelegate, FBBrowserScrollViewDelegate, FBWebViewContainerControllerBannerProvider, FBIntentHandler;
@class NSString, UIView, FBUserSession, FBPopoverActionSheet, FBPopoverController, UIViewController, FBNuxController, UIColor, FBBrowserLayoutView, NSArray, NSMutableArray, FBPulseWebViewBannerProvider, FBSavedUrlNuxManager, NSURL, FBBrowserRelatedStoriesViewController, FBProgressAnimator, FBWebViewController, FBBrowserSaveConfig, FBBrowserShareNowConfig, FBBrowserSendInMessengerConfig, FBBrowserLayoutConfig, FBAnalyticsInfo, FBMemFeedStory;

@interface FBWebViewContainerController : UIViewController <FBWebViewControllerDelegate, FBPopoverControllerDelegate, FBWebViewContainerControllerBannerProviderDelegate, FBModalContentViewController, FBBrowserChromeDelegate, UIScrollViewDelegate, FBSavedDashboardStoreManagerListener, UIGestureRecognizerDelegate, FBBrowserSavedLinksDataStoreManagerListener, FBBrowserRelatedStoriesViewControllerDelegate, FBBrowserLayoutViewDelegate, FBMinimizableContentDelegate, FBMinimizableModalViewController_DEPRECATED, FBInAppNotificationEligibilityProtocol> {
	...
	FBNuxController* _minimizeButtonNuxController;
	NSString* _pageTitle;
	NSURL* _pageURL;
	...
	BOOL _minimizeBouncedURL;
	BOOL _minimizeClosedURL;
	long long _minDurBeforeTTI;
	BOOL _shouldShowUFIAsFooter;
	FBProgressAnimator* _minimizedTabProgressAnimator;
	BOOL _minimizedTabReopened;
	BOOL _bounceMinimized;
	BOOL _isInNavigation;
	id<FBCancelable> _minimizePopover;
	double _minimizePopoverBeforeTTIDuration;
	FBNuxController* _popoverNuxController;
	BOOL _minimizePopoverNUXShowed;
	...
	FBBrowserSendInMessengerConfig* _sendMessageConfig;
...
@property (nonatomic,retain) FBBrowserSendInMessengerConfig * sendMessageConfig;                                                            //@synthesize sendMessageConfig=_sendMessageConfig - In the implementation block
...
-(void)setSendMessageConfig:(FBBrowserSendInMessengerConfig *)arg1 ;
...
-(void)chromeUFIDidTapName:(id)arg1 ;
...
-(FBBrowserSendInMessengerConfig *)sendMessageConfig;
