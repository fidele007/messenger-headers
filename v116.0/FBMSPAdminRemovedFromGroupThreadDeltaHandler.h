...
@interface FBMSPAdminRemovedFromGroupThreadDeltaHandler : NSObject <FBViewerContextClassProvidable, MNMessagesSyncIrisDeltaProcessing> {
...
-(void)_processAdminRemovedDelta:(id)arg1 completion:(/*^block*/id)arg2 ;
