...
@property (nonatomic,copy) NSString * componentFlowRequestId; 
@property (nonatomic,copy) NSString * action; 
@property (nonatomic,copy) FBTextWithEntitiesInput * body; 
@property (nonatomic,copy) NSString * requestNoteId; 
