...
@class NSString, FBTarotPublisherEntity, FBTarotManageScreenCardEntity;
...
@interface FBTarotDigestEndCardEntity : NSObject <FBTarotCardEntityProtocol> {
	...
	Maybe<FB::Signal<FBTarotFeedbackEntity *> >* _feedbackEntity;
...
@property (nonatomic,readonly) Maybe<FB::Signal<FBTarotFeedbackEntity *> >* feedbackEntity;              //@synthesize feedbackEntity=_feedbackEntity - In the implementation block
...
-(Maybe<FB::Signal<FBTarotFeedbackEntity *> >*)feedbackEntity;
...
-(NSString *)cardID;
-(id)initWithPublisherEntity:(id)arg1 cardID:(id)arg2 cardMedia:(Either<FBTarotImageEntity *, FBTarotVideoEntity *>)arg3 feedbackEntity:(Maybe<FB::Signal<FBTarotFeedbackEntity *> >*)arg4 manageScreenEntity:(id)arg5 ;
-(NSString *)cardType;
@end
