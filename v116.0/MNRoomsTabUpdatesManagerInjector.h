...
@interface MNRoomsTabUpdatesManagerInjector : NSObject <FBViewerContextInjecting> {
...
-(id)batchTaskExecutor;
-(id)roomsTabUpdatesStore;
-(id)roomCreationSuggestionsModelController;
-(id)updatesConfigManger;
