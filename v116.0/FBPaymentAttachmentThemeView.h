...
@class MNPaymentsPeerToPeerAttachmentViewModel, FBNetworkImageView, NSString;

@interface FBPaymentAttachmentThemeView : UIView <FBPaymentsViewModelConfigurable> {
