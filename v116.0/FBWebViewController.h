...
#import <FBSharedFramework/NJKWebViewProgressDelegate.h>
...
#import <Messenger/FBWebSiteIntegrityReporterDelegate.h>
...
@interface FBWebViewController : UIViewController <FBAnimatedProgressBarViewDelegate, FBFullScreenErrorViewDelegate, FBMobileCanvasDialog, FBNuxBannerControllerDelegate, FBPassLoaderDelegate, FBPresentableViewController, FBWebAppLinkBannerViewControllerDelegate, FBWebNativeThirdPartyURLControllerDelegate, FBWebToolbarViewDelegate, NJKWebViewProgressDelegate, NSURLConnectionDelegate, NSUserActivityDelegate, PKAddPassesViewControllerDelegate, UIActionSheetDelegate, UIScrollViewDelegate, ZRTariffedUxSentryDelegate, FBWebSiteIntegrityReporterDelegate, FBModalWebFlow> {
	...
	FBWebSiteIntegrityReporter* _siteIntegrityReporter;
	struct {
	...
	BOOL _disableJewels;
	BOOL _disableShareBarButtonItem;
...
@property (assign,nonatomic) BOOL disableShareBarButtonItem;                                                       //@synthesize disableShareBarButtonItem=_disableShareBarButtonItem - In the implementation block
...
@property (nonatomic,readonly) double webToolbarHeight; 
...
@property (assign,nonatomic) BOOL enableAutoReload;                                                                //@synthesize enableAutoReload=_enableAutoReload - In the implementation block
...
-(void)setDisableShareBarButtonItem:(BOOL)arg1 ;
-(BOOL)disableShareBarButtonItem;
-(BOOL)isModalFlow;
...
-(void)setEnableAutoReload:(BOOL)arg1 ;
...
-(void)presentRapidReport:(id)arg1 ;
-(void)reportRedirectChainFailed;
