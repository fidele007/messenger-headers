...
@interface FBSimpleVideoPlaybackLoggingDataProvider : NSObject <FBVideoPlaybackLoggingDataProvider> {
	...
	NSString* _instreamVideoAdBreakVideoID;
...
@property (nonatomic,copy,readonly) NSNumber * instreamVideoAdBreakIndex;                                                 //@synthesize instreamVideoAdBreakIndex=_instreamVideoAdBreakIndex - In the implementation block
@property (nonatomic,copy) NSString * instreamVideoAdBreakVideoID;                                                        //@synthesize instreamVideoAdBreakVideoID=_instreamVideoAdBreakVideoID - In the implementation block
...
-(void)setInstreamVideoAdBreakVideoID:(NSString *)arg1 ;
