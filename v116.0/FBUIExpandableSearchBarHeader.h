...
@class FBNavigationBarSearchTextField, UILabel, NSString;

@interface FBUIExpandableSearchBarHeader : UIControl <FBExpandableView> {

	FBNavigationBarSearchTextField* _expandedView;
