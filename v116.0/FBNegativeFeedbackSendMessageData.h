...
@property (nonatomic,copy) NSString * negativeFeedbackActionId; 
@property (nonatomic,copy) NSString * negativeFeedbackMessageBody; 
@property (nonatomic,copy) NSString * negativeFeedbackMessageRecipientId; 
