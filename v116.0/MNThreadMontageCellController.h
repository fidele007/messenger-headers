...
-(id)initWithProfileImageViewController:(id)arg1 montageThumbnailController:(id)arg2 stickerResourceManager:(id)arg3 nameFormatter:(id)arg4 configManager:(id)arg5 ;
