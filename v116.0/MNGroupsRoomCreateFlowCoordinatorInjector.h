...
-(id)threadStore;
-(id)customSettingsViewController;
-(id)deltaHandlerListenerAnnouncer;
-(id)groupsTabManager;
-(id)nonCachedBlockingGroupThreadCreator;
-(id)nonCachedThreadNavigationCoordinator;
-(id)roomCreateViewController;
-(id)roomShareController;
