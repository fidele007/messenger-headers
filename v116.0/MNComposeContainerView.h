...
@interface MNComposeContainerView : UIView <MNComposerContaining> {
	...
	BOOL _composerBarAddButtonHidden;
...
@property (assign,getter=isComposerBarAddButtonHidden,nonatomic) BOOL composerBarAddButtonHidden;                       //@synthesize composerBarAddButtonHidden=_composerBarAddButtonHidden - In the implementation block
