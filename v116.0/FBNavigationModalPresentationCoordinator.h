...
-(void)_cancelPresentationOfModalViewController:(id)arg1 usingMethod:(unsigned long long)arg2 restoringPreviousModalPresentingViewController:(id)arg3 animated:(BOOL)arg4 ;
-(void)_cleanUpDismissedModalViewController:(id)arg1 ;
