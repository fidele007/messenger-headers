...
@property (nonatomic,readonly) BOOL includeCYMKCacheResults;                //@synthesize includeCYMKCacheResults=_includeCYMKCacheResults - In the implementation block
-(id)initWithIncludeUsers:(BOOL)arg1 includeGroups:(BOOL)arg2 includePages:(BOOL)arg3 includeVCEndpoints:(BOOL)arg4 includeGames:(BOOL)arg5 includeInternalBots:(BOOL)arg6 includeSecureThreads:(BOOL)arg7 includeAddressBookEntries:(BOOL)arg8 includeNetworkResults:(BOOL)arg9 includeLocalResults:(BOOL)arg10 includeCYMKCacheResults:(BOOL)arg11 ;
