...
@class MNBusinessPlugin, FBImageDownloader, FBUserSession, NSString;

@interface MNAgentMessageReceiptViewFactory : NSObject <FBViewerContextClassProvidable, MNAttachmentStyleViewFactory> {
