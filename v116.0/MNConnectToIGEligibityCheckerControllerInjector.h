...
@interface MNConnectToIGEligibityCheckerControllerInjector : NSObject <FBViewerContextInjecting> {
...
-(id)igInAppAccountFetchingRequestSender;
-(id)loggedInUserInfoManager;
-(id)foregroundJobScheduler;
