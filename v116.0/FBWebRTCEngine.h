...
-(void)startConferenceCallWithName:(id)arg1 participants:(id)arg2 userIdsToRing:(id)arg3 serverInfoData:(id)arg4 directVideo:(BOOL)arg5 callTrigger:(id)arg6 analyticsExtra:(id)arg7 countdownBeforeRinging:(BOOL)arg8 appConfig:(id)arg9 ;
...
-(void)_initializeCallUsingMultiway:(BOOL)arg1 conferenceName:(id)arg2 requireCamera:(BOOL)arg3 requireMicrophone:(BOOL)arg4 configureProperties:(/*^block*/id)arg5 success:(/*^block*/id)arg6 failure:(/*^block*/id)arg7 ;
...
-(void)removeUsers:(id)arg1 onSuccess:(/*^block*/id)arg2 onError:(/*^block*/id)arg3 ;
-(id)_createCallProperties:(long long)arg1 isUsingMultiwayProtocol:(BOOL)arg2 uuid:(id)arg3 ;
...
-(void)startPausedLiveWithCallWithBroadcastId:(id)arg1 analyticsExtra:(id)arg2 appConfig:(id)arg3 ;
...
-(void)DEPRECATED_setVideoParametersWithCaptureWidth:(int)arg1 captureHeight:(int)arg2 captureFramerate:(int)arg3 ;
-(id)currentPeerId;
...
-(void)updateParticipantStates:(id)arg1 participantCapabilities:(id)arg2 isDirectVideoCall:(BOOL)arg3 ;
