...
-(void)_handleBroadcastWithWebView:(id)arg1 websiteURL:(id)arg2 messageName:(id)arg3 messageParams:(id)arg4 ;
-(void)_handleDirectShareWithWebView:(id)arg1 websiteURL:(id)arg2 messageName:(id)arg3 messageParams:(id)arg4 ;
-(void)_handleBeginShareFlowSuccessWithMessageName:(id)arg1 messageParams:(id)arg2 websiteURL:(id)arg3 webView:(id)arg4 isSent:(BOOL)arg5 ;
