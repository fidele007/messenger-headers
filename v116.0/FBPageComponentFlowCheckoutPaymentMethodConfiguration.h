...
@interface FBPageComponentFlowCheckoutPaymentMethodConfiguration : NSObject <FBPaymentsCheckoutPaymentMethodConfiguration> {
...
-(id)initWithProductItemType:(id)arg1 ;
@end
