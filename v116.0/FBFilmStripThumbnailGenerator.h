...
@class AVAssetImageGenerator, NSObject, NSMutableDictionary, UIImage, FBVideoProcessor, FBVideoProcessorConfig, NSArray;
...
-(void)_handleImageGeneratorCompleteInSerialQueueWithRequestedTime:(SCD_Struct_FB180)arg1 image:(id)arg2 error:(id)arg3 ;
-(void)_callHandler:(/*^block*/id)arg1 inQueue:(id)arg2 withTime:(SCD_Struct_FB180)arg3 image:(id)arg4 error:(id)arg5 ;
