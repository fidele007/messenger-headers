...
@class MNScoutAdapter, NSString;

@interface MNScoutThreadMessageSubscribingListener : NSObject <MNThreadMessageSubscribing> {
...
-(id)initWithScoutAdapter:(id)arg1 authManager:(id)arg2 ;
