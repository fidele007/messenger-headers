...
@property (assign,nonatomic) BOOL hasAppliedEdits;                                         //@synthesize hasAppliedEdits=_hasAppliedEdits - In the implementation block
...
-(void)_updateRevertButtonVisibility;
...
-(void)setHasAppliedEdits:(BOOL)arg1 ;
...
-(void)composerPhotoOverlayAttachmentsViewControllerDidHitRevert:(id)arg1 ;
...
-(void)composerDoodlesViewControllerDidHitRevert:(id)arg1 ;
...
-(void)galleryTopBarDidTapRevertButton:(id)arg1 ;
