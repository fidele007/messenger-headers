...
-(id)initWithReuseIdentifier:(id)arg1 avatarImageDecoration:(id)arg2 callButtonImageProvider:(id)arg3 dateFormatter:(id)arg4 style:(unsigned long long)arg5 directVideoCallingEnabled:(BOOL)arg6 advancedAggregationFormat:(BOOL)arg7 ;
