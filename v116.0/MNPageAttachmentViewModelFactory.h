...
@interface MNPageAttachmentViewModelFactory : NSObject <FBViewerContextClassProvidable, MNAttachmentStyleViewModelCreator> {
...
-(id)_viewModelForPages:(id)arg1 message:(id)arg2 ;
