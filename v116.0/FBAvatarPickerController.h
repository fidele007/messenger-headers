...
@class NSMutableArray, NSArray, FBAvatarPickerControllerDataSource, NSSet, NSMutableSet, FBKVOController, NSString, NSTimer, FBUserSession, FBEntityPickerTextField, NSPredicate, UIView, FBAvatarPickerView, FBLoadingIndicatorView;
