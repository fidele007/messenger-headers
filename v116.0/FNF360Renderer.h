...
#import <FBSharedFramework/FNFPlayerRenderer.h>
...
@property (nonatomic,readonly) unsigned long long projectionType;              //@synthesize projectionType=_projectionType - In the implementation block
