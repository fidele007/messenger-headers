...
@interface FBNewNavigationController : FBNewCustomNavigationController <FBMovableNavigationBarViewControllerDelegate, FBNavigationBarLayoutDelegate, FBNavigationControllerInternal_DEPRECATED, FBNavigationController_DEPRECATED> {
	...
	BOOL _useEmbeddedNavEverywhere;
...
@property (assign,nonatomic) BOOL fullScreenSwipeEnabled; 
...
-(void)_setExternalNavigationBarItems:(id)arg1 animated:(BOOL)arg2 ;
