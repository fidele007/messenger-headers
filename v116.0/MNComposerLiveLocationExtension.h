...
@class MNComposerLiveLocationExtensionInjector, FBLazyCreator, MNMessageLiveLocationAnalyticsLogger, NSString;
...
@interface MNComposerLiveLocationExtension : MNAbstractComposerTrayExtension <FBClassInjectable, MNMessageLiveLocationTrayViewControllerDelegate> {
	...
	FBLazyCreator* _trayViewControllerCreator;
