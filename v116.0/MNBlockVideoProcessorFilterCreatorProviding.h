...
#import <Messenger/MNVideoProcessorFilterCreatorProviding.h>

@class NSString;

@interface MNBlockVideoProcessorFilterCreatorProviding : NSObject <MNVideoProcessorFilterCreatorProviding> {
