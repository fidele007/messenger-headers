...
#import <Messenger/MNAddMembersRequestListener.h>
...
@interface FBWebRTCViewController : UIViewController <FBWebRTCCallActionViewDelegate, UIActionSheetDelegate, UIAlertViewDelegate, FBWebRTCInCallEventListener, FBWebRTCViewDelegate, FBWebRTCRemoteVideoRenderStatusListener, FBWebRTCRosterDelegate, RTCVideoCaptureSessionListener, UICollectionViewDelegate, FBWebRTCVideoFilterControllerDelegate, FBWebRTCSettingsPopoverControllingDelegate, FBWebRTCVoicemailHandlerListener, FBWebRTTCVideoSnapshotOverlayViewControllerDelegate, RTCGroupVideoManagerDelegate, FBWebRTCGroupCallRingingManagerListener, FBWebRTCActivityViewControllerDelegate, FBWebRTCPostCallControllerListener, FBModalPresentationStackViewControllerDelegate, MNAddMembersRequestListener, FBClassProvidable, FBWebRTCSessionListener> {
	...
	int _filterButtonInVideoActionsTooltipShownCount;
	...
	BOOL _filterUsable;
	BOOL _reactionsUsable;
	BOOL _showRosterOnAppear;
	BOOL _showSwitchLayoutWhenVideo;
	BOOL _showFilterUIOnAppear;
	long long _filterTypeForUIToBeShownOnAppear;
	MNTooltip* _snapshotTooltip;
	MNTooltip* _expressionTooltip;
	...
	id<FBProvider> _addMemberViewControllerProvider;
	MNAddMembersViewController* _addMembersViewController;
	FBProvider* _modalPresentationProvider;
	BOOL _callUIActive;
...
-(void)showExpressionEffectsUIForFilterType:(long long)arg1 ;
...
-(void)_reloadThreadSummary;
-(id)_filterIndexForCollectionView:(id)arg1 atIndexPath:(id)arg2 ;
-(void)_updateEffectsEntryPointVisibility;
-(void)_updateReactionsEntryPointVisibility;
-(BOOL)_isFilterUsableAfterHoldoutCheck;
-(BOOL)_isAudioRosterHidden;
-(void)_logExpressionActionForCall:(id)arg1 enabled:(BOOL)arg2 filterType:(id)arg3 filterId:(id)arg4 filterName:(id)arg5 duration:(double)arg6 featureIntent:(long long)arg7 ;
-(BOOL)_canShowFilterNux;
-(void)_showTooltip:(id)arg1 positionInWindow:(CGPoint)arg2 bodyText:(id)arg3 direction:(unsigned long long)arg4 completion:(/*^block*/id)arg5 ;
...
-(void)didAddMembersToGroupThreadKey:(id)arg1 ;
-(void)willDismissWithoutAddingMembers;
