...
@interface FBServicesFollowUpMessageSettingUpdateData : FBGraphQLInput

@property (nonatomic,copy) NSString * clientMutationId; 
@property (nonatomic,copy) NSString * actorId; 
@property (nonatomic,copy) NSString * pageId; 
@property (nonatomic,copy) NSString * messageSettingId; 
@property (nonatomic,copy) NSString * userId; 
@property (nonatomic,copy) NSString * messageContent; 
@property (nonatomic,copy) NSNumber * scheduleInSeconds; 
