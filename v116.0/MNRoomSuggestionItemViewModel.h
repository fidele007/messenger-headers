...
@property (nonatomic,readonly) BOOL shouldShowNewItemBadge;                                       //@synthesize shouldShowNewItemBadge=_shouldShowNewItemBadge - In the implementation block
-(MNRoomSuggestionRow *)suggestionRow;
-(BOOL)shouldShowNewItemBadge;
-(id)initWithItemIdentifier:(id)arg1 suggestionRow:(id)arg2 loggingData:(id)arg3 shouldShowNewItemBadge:(BOOL)arg4 ;
