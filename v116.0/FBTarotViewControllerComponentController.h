...
@class FBTarotViewControllerComponent;

@interface FBTarotViewControllerComponentController : CKStatefulViewComponentController

@property (nonatomic,readonly) FBTarotViewControllerComponent * component; 
