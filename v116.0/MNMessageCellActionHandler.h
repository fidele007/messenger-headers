...
@class MNIntentHandler, FBMobileConfigContextManager, MNNavigationCoordinator, MNForwardMessageHandler, MNSaveMessageHandler, FBCurrentCountryManager, MNAppMessageAttachmentUtils, FBUserSession, UIAlertController, MNActivityViewPresenter, FBMAttachmentURLRequestFactory, MNPlatformAppActionHandler, MNMessageDetectedDataHandlingManager, FBMSendEventLogger, MNThreadUpdateRunningService, FBLazyCreator, FBMLoggedInUserInfoManager, MNEventsReminderActionHandler, MNSaveMessageOutboundClickCoordinator, MNMessageCellActionHandlerConfiguration, MNGameListPresenter, MNImportedContactRemovalCoordinator, MNUserInfoControllerCoordinator, MNRoomsReportingManager, MNCopyMessageActionHandler, MNContextMenuActionConfirmationHandler, UIViewController, LPPhoneNumber, NSString, NSDictionary, NSURL, MNAppMessage, MNThreadViewModel;

@interface MNMessageCellActionHandler : NSObject <MNPhotoViewControllerDelegate, CNContactViewControllerDelegate, MNPlatformAppActionHandlerDelegate, UIPopoverPresentationControllerDelegate, FBClassProvidable, MNThreadViewModelConfigurable, MNMessageCollectionViewCellDelegate, MNAdminMessageCollectionViewCellDelegate, MNFoldableAdminMessageCollectionViewCellDelegate, MNMessageCellLinkHandling> {
	...
	MNCopyMessageActionHandler* _copyMessageActionHandler;
	MNContextMenuActionConfirmationHandler* _contextMenuActionConfirmationHandler;
...
-(void)_showDeleteActionSheetForMessage:(id)arg1 messageCell:(id)arg2 deletionCompletion:(/*^block*/id)arg3 ;
...
-(void)foldableAdminMessageCell:(id)arg1 didGenerateEvent:(id)arg2 ;
