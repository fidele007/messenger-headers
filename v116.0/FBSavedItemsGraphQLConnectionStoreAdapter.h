...
-(void)_updateDataModel:(id)arg1 withSeenState:(id)arg2 atIndexPath:(id)arg3 ;
-(void)_updateDataModel:(id)arg1 withViewedState:(id)arg2 atIndexPath:(id)arg3 ;
-(void)_updateWithItem:(id)arg1 atIndexPath:(id)arg2 ;
-(id)_groupNameForSectionIndex:(long long)arg1 ;
-(void)_updateDataSourceItemsWithPreviousState:(id)arg1 newState:(id)arg2 updatedIndexPaths:(id)arg3 ;
...
-(void)updateItem:(id)arg1 withSeenState:(id)arg2 ;
-(BOOL)_itemInNotificationItems:(id)arg1 ;
...
-(NSString *)filter;
-(void)_removeGroupAtIndex:(long long)arg1 ;
@end
