...
@class MNAppleMediaPickerController, MNCameraViewController, ZRTariffedUxSentry, FBUserSession, MNUserSettings, MNImageRequester, MNImageUploadCandidateStore, FBLazyCreator, MNComposerCameraExtensionListenerAnnouncer, MNComposerExtensionInitiator, MNComposerLongPressVideoController, NSString, UIColor;
...
-(void)_addCameraExtensionEventListener:(id)arg1 ;
-(void)_removeCameraExtensionEventListener:(id)arg1 ;
