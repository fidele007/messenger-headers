...
@class MNSuggestedContactsRetrieverWithHoistedMontageContactConfiguration, FBMLoggedInUserInfoManager, NSArray, NSString;
...
-(id)initWithSuggestedContactsRetriever:(id)arg1 configuration:(id)arg2 loggedInUserInfoManager:(id)arg3 ;
