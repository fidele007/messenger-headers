...
#import <Messenger/FBAccountRecoveryCodeEntryFlowControlling.h>
...
@class FBAccountRecoveryFlowData, FBAccountRecoveryOtherSessionsFlowController, NSString;

@interface FBAccountRecoveryCodeEntryFlowController : NSObject <FBAccountRecoveryCodeEntryFlowControlling, FBAuthRecoveryControllingDelegate, FBAuthRecoveryControlling> {
	...
	FBAccountRecoveryOtherSessionsFlowController* _otherSessionsFlowController;
...
-(void)didContinueWithCode:(id)arg1 ;
-(void)recover;
