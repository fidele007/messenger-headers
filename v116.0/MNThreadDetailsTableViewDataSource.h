...
#import <Messenger/MNPageNullStateHeaderViewActionHandling.h>
#import <UIKit/UITableViewDataSource.h>
#import <Messenger/MNThreadViewModelLoadResultConfigurable.h>

@protocol MNThreadClientSummaryUpdateCreating, MNThreadDetailsSectionProviding, MNAuthenticationManager, MNInviteEligibilityChecking, MNSecureMessagingCapabilityQuerying, MNSecureMessagingDeviceInformation, MNAvatarImageDecorating, MNThreadDetailsTableViewDataSourceDelegate;
@class MNThreadParticipantNameFormatter, FBUserSession, MNThreadViewModel, MNThreadDetailsSectionProviderController, FBWebRTCCallStarter, FBWebRTCCallButtonImageProvider, MNPlatformThreadDetailsViewModel, MNThreadDetailsViewController, MNThreadDetailsUserInfoHeaderCell, MNThreadDetailsPageConfiguration, FBMobileConfigContextManager, MNPeopleCellFactory, MNEphemeralMessagePolicy, MNBlockFeatureConfiguration, MNThreadDetailsTableViewCellIconsConfiguration, MNThreadImageManager, MNProfileImageViewController, MNThreadDetailsGroupDescriptionView, MNThreadDetailsPageDescriptionView, NSArray, MNThreadDetailsContactInfoViewModel, NSString, FBStringWithRedactedDescription;

@interface MNThreadDetailsTableViewDataSource : NSObject <MNThreadDetailsUserInfoHeaderCellDelegate, MNThreadDetailsDescriptionViewDelegate, MNPageNullStateHeaderViewActionHandling, UITableViewDataSource, MNThreadViewModelLoadResultConfigurable> {
	...
	NSString* _nativeBookingEntryLink;
...
@property (nonatomic,copy) NSString * nativeBookingEntryLink;                                             //@synthesize nativeBookingEntryLink=_nativeBookingEntryLink - In the implementation block
...
-(id)_pageRequestAnotherAppointmentCellForRow:(unsigned long long)arg1 tableView:(id)arg2 ;
...
-(void)_configureMoveToOtherFolderCell:(id)arg1 ;
...
-(NSString *)nativeBookingEntryLink;
...
-(void)setNativeBookingEntryLink:(NSString *)arg1 ;
