...
#import <Messenger/FBVideoEditingPlaybackViewDelegate.h>
#import <Messenger/FBVideoVolumeControlViewDelegate.h>
#import <Messenger/FBAudioSessionManagerClient.h>
#import <UIKit/UIScrollViewDelegate.h>
#import <Messenger/FBVideoCreativeToolsApplier.h>
#import <Messenger/FBVideoFilterViewsUpdateProtocol.h>
...
@class FBVideoCreativeToolsApplierListenerAnnouncer, UIImageView, NSString, FBProfileVideoLogger, FBVideoEditingModuleLogger, UIView, FBVideoSizeView, FBVideoTimeView, FBVideoEditingConfiguration, FBBubbleViewPresenter, FBMediaCreativeToolFilterViewController, FBMediaCreativeToolFilterView, NSArray, UITapGestureRecognizer, FBVideoProcessor, FBVideoClip, UIImage, FBVideoEditingPlaybackView, FBVideoTrimView, FBVideoVolumeControlView, FBVideoEditingAudioToggle, FBMediaHDUploadButton, FBMediaGalleryBottomBar, FBButton, UIScrollView, FBCropRectangleView, FBVideoScrubberView;
...
@interface FBVideoEditingViewController : UIViewController <FBVideoTrimViewDelegate, FBVideoEditingPlaybackViewDelegate, FBVideoVolumeControlViewDelegate, FBAudioSessionManagerClient, UIScrollViewDelegate, FBVideoCreativeToolsApplier, FBVideoFilterViewsUpdateProtocol, FBVideoScrubberViewDelegate> {
	...
	unsigned long long _numberOfOverlayFilters;
	...
	SCD_Struct_FB180 _videoMinLength;
	SCD_Struct_FB180 _videoMaxLength;
	SCD_Struct_FB180 _frameOffset;
	SCD_Struct_FB180 _keyTime;
...
@property (assign,nonatomic) SCD_Struct_FB180 keyTime;                                                                    //@synthesize keyTime=_keyTime - In the implementation block
...
@property (assign,nonatomic) SCD_Struct_FB180 frameOffset;                                                                //@synthesize frameOffset=_frameOffset - In the implementation block
...
@property (assign,nonatomic) SCD_Struct_FB180 videoMinLength;                                                             //@synthesize videoMinLength=_videoMinLength - In the implementation block
@property (assign,nonatomic) SCD_Struct_FB180 videoMaxLength;                                                             //@synthesize videoMaxLength=_videoMaxLength - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_FB180 videoPosition; 
...
@property (assign,nonatomic) unsigned long long numberOfOverlayFilters;                                                   //@synthesize numberOfOverlayFilters=_numberOfOverlayFilters - In the implementation block
...
-(id)filterView;
-(void)setVideoMinLength:(SCD_Struct_FB180)arg1 ;
...
-(double)keyPosition;
-(void)setKeyTime:(SCD_Struct_FB180)arg1 ;
-(void)setKeyPosition:(double)arg1 ;
-(void)setFrameOffset:(SCD_Struct_FB180)arg1 ;
...
-(SCD_Struct_FB180)videoMinLength;
-(SCD_Struct_FB180)videoMaxLength;
-(void)setVideoMaxLength:(SCD_Struct_FB180)arg1 ;
...
-(void)_trimValueChanged:(id)arg1 autoplay:(BOOL)arg2 fromScrubTime:(SCD_Struct_FB180)arg3 ;
...
-(void)_continuePlayingAfterUserInteractionFromScrubTime:(SCD_Struct_FB180)arg1 ;
-(void)_handleAudioChange:(BOOL)arg1 ;
-(void)playbackView:(id)arg1 didPlayToTime:(SCD_Struct_FB180)arg2 ;
...
-(id)selectedFrameForVideoClip:(id)arg1 ;
