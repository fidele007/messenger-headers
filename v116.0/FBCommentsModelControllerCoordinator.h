...
#import <Messenger/FBCKCommentsStoreListener.h>
...
@interface FBCommentsModelControllerCoordinator : NSObject <FBCommentsModelControllerCoordinatorCountDecrementerDelegate, FBCKCommentsStoreListener, FBStreamListener, FBCommentPublisherDelegate, FBCommentEditorDelegate, FBCommentDeleterDelegate, FBCommentHiderDelegate, FBCommentUnhiderDelegate, FBCommentsRefresherDelegate, FBCKStreamResponseHandlerProcessingDelegate> {
	...
	SCD_Struct_FB209 _requiredFetchLimit;
...
@property (nonatomic,readonly) SCD_Struct_FB209 requiredFetchLimit;                                                          //@synthesize requiredFetchLimit=_requiredFetchLimit - In the implementation block
...
-(void)registerRequiredFetchLimit:(SCD_Struct_FB209)arg1 ;
...
-(SCD_Struct_FB209)requiredFetchLimit;
