...
@class NSMutableArray, NSMutableSet, NSSet, UIViewController, FBExpandableNavigationBar, FBExpandableNavigationScrollHandler, FBUserSession, FBExpandableButton, FBCarouselScrollView, FBCarouselTitleView, NSArray, UIControl, NSString;
...
@interface FBHorizontalCarouselViewController : UIViewController <UIScrollViewDelegate, FBCarouselScrollViewGestureDelegate, FBNavigationChromePresenter, FBLoadingProgressDelegate, FBExpandableNavigationBarStatusBarAppearanceDelegate, FBInAppNotificationEligibilityProtocol> {
	...
	BOOL _navigationChromeTitleVisible;
...
-(FBExpandableButton *)_backButton;
-(FBExpandableButton *)_shareButton;
-(id)initWithContentControllers:(id)arg1 navigationBarExpansionStyle:(unsigned long long)arg2 session:(id)arg3 ;
...
-(id)initWithContentControllers:(id)arg1 navigationBarExpansionStyle:(unsigned long long)arg2 navigationChromeTitleVisible:(BOOL)arg3 session:(id)arg4 ;
...
-(void)updateOverlayExpansionPercentage;
-(void)expandNavigationBarAnimated;
-(void)bounceCarousel;
