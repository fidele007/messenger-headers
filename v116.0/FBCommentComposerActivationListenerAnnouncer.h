...
#import <Messenger/FBCommentComposerActivationListener.h>

@class NSString;

@interface FBCommentComposerActivationListenerAnnouncer : FBAnnouncerBase <FBCommentComposerActivationListener>
