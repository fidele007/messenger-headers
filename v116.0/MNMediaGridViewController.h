...
@class MNCollectionViewUpdater, MNAssetsListController, MNMediaPickerPerformanceLogger, MNMediaPickerAccessibilityLabelGenerator, PHAssetCollection, MNMultiAssetPickerViewController, MNMediaGridView, PHImageRequestOptions, NSObject, NSString;
...
-(void)_updateCollectionViewDataWithCurrentAlbum;
...
-(id)initWithPhotosDataSource:(id)arg1 photosDataRequester:(id)arg2 mediaPickerAccessibilityLabelGenerator:(id)arg3 assetsListController:(id)arg4 multiAssetPickerViewController:(id)arg5 mediaPickerPerformanceLogger:(id)arg6 ;
