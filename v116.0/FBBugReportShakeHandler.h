...
@class FBBugReportCoordinator, UIViewController, NSMutableArray, UIWindow, NSMutableDictionary, NSString, NSDictionary, FBBugReportVideoScreenRecorder, FBBugReportVideoRecorderViewController, FBBugReportVideoScreenVideoRecorderWindow, FBBugReportScreenshotTakingWindow, FBBugReportScreenshotTakingViewController, NSDate, NSTimer, FBBugReportInitialCoordinator, FBTimer, FBUserSession, NSObject, FBBugReportConfiguration;
