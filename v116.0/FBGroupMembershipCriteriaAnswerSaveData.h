...
@interface FBGroupMembershipCriteriaAnswerSaveData : FBGraphQLInput

@property (nonatomic,copy) NSString * clientMutationId; 
@property (nonatomic,copy) NSString * actorId; 
@property (nonatomic,copy) NSString * groupId; 
@property (nonatomic,copy) NSArray * customQuestions; 
@property (nonatomic,copy) NSArray * questionnaireAnswers; 
