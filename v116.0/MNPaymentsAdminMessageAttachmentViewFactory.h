...
@class MNPaymentsAdminMessageAttachmentViewFactoryInjector, NSString;

@interface MNPaymentsAdminMessageAttachmentViewFactory : NSObject <FBClassInjectable, MNAttachmentStyleViewFactory> {

	MNPaymentsAdminMessageAttachmentViewFactoryInjector* _injector;
