...
#import <Messenger/FBWebLivePhotoSupportingViewDelegate.h>
#import <Messenger/FBPagingViewContentView.h>

@protocol FBRichPhotoViewDelegate, FBRichPhotoViewSpinnerLoggingDelegate, FBQueriedNodeFieldsProtocol;
@class UIButton, FBTagDecorator, NSDate, NSMutableSet, UIView, FB360PhotoView, FB360PhotoPresenter, FBZoomingPhotoView, FBPhotosConsumptionReferrer, FBUserSession, FBPhotoLoadingProgressView, UIActivityIndicatorView, FBWebLivePhotoSupportingView, FBLivePhotoBadgeView, FBTimer, FBMemPhoto, FBScenePath, NSTimer, FBMemModelObject, NSString, FBPhotoTaggingSearchController, FBWebPhotoView, UIImage, NSSet;
...
@interface FBRichPhotoView : UIView <FBZoomingPhotoViewDelegate, FBTagDecoratorDelegate, FBNetworkerRequestDelegate, FBWebImageViewListener, FBWebLivePhotoSupportingViewDelegate, FBPagingViewContentView> {
	...
	FB360PhotoPresenter* _sphericalPhotoPresenter;
...
@property (nonatomic,copy) NSSet * removedTags;                                                                    //@synthesize removedTags=_removedTags - In the implementation block
...
-(void)setRemovedTags:(NSSet *)arg1 ;
