...
@class FBUserSession, MNNavigationCoordinator, MNThreadParticipantNameFormatter, MNUserBlocker, MNBusinessBlocker, MNIntentHandler, FBLocaleMap, MNUserStore, MNThreadUpdateRunningService, NSString, FBMUser, UITableView, MNTableViewCell, UISwitch, MNLoadingView, FBRapidFeedbackSurveyManager, MNContentSubscriptionTopicsFetcher, MNContentSubscriptionTopicsObserver, NSMutableArray, MNProfileImageViewController;

@interface MNBlockUserFullScreenViewController : UIViewController <UITableViewDataSource, UITableViewDelegate, MNBlockUserSectionFooterViewDelegate, MNContentSubscriptionTopicCellDelegate, MNContentSubscriptionTopicsObserverDelegate, FBRapidFeedbackSurveyManagerDelegate, FBClassProvidable> {
