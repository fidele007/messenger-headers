...
@protocol FBProvider;
@class MNMessageMontageReplyContextView, MNMessageMontageReplyContextViewModel, MNMontageThumbnailController, MNThreadMontageThumbnailFactory, FBMLoggedInUserInfoManager, MNThreadMontageThumbnail, NSString;
...
-(void)_configureMontageThumbnailView;
