...
@interface FBVideoTrimView : UIView <FBFilmStripViewDelegate, FBTrimViewDelegate> {
	...
	FBVideoClip* _clip;
	SCD_Struct_FB180 _minTrimmedLength;
	SCD_Struct_FB180 _maxTrimmedLength;
	SCD_Struct_FB180 _scrubTime;
...
@property (assign,nonatomic) SCD_Struct_FB180 minTrimmedLength;                              //@synthesize minTrimmedLength=_minTrimmedLength - In the implementation block
@property (assign,nonatomic) SCD_Struct_FB180 maxTrimmedLength;                              //@synthesize maxTrimmedLength=_maxTrimmedLength - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_FB181 timeRange; 
@property (nonatomic,readonly) SCD_Struct_FB180 scrubTime;                                   //@synthesize scrubTime=_scrubTime - In the implementation block
...
-(void)setMaxTrimmedLength:(SCD_Struct_FB180)arg1 ;
-(void)seekScrubberToTime:(SCD_Struct_FB180)arg1 ;
-(unsigned long long)draggingMode;
-(SCD_Struct_FB180)scrubTime;
...
-(void)postEditDidEnd;
-(void)_seekScrubberToTime:(SCD_Struct_FB180)arg1 forceUpdate:(BOOL)arg2 autohide:(BOOL)arg3 ;
-(void)updateFilmCropOriginWithXProportion:(double)arg1 YProportion:(double)arg2 ;
-(SCD_Struct_FB181)_timeRangeForTrimRange:(CGPoint)arg1 ;
-(void)_scrubToTime:(SCD_Struct_FB180)arg1 autohideScrubber:(BOOL)arg2 ;
...
-(void)setMinTrimmedLength:(SCD_Struct_FB180)arg1 ;
-(SCD_Struct_FB180)minTrimmedLength;
-(SCD_Struct_FB180)maxTrimmedLength;
-(void)layoutSubviews;
