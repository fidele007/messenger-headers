...
@class MNJoinableHashUrlHandlerInjector, NSString;

@interface MNJoinableHashUrlHandler : NSObject <FBClassInjectable, MNUrlHandlerExtending> {

	MNJoinableHashUrlHandlerInjector* _injector;
