...
#import <Messenger/FBVideoPlaybackContainerViewDelegate.h>
...
@interface FBVideoPlaybackController : NSObject <AVPlayerItemOutputPullDelegate, FBVideoAudioRouteEventListener, FBVideoPlaybackContainerViewDelegate> {
...
@property (nonatomic,readonly) double currentVideoTimeInOneLoop; 
...
@property (assign,nonatomic) BOOL showCaptions;                                                                           //@synthesize showCaptions=_showCaptions - In the implementation block
...
-(id)_audioRampForItem:(id)arg1 startVolume:(float)arg2 endVolume:(float)arg3 timeRange:(SCD_Struct_FB181)arg4 ;
...
-(double)currentVideoTimeInOneLoop;
...
-(CGPoint)pitchAndYawWithPositionOnVideo:(CGPoint)arg1 ;
-(CGPoint)positionWithPitch:(double)arg1 yaw:(double)arg2 ;
...
-(void)videoPlaybackContainerViewPerformMagicTap:(id)arg1 ;
-(BOOL)showShadow;
...
-(void)_playbackItemLoadedWithPlaybackItem:(id)arg1 playerItem:(id)arg2 error:(id)arg3 loader:(id)arg4 assetDuration:(SCD_Struct_FB180)arg5 ;
-(void)_resetForError:(id)arg1 ;
-(void)_playerStateBlockHandlerUsingRate:(float)arg1 ;
-(void)_safeSeekToTime:(SCD_Struct_FB180)arg1 completionHandler:(/*^block*/id)arg2 ;
...
-(void)_getVolumeCompletionBlockWithForPlayerItem:(id)arg1 FromVolume:(float)arg2 toVolume:(float)arg3 duration:(float)arg4 completion:(/*^block*/id)arg5 ;
...
-(SCD_Struct_FB234)_fetchVideoMetadataForVideoNetworkerAnalysis;
...
-(void)_periodicTimeObserverCallback:(SCD_Struct_FB180)arg1 ;
-(void)_emitRepresentationEndedEventForPreviousRepresentation:(id)arg1 ;
-(void)_addRepresentationChangedCallback;
-(void)_prepare360Renderer:(BOOL)arg1 playerItem:(id)arg2 player:(id)arg3 ;
-(void)rampForPlayerItem:(id)arg1 toVolume:(float)arg2 duration:(float)arg3 completion:(/*^block*/id)arg4 ;
...
-(void)addAudioLevelMeterCallback:(/*^block*/id)arg1 timeInterval:(SCD_Struct_FB180)arg2 ;
