...
@class FBUserSession, FBCLEventChannel, FBCLLocationCollectionConfig, FBCLLocationUpdateRequest, FBCLLocationLogger, CLLocationManager, NSDate, FBCLLocationQualityChecker, FBCLLocationUpdateListenerAnnouncer, NSString;
