...
@class MNThreadDetailsActionsControllerInjector, MNThreadMutePicker, MNThreadMembersUpdater, MNEphemeralMessageLifeTimePicker, MNNavigationBarController, MNThreadPhotosViewController, MNThreadPhotoEditController, MNThreadCustomizationModalPickerController, MNThreadEphemeralitySetter, MNThreadDetailsSecureCodenameEditController, MNSecureMessagingDeviceStatusOverrideAlertHandler, MNThreadViewModel, FBMUser, FBRapidFeedbackSurveyManager, MNThreadDetailsIgnoreMessagesActionFunnelLogger, MNProgressBarController, MNThreadDetailsContactViewController, MNThreadNicknameViewController, MNSecureMessagingIdentityKeyViewController, UIAlertView, NSString;

@interface MNThreadDetailsActionsController : NSObject <FBClassInjectable, MNThreadMutePickerDelegate, UIAlertViewDelegate, MNThreadMembersUpdaterDelegate, MNThreadPhotoEditControllerDelegate, MNThreadCustomizationModalPickerControllerDelegate, MNEphemeralMessageLifeTimePickerDelegate, MNThreadEphemeralitySetterDelegate, MNThreadDetailsSecureCodenameEditControllerDelegate, MNBookingRequestsViewControllerDelegate, FBRapidFeedbackSurveyManagerDelegate, FBConfirmationViewDelegate, MNThreadDetailsViewControllerDelegate, MNThreadDetailsContactViewControllerDelegate> {
	...
	FBMUser* _userToIgnoreMessagesFrom;
	...
	MNSecureMessagingIdentityKeyViewController* _identifyKeyForLoggedInUserController;
	MNSecureMessagingIdentityKeyViewController* _identifyKeyForOtherUserController;
	/*^block*/id _removeUserCompletionBlock;
	UIAlertView* _leaveGroupAlertView;
	UIAlertView* _removeFromThreadAlertView;
	UIAlertView* _ignoreMessagesAlertView;
...
@property (nonatomic,retain) UIAlertView * ignoreMessagesAlertView;                                                            //@synthesize ignoreMessagesAlertView=_ignoreMessagesAlertView - In the implementation block
...
@property (nonatomic,readonly) MNSecureMessagingIdentityKeyViewController * identifyKeyForLoggedInUserController;              //@synthesize identifyKeyForLoggedInUserController=_identifyKeyForLoggedInUserController - In the implementation block
@property (nonatomic,readonly) MNSecureMessagingIdentityKeyViewController * identifyKeyForOtherUserController;                 //@synthesize identifyKeyForOtherUserController=_identifyKeyForOtherUserController - In the implementation block
+(Class)injectorClass;
-(void)_leaveGroup;
...
-(void)setIgnoreMessagesAlertView:(UIAlertView *)arg1 ;
-(UIAlertView *)ignoreMessagesAlertView;
-(void)_didFetchSurveyManager:(id)arg1 ;
-(void)_showIgnoreMessagesSurvey;
...
-(void)_ignoreMessagesFromUser:(id)arg1 ;
...
-(MNSecureMessagingIdentityKeyViewController *)identifyKeyForLoggedInUserController;
-(MNSecureMessagingIdentityKeyViewController *)identifyKeyForOtherUserController;
...
-(void)threadDetailsViewController:(id)arg1 didSelectIgnoreMessages:(id)arg2 funnelLogger:(id)arg3 ;
...
-(void)threadDetailsViewController:(id)arg1 didTapPageAboutButtonWithUser:(id)arg2 ;
-(void)threadDetailsViewController:(id)arg1 didCommitSendingWithAttachment:(id)arg2 extraClientTags:(id)arg3 ;
