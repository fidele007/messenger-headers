...
#import <FBSharedFramework/MNPageResponsivenessUpdaterListener.h>
#import <Messenger/MNWelcomeNuxUpdaterListener.h>

@protocol MNAuthenticationManager, MNMessageListFetchedMemoryStateAffirming, MNMessageRefreshNetworkRunnerListening, MNPendingThreadQuerying, MNUserChangedListener, MNUserMonitoring, MNThreadViewModelUpdateMonitorListening, OS_dispatch_queue, FBClock, MNUserRetriever, MNMessagesModelControllerDelegate;
...
@interface MNMessagesModelController : NSObject <MNTypingNotificationManagerDelegate, MNMessagesModelControllerMessagesLoaderDelegate, FBMMessageReceivedLegacyListening, MNPushMessageReceivedListening, MNMessageRefreshNetworkRunnerListening, MNMessagesModelControllerThreadViewModelMonitorAdapterDelegate, MNUserRetrieverDelegate, MNThreadViewModelConfigurable, FBMMessageSendListening, FBMThreadMessageSenderListening, MNPendingThreadRequestListening, MNAttributionAppSupplementaryInfoLoaderListener, MNThreadContextManagerListener, MNPageResponsivenessUpdaterListener, MNWelcomeNuxUpdaterListener> {
	...
	id<MNUserChangedListener> _userChangedListenerDispatcher;
...
-(void)_updateReadStateForUserIfNecessary:(id)arg1 ;
