...
@class FBLeadGenToolbox;

@interface FBLeadGenContextPageComponent : CKCompositeComponent {

	FBLeadGenToolbox* _toolbox;
	CKTypedComponentAction<> _updateStateAction;

}
+(id)newWithContextInfo:(id)arg1 updateStateAction:(CKTypedComponentAction<>)arg2 toolbox:(id)arg3 ;
