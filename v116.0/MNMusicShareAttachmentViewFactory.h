...
@class MNMusicShareAttachmentViewFactoryInjector, NSString;

@interface MNMusicShareAttachmentViewFactory : NSObject <FBClassInjectable, MNAttachmentStyleViewFactory> {

	MNMusicShareAttachmentViewFactoryInjector* _injector;
