...
@property (nonatomic,copy) NSArray * friendRequesteeIds; 
@property (nonatomic,copy) NSString * source; 
@property (nonatomic,copy) NSArray * warnAckForIds; 
@property (nonatomic,copy) NSString * peopleYouMayKnowLocation; 
@property (nonatomic,copy) NSArray * refs; 
