...
#import <Messenger/FBNANavigationCoordinatorProvider.h>
...
@class NSArray, FBUserSession, FBNativeArticleDisplayConfiguration, FBNativeArticlePreloadCoordinator, FBAccessibilityScrollState, FBRichStoryBlockControllerRegistry, FBNativeArticleInteractionRegistry, FBNativeArticleResourceBundle, FBNativeArticleTransitionDriver, FBNativeArticleTransitionCache, NSMutableDictionary, FBNativeArticlePreloadHandler, FBReusePoolController, FBNAPinnedOverlayController, FBAnimationPerformanceLogger, FBNativeArticleBlockVPVLogger, FBNativeArticleRendererController, ASDisplayNode, FBRichStoryViewModel, NSString, FBNativeArticleScrollHandler, FBNativeArticleScrollView, FBRichStoryRendererController, NSDictionary;

@interface FBNativeArticleController : NSObject <FBAnalyticsTrackingCodesDataSource, FBDescribable, FBModalPresentationSource, FBNativeArticleOrientationSwitch, FBNativeArticlePopoverHostingViewProvider, FBNativeArticlePreloadHandlerDelegate, FBNativeArticleScrollHandlerDelegate, FBNativeArticleScrollViewGestureHandling, FBNativeArticleTransitionDriverDelegate, _FBNativeArticleScrollNodeDelegate, FBNativeArticleTransitionLayoutGenerator, FBNAPinnedOverlayControllerDelegate, FBNANavigationCoordinatorProvider, UIScrollViewDelegate, FBRichStoryRendererControllerDelegate, FBCardVisibility, FBIntentHandler> {

	FBUserSession* _session;
	FBNativeArticleDisplayConfiguration* _displayConfiguration;
	FBNativeArticlePreloadCoordinator* _preloadCoordinator;
	FBAccessibilityScrollState* _accessibilityScrollState;
	...
	SCD_Struct_FB32 _delegateMethods;

}

@property (assign,nonatomic) SCD_Struct_FB32 delegateMethods;                                    //@synthesize delegateMethods=_delegateMethods - In the implementation block
...
-(void)setDelegateMethods:(SCD_Struct_FB32)arg1 ;
...
-(SCD_Struct_FB33)_transitioningBlockControllerMethodsForBlock:(id)arg1 ;
...
-(SCD_Struct_FB32)delegateMethods;
