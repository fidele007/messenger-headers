...
@protocol FBProvider;
@class MNAddMembersRequestListenerAnnouncer, FBMThreadSummary, FBKeyboardObserver, MNUserSettings, NSArray, MNAddMembersView, MNTopContactsRetriever, MNContactsRetrieverSimpleLogger, MNAddressBookContactSyncPolicy, MNPeoplePickerViewController, FBMBatchMembersAdder, UIAlertView, MNNavigationBarController, MNProgressBarController, NSString;
...
@interface MNAddMembersViewController : FBContainerViewController <FBKeyboardObserverDelegate, FBMMembersAdderDelegate, MNPeoplePickerViewControllerDelegate, UIAlertViewDelegate, FBClassProvidable, MNDismissableViewController> {
	...
	MNAddMembersRequestListenerAnnouncer* _addMembersRequestAnnouncer;
...
-(id)progressTitleId;
-(void)addAddMembersRequestListener:(id)arg1 ;
-(void)removeAddMembersRequestListener:(id)arg1 ;
