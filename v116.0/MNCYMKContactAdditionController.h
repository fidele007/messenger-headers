...
@class MNCYMKContactAdditionRequester, MNCYMKContactAdditionListeningAnnouncer, MNContactAnalyticsLogger, NSString;
...
-(id)initWithContactAdditionRequester:(id)arg1 cymkContactAdditionListeningAnnouncer:(id)arg2 contactAnalyicsLogger:(id)arg3 ;
