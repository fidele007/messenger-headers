...
-(id)initWithAudioRecorderProvider:(id)arg1 composerIconProvider:(id)arg2 modalPresentationStackManagerProvider:(id)arg3 soundController:(id)arg4 applicationName:(id)arg5 webRTCHandler:(id)arg6 userSettings:(id)arg7 composerConfiguration:(id)arg8 ;
