...
@class FBLazyCreator, MNReactNativeNavigationHandler, NSString;

@interface MNReactNativeUrlHandler : NSObject <RCTBridgeDelegate, MNUrlHandlerExtending> {

	FBLazyCreator* _bridgeCreator;
	MNReactNativeNavigationHandler* _navigationHandler;
