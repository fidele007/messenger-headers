...
@class UICollectionView, NSArray, NSDictionary, MNPhotoViewImageDownloadController, NSIndexPath, UIView, MNMediaCollectionLoadingView, NSMutableDictionary, FBUserSession, FBMobileConfigContextManager, NSString;
...
-(id)initWithMediaFetcher:(id)arg1 photoDownloadController:(id)arg2 viewPreviewingHandler:(id)arg3 layout:(long long)arg4 iconControllerProvider:(id)arg5 nullStateView:(id)arg6 decorateView:(id)arg7 listener:(id)arg8 showsHorizontalScrollIndicator:(BOOL)arg9 userSession:(id)arg10 configManager:(id)arg11 ;
