...
@interface FBFilmStripView : UIView <FBVideoFilmstripViewDataSource, FBVideoFilmstripViewDelegate> {
	...
	SCD_Struct_FB181 _videoTimeRange;
	double _videoAspect;
...
-(double)xPositionForTime:(SCD_Struct_FB180)arg1 inView:(id)arg2 ;
...
-(SCD_Struct_FB181)timeRangeForRect:(CGRect)arg1 ;
-(SCD_Struct_FB181)timeRangeOnScreen;
