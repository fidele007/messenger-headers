...
@class MNPhotoViewImageDownloadController, FBLazyCreator, MNMontageViewMessageWrapper, MNPhotoViewModel, MNImage, MNMontagePlaybackTimer, NSString;

@interface MNMontagePhotoController : NSObject <MNMontagePlaybackTimerDelegate, MNMontageMessageController> {
