...
@class NSObject, AVCaptureVideoPreviewLayer, AVCaptureSession, RTCFakeCaptureSession, AVCaptureVideoDataOutput, NSMutableArray, RTCVideoSnapshotRequestManager, RTCVideoPreviewView, RTCVideoCaptureSessionListenerAnnouncer, NSString;
...
@interface RTCVideoCaptureSession : NSObject <AVCaptureVideoDataOutputSampleBufferDelegate, RTCVideoSnapshotSource> {
	...
	RTCFakeCaptureSession* _fakeCaptureSession;
	...
	NSString* _currentCaptureQuality;
...
-(void)_cameraRuntimeError:(id)arg1 ;
...
-(void)_startListeningForCameraError;
