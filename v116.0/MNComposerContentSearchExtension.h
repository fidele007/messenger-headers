...
@protocol FBProvider, MNComposerConfiguring, MNComposerExtensionSendDelegate, MNComposerExtensionEditDelegate, MNActionNuxPresenter, MNComposerTooltipPresenting, MNComposerContentSearchExtensionDelegate;
@class MNComposerExtensionPopupPresentationStrategy, FBLazyCreator, MNComposerPreviewViewController, NSString, UIColor;
