...
@property (nonatomic,copy) NSArray * inviteePhoneNumbers; 
@property (nonatomic,copy) NSArray * inviteeFbids; 
@property (nonatomic,copy) NSArray * inviteeContactTokenIds; 
@property (nonatomic,copy) NSString * invitedAppId; 
@property (nonatomic,copy) NSString * threadFbid; 
