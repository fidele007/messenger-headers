...
-(id)_elementDescriptorForRelatedContentBlock:(id)arg1 metrics:(id)arg2 presentationAttributes:(id)arg3 ;
-(id)_elementDescriptorForEventCollectionBlock:(id)arg1 metrics:(id)arg2 presentationAttributes:(id)arg3 ;
-(id)_elementDescriptorForCTABlock:(id)arg1 fullBleed:(BOOL)arg2 compressed:(BOOL)arg3 ;
