...
@class FBGraphQLConnectionStoreListenerAnnouncer, FBGraphQLConnectionStoreStateChangeListenerAnnouncer, NSString;

@interface FBGraphQLConnectionStoreModificationAnnouncer : NSObject <FBGraphQLConnectionStoreListener> {

	FBGraphQLConnectionStoreListenerAnnouncer* _storeListenerAnnouncer;
	FBGraphQLConnectionStoreStateChangeListenerAnnouncer* _stateChangeListenerAnnouncer;
...
-(id)initWithStoreListenerAnnouncer:(id)arg1 stateChangeListenerAnnouncer:(id)arg2 ;
@end
