...
@class UIApplication, FBUsageTimeLogger, FBUsageTimeComparisonLogger, FBPowerMetrics, NSString, FBBackgroundEventList, NSMutableDictionary, NSArray, NSObject, FBBackgroundTimeState;
