...
@class FBMPushLogger, FBAnalytics, UIApplication, FBMPushHandlerExtensionController, OrcaPushRegistrar, FBMMessageLocalNotificationScheduler, MNBadgeCountEventTracker, FBMAPNSMessageListenerAnnouncer, MNMessageLocalNotificationSharedHistoryCache, NSString;
...
@interface FBMAPNSPushHandler : NSObject <FBViewerContextClassProvidable, FBMConfigurable> {
	...
	MNMessageLocalNotificationSharedHistoryCache* _localNotificationSharedHistoryCache;
...
-(void)_handleMessengerPromotionPush:(id)arg1 launchedByUser:(BOOL)arg2 withHandledCompletionBlock:(/*^block*/id)arg3 ;
...
-(void)_handleRoomNotificationPushWithRoomNotificationType:(id)arg1 launchedByUser:(BOOL)arg2 handledCompletionBlock:(/*^block*/id)arg3 ;
