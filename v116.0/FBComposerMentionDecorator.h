...
@interface FBComposerMentionDecorator : NSObject <UITableViewDelegate, UITableViewDataSource, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, FBMemAvatarTaggingSearchProviderDelegate> {
	...
	BOOL _allowMultipleMentionsOfSameEntity;
...
-(id)initWithSession:(id)arg1 allowMultipleMentionsOfSameEntity:(BOOL)arg2 ;
...
-(SCD_Struct_FB186)_detectChangedRangeIn:(id)arg1 from:(id)arg2 probableChangeEnd:(unsigned long long)arg3 ;
...
-(void)_reportCollectionIDs:(id)arg1 forText:(id)arg2 ;
