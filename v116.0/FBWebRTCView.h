...
#import <Messenger/FBWebRTCDraggableOverlayViewDelegate.h>
...
@class FBWebRTCNonZeroRatedSessionWarningView, UIView, UIImageView, UILabel, FBWebRTCPeerView, FBWebRTCHideFullScreenButton, FBWebRTCDraggableOverlayView, FBWebRTCInteractionBlockingView, FBWebRTCActiveAudioSpeakerView, FBWebRTCCountdownView, FBWebRTCRingGroupNoticeView, FBWebRTCFilterSelectionView, UICollectionView, NSMutableArray, _FBTouchCapturingGestureRecognizer, UIPanGestureRecognizer, FBWebRTCCallViewModel, FBWebRTCSession, MNUserSettings, FBUserSession, NSTimer, FBMUserName, FBWebRTCRemoteVideoRenderStatus, FBMobileConfigContextManager, FBWebRTCStarRatingView, FBWebRTCInfoView, FBWebRTCAudioRosterView, FBWebRTCVideoView, FBWebRTCCallActionView, RTCGroupVideoView, FBWebRTCPeerVideoView, NSString;

@interface FBWebRTCView : UIView <FBWebRTCCallActionViewDelegate, FBWebRTCDraggableOverlayViewDelegate, FBWebRTCInteractionBlockingViewDelegate, FBWebRTCRingGroupNoticeViewDelegate, FBWebRTCFilterSelectionViewDelegate, VideoRenderInfoDelegate, FBWebRTCStarRatingPresentingView> {
	...
	FBWebRTCHideFullScreenButton* _hideButton;
	FBWebRTCDraggableOverlayView* _draggableSelfVideoOverlayView;
	FBWebRTCDraggableOverlayView* _draggablePeerVideoOverlayView;
	...
	FBWebRTCFilterSelectionView* _beautificationSelectionView;
	...
	BOOL _videoActionsViewEnabled;
	BOOL _reactionActive;
	...
	unsigned long long _peerToPeerVideoLayout;
...
@property (nonatomic,readonly) FBWebRTCPeerView * peerView;                                                      //@synthesize peerView=_peerView - In the implementation block
...
@property (assign,nonatomic) unsigned long long peerToPeerVideoLayout;                                           //@synthesize peerToPeerVideoLayout=_peerToPeerVideoLayout - In the implementation block
...
-(void)_configurePeerToPeerVideoLayoutForViewState:(unsigned long long)arg1 ;
-(void)_didPressHideButton:(id)arg1 ;
-(void)_createCountdownViews;
-(void)_stopVideoDisabledMessageTimer;
-(void)setOverlayActive:(BOOL)arg1 animated:(BOOL)arg2 ;
-(void)setFilterViewVisible:(BOOL)arg1 animated:(BOOL)arg2 forFilterType:(long long)arg3 ;
...
-(BOOL)_isAnyFilterSelectionUIVisible;
-(BOOL)isFilterSelectionUIVisibleForFilterType:(long long)arg1 ;
-(void)_updateFrameForDraggableView:(id)arg1 ;
-(void)_refreshAllAloneOverlay;
-(void)_logAction:(id)arg1 forFunnel:(id)arg2 withTag:(id)arg3 ;
-(void)_onSwipeToMinimize;
-(void)_adjustOrderForSelfview:(BOOL)arg1 ;
-(unsigned long long)sizeTypeForCurrentDevice:(BOOL)arg1 ;
-(void)setPeerToPeerVideoLayout:(unsigned long long)arg1 ;
-(BOOL)_shouldForceHalfAndHalf;
-(BOOL)_showZoomSelfView;
...
-(id)selectionViewForFilterType:(long long)arg1 ;
...
-(void)setStickyFlagOnFilterView:(BOOL)arg1 ;
...
-(BOOL)allAlone;
-(unsigned long long)peerToPeerVideoLayout;
-(void)layoutSubviews;
