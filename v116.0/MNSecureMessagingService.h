...
#import <Messenger/MNSecureMessagingThreadNavigating.h>
...
@interface MNSecureMessagingService : NSObject <FBBackgroundingListener, MNSecureMessagingStartupStateMachineListener, MNSecureMessagingRegistrationStateUpdateListening, MNSecureMessagingCapabilityManualOverrideExecutorDelegate, MNSecureMessagingAccessProtectedDataFailureListening, MNSecureThreadServiceControlling, MNSecureMessageSending, MNSecureImageRequesting, MNSecureMessagingThreadNavigating, MNSecureMessagingBadgeCounting, MNSecureMessagingDeviceInformation, MNSecureMessagingRegisteredDeviceStatusUpdateRunning, MNSecureMessagingServiceManipulating, MNSecureMessagingCapabilityManualOverriding, FBWebRTCEndToEndEncrypting> {
	...
	MNSecureMessagingMigrationAwareCryptoStateLoader* _cryptoStateLoader;
	...
	MNSecureMessagingProtectedDataAvailabilityHandler* _protectedDataHandler;
...
-(void)willNavigateToSecureThreadWithKey:(id)arg1 ;
...
-(id)initWithOmnistore:(id)arg1 userSession:(id)arg2 application:(id)arg3 versionedFileHandler:(id)arg4 authManager:(id)arg5 badgeCountService:(id)arg6 backgroundAnnouncer:(id)arg7 analytics:(id)arg8 ephemeralMessageSystemController:(id)arg9 globalMuteStatusReader:(id)arg10 mobileConfigManager:(id)arg11 currentUserIsIsMinor:(BOOL)arg12 clock:(id)arg13 migrationRunner:(id)arg14 appGroup:(id)arg15 queue:(id)arg16 ;
