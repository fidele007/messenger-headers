...
@interface NTNativeTemplateAnimatingWrappingComponentController : CKComponentController <FBComponentControllerWorkingRangeListening, FBComponentControllerWorkingRangeListenerProviding> {

	BOOL _hasFiredOnLoadActions;
