...
@interface MNPaymentsPeerToPeerPaymentsCheckoutPaymentMethodConfiguration : NSObject <FBPaymentsCheckoutPaymentMethodConfiguration>
...
-(BOOL)cardFormShouldShowCountryPicker;
