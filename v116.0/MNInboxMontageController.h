...
@class MNMontageSeenHeadsController, FBMobileConfigContextManager, MNProfileImageViewController, NSString;

@interface MNInboxMontageController : NSObject <MNHorizontalScrollInboxUnitViewListening> {
