...
-(id)initWithPageID:(id)arg1 threadFBID:(id)arg2 session:(id)arg3 profileImageViewController:(id)arg4 intentHandler:(id)arg5 imageDownloader:(id)arg6 ctaHandler:(id)arg7 userStore:(id)arg8 userInvalidator:(id)arg9 ;
-(void)_fetchPageUser;
