...
@class MNMusicSharePlaybackControllerInjector, FBSystemAVMusicPlayer, NSString;

@interface MNMusicSharePlaybackController : NSObject <FBClassInjectable, MNMessagesAppearanceEventListener> {

	MNMusicSharePlaybackControllerInjector* _injector;
	FBSystemAVMusicPlayer* _musicPlayer;
...
-(void)addMusicPlayerListener:(id)arg1 ;
-(long long)musicPlayerState;
-(void)removeMusicPlayerListener:(id)arg1 ;
