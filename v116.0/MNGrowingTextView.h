...
@interface MNGrowingTextView : UIView <MNComposerTextViewConfiguring, MNTextViewInternalDelegate, FBKeyboardPresenting, UITextViewDelegate> {
...
@property (assign,nonatomic) BOOL placeholderShouldWrap; 
