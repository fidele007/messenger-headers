...
@class FBWebRTCCallStarter, FBWebRTCRecentCallerViewModel, FBWebRTCCallButtonImageProvider, FBWebRTCCallLogView, UITableView, UISearchBar, FBImageDownloader, MNDateFormatter, UISearchDisplayController, MNPeopleSearchController, MNPeopleCellFactory, MNCDNProfileImageDownloader, NSString;
...
-(id)initWithRecentCallerViewModel:(id)arg1 callStarter:(id)arg2 imageDownloader:(id)arg3 dateFormatter:(id)arg4 callButtonImageProvider:(id)arg5 peopleSearchController:(id)arg6 peopleCellFactory:(id)arg7 profileImageDownloader:(id)arg8 ;
