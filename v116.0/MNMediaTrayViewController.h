...
@class MNMediaTrayView, MNMediaTraySelectedImageGenerator, MNMediaTrayVisibilityListeningAnnouncer, MNPermissionsViewController, MNLocalAssetAccessibilityLabelGenerator, FBAssetsLibrary, NSIndexPath, FBViewStateDebouncer, NSArray, FBUserSession, MNMediaTrayConfiguration, NSString;
...
@interface MNMediaTrayViewController : UIViewController <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UIScrollViewDelegate, MNMediaTrayDataSourceDelegate, MNMediaTrayViewPhotoCellDelegate, MNMediaTrayViewDelegate, MNHorizontalLineLayoutDelegate> {
	...
	MNMediaTrayConfiguration* _configuration;
	id<MNMediaTrayViewControllerDelegate> _delegate;
	NSArray* _selectedAssetsIndexPaths;

}

@property (nonatomic,copy) MNMediaTrayConfiguration * configuration;                             //@synthesize configuration=_configuration - In the implementation block
...
-(id)initWithMediaTrayDataSource:(id)arg1 mediaAccessibilityLabelGenerator:(id)arg2 mediaTrayConfiguration:(id)arg3 alertControllerPresenter:(id)arg4 userSession:(id)arg5 ;
-(void)loadSelectedAssetsWithCompletion:(/*^block*/id)arg1 ;
-(void)_initPermissionsViewControllerIfNecessary;
-(void)mediaTrayViewPhotoCellDidSelectSend:(id)arg1 withPhotoQualitySettingOption:(unsigned long long)arg2 ;
-(void)mediaTrayViewPhotoCellDidSelectEdit:(id)arg1 ;
-(void)mediaTrayViewPhotoCellDidTapHdButton:(id)arg1 ;
-(BOOL)mediaTrayViewPhotoCellShouldShowCheckMark:(id)arg1 ;
-(id)_cellReuseIdentifierPhoto;
-(id)_cellReuseIdentifierVideo;
-(id)_cellReuseIdentifierFNFVideo;
...
-(void)_loadAssetAtIndexPath:(id)arg1 withCompletion:(/*^block*/id)arg2 ;
...
-(void)_didSelectEditAtIndex:(long long)arg1 ;
...
-(long long)_currentSelectionStyle;
-(BOOL)_shouldUseFNFPlayerCell;
...
-(void)_mediaTrayDidSelectEditFBVideoAsset:(id)arg1 videoAsset:(id)arg2 thumbnail:(id)arg3 identifier:(id)arg4 ;
...
-(void)viewDidLoad;
-(void)setConfiguration:(MNMediaTrayConfiguration *)arg1 ;
-(MNMediaTrayConfiguration *)configuration;
