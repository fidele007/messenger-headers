...
@interface FB360OrientationTracker : NSObject {
	...
	BOOL _notifyDelegatesForMotionUpdates;
	BOOL _enableDeviceRollUpdate;
	BOOL _paused;
...
@property (assign,nonatomic) BOOL notifyDelegatesForMotionUpdates;                             //@synthesize notifyDelegatesForMotionUpdates=_notifyDelegatesForMotionUpdates - In the implementation block
@property (assign,nonatomic) BOOL enableDeviceRollUpdate;                                      //@synthesize enableDeviceRollUpdate=_enableDeviceRollUpdate - In the implementation block
...
-(BOOL)notifyDelegatesForMotionUpdates;
...
-(void)setNotifyDelegatesForMotionUpdates:(BOOL)arg1 ;
-(void)setEnableDeviceRollUpdate:(BOOL)arg1 ;
