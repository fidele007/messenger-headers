...
-(id)_authenticationFunnelActionPayloadWithTocTarget:(id)arg1 ;
-(id)_authenticationFunnelActionPayloadWithPhoneNumber:(id)arg1 ;
...
-(id)initWithLocaleMap:(id)arg1 analytics:(id)arg2 registrationType:(long long)arg3 igAccessToken:(id)arg4 ;
