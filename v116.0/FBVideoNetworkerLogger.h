...
-(void)logDidFinishConnectionForURL:(id)arg1 socket:(id)arg2 bytes:(unsigned long long)arg3 duration:(unsigned long long)arg4 bytesCached:(unsigned long long)arg5 prefetchedBytesCached:(unsigned long long)arg6 cacheReadDurationMS:(unsigned long long)arg7 prefetchCacheReadDurationMS:(unsigned long long)arg8 offset:(unsigned long long)arg9 requestLength:(unsigned long long)arg10 videoID:(id)arg11 cancelReason:(id)arg12 firstRequest:(BOOL)arg13 isForDiskCache:(BOOL)arg14 ;
