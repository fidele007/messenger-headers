...
@interface MNIGContactsSyncSettingControllerInjector : NSObject <FBInjecting> {
...
-(id)accountConnectionViewControllerFactory;
-(id)loggedInUserInfoManager;
-(id)connectToIGEligibilityChecker;
-(id)igContactsSyncDetailViewControllerFactory;
-(id)analytics;
-(id)modalPresenter;
