...
#import <Messenger/FBGraphQLConnectionSectionComponentUpdateListener.h>

@class NSString;

@interface FBGraphQLConnectionSectionComponentUpdateListenerAnnouncer : FBAnnouncerBase <FBGraphQLConnectionSectionComponentUpdateListener>
