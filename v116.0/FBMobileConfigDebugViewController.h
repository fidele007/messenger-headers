...
-(void)getTroubleshootingInfo:(id)arg1 universe:(id)arg2 paramName:(id)arg3 isSessionless:(BOOL)arg4 ;
...
-(void)warnAboutRestartingApp:(id)arg1 message:(id)arg2 ;
-(void)mobileConfigEnabledChecked:(id)arg1 ;
-(BOOL)checkSandboxSettings;
...
-(void)getQEParamTroubleshootingInfoWithMeta:(config_meta_t)arg1 ;
-(void)getGKTroubleshootingInfoWithMeta:(config_meta_t)arg1 ;
