...
@interface FBComposerAttachment : NSObject <NSCoding, NSCopying> {
	...
	FBComposerContactYourRepresentativeAttachment* _contactYourRepresentativeAttachment_contactYourRepresentativeAttachment;
	FBComposerUnsolicitedRecommendationAttachment* _unsolicitedRecommendationAttachment_unsolicitedRecommendationAttachment;

}
+(id)activityAttachmentWithActivityAttachment:(id)arg1 ;
+(id)contactYourRepresentativeAttachmentWithContactYourRepresentativeAttachment:(id)arg1 ;
