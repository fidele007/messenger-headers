...
@interface FBQuickPromotionCoordinator : NSObject <FBQPPromotionEventHandling> {
	...
	NSMutableDictionary* _stickyPeriodBannerViewControllers;
	NSMutableDictionary* _promotionFirstSeenTimes;
	NSMutableDictionary* _closePromotionCallbacks;
...
-(void)registerForPromotionID:(id)arg1 closePromotion:(/*^block*/id)arg2 ;
...
-(BOOL)closePromotionID:(id)arg1 ;
-(void)recordAction:(id)arg1 promotionID:(id)arg2 nuxID:(id)arg3 ;
