...
@protocol MNComposerConfiguring, FBProvider, MNWebRTCMessagesViewCallControllerDelegate;
@class FBWebRTCCallStarter, MNPresenceSubscriptionService, FBWebRTCCallButtonImageProvider, FBWebRTCGroupCallStarter, FBMobileConfigContextManager, MNThreadPresenceTracker, MNUserSettings, NSString, FBMThreadSummary, FBMIndexedUserSet, UIBarButtonItem, FBWebRTCCallButton, MNFullScreenTooltipController, FBTimer;
...
-(BOOL)_canStartOneOnOneOverMultiway;
-(BOOL)_canShowGroupPresenceIndicator;
-(BOOL)_canShowP2PPresenceIndicator;
-(void)_startTooltipTimerComplete;
-(void)_showInstantVideoTooltipIfNeeded;
-(BOOL)_canShowGroupPresenceIndicatorTooltip;
-(void)_showGroupPresenceEducationTooltipIfNeeded;
...
-(BOOL)_canShowP2PPresenceIndicatorTooltip;
-(void)_showRTCWithPresenceEducationTooltipIfNeeded;
...
-(void)_showRTCWithPresenceEducationTooltip;
-(void)_showGroupPresenceEducationTooltip;
-(id)_getActiveUsersInThread;
-(BOOL)hasButtonsForCurrentMessageThread;
-(BOOL)_isCoPresentWithCapability:(unsigned long long)arg1 ;
