...
@class FBSignalSeamSignalCompositeComponent;

@interface FBSignalSeamSignalCompositeComponentController : CKComponentController {

	Signal<CKComponent *()()>* _componentCreationBlockSignal;

}

@property (nonatomic,readonly) FBSignalSeamSignalCompositeComponent * component; 
