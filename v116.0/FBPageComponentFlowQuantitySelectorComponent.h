...
@class FBMemQuantitySelectorFormField, FBPageComponentFlowComponentContext;

@interface FBPageComponentFlowQuantitySelectorComponent : CKCompositeComponent {

	FBMemQuantitySelectorFormField* _model;
	FBPageComponentFlowComponentContext* _context;

}

@property (nonatomic,readonly) FBMemQuantitySelectorFormField * model;                     //@synthesize model=_model - In the implementation block
...
-(FBMemQuantitySelectorFormField *)model;
@end
