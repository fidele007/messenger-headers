...
-(void)_addUserId:(id)arg1 toSection:(unsigned long long)arg2 ;
-(id)_indexPathForUserId:(id)arg1 ;
-(id)_indexPathForInsertingUserInState:(unsigned long long)arg1 ;
-(void)_swapUserId:(id)arg1 fromSection:(unsigned long long)arg2 toSection:(unsigned long long)arg3 ;
-(id)_collectionView:(id)arg1 addMemberCellForItemAtIndexPath:(id)arg2 ;
-(id)_collectionView:(id)arg1 userCellForItemAtIndexPath:(id)arg2 ;
-(id)_userForIndexPath:(id)arg1 ;
-(void)_fetchProfileImageForUser:(id)arg1 andInsertInCell:(id)arg2 ;
-(void)_removeUserId:(id)arg1 fromSection:(unsigned long long)arg2 ;
...
-(id)initWithImageDownloader:(id)arg1 callButtonImageProvider:(id)arg2 userSession:(id)arg3 userStore:(id)arg4 avatarImageDecoration:(id)arg5 presenceSubscriptionService:(id)arg6 showRingAllButton:(BOOL)arg7 showAddMemberOption:(BOOL)arg8 ;
-(void)configureWithSession:(id)arg1 rosterView:(id)arg2 ;
-(void)addUserIDsIfNotAlreadyExist:(id)arg1 ;
