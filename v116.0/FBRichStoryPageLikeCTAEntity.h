...
-(id)initWithPageName:(id)arg1 pageProfilePictureURL:(id)arg2 socialContext:(id)arg3 friendsWhoLikeProfilePictureURLs:(id)arg4 CTATitle:(id)arg5 viewerLiked:(BOOL)arg6 actionCompleted:(BOOL)arg7 CTAAction:(/*^block*/id)arg8 logViewedAction:(/*^block*/id)arg9 didUpdateTask:(id)arg10 ;
-(BOOL)viewerLiked;
-(NSString *)pageName;
@end
