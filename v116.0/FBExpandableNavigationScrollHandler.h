...
#import <Messenger/FBExpandableNavigationProtocol.h>

@class FBExpandableNavigationBar, UIScrollView, NSString;

@interface FBExpandableNavigationScrollHandler : NSObject <FBExpandableNavigationProtocol> {
...
+(SCD_Struct_FB29)expansionAnimationConfiguration;
-(double)expandableNavigationPercentVisible;
...
-(void)_setNavigationBarExpanded:(BOOL)arg1 animationConfig:(SCD_Struct_FB29)arg2 ;
