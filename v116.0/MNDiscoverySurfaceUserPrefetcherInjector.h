...
@class FBProviderMapData, FBMobileConfigContextManager, MNUserProvider, NSString;

@interface MNDiscoverySurfaceUserPrefetcherInjector : NSObject <FBViewerContextInjecting> {
