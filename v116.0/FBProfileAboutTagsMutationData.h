...
@property (nonatomic,copy) NSArray * addIds; 
@property (nonatomic,copy) NSArray * removeIds; 
@property (nonatomic,copy) NSString * referrerType; 
@property (nonatomic,copy) NSString * referrerId; 
@property (nonatomic,copy) NSString * entityCardPosition; 
@property (nonatomic,copy) NSArray * typeaheadAddIds; 
