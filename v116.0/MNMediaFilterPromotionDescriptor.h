...
@interface MNMediaFilterPromotionDescriptor : FBValueObject <NSCopying> {
...
-(id)initWithSectionId:(id)arg1 promptText:(id)arg2 descriptionText:(id)arg3 tooltipColor:(id)arg4 buttonColor:(id)arg5 imageUrl:(id)arg6 ;
-(NSURL *)imageUrl;
