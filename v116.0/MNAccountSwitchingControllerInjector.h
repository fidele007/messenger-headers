...
-(id)accountSettings;
-(id)pendingAccountController;
-(id)accountUserInformationFetchRequestController;
-(id)accountSwitchingAuthenticatorFactory;
-(id)accountFactory;
-(id)notificationsAccessTokenRequestController;
-(id)notificationsAccessTokenStore;
