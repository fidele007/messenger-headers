...
@class NSURL, NSDictionary, RCTPerformanceLogger, NSLock, RCTImageLoader, RCTImageStoreManager, RCTNetworking, RCTRedBox, RCTDevMenu, RCTAccessibilityManager, RCTUIManager, RCTDevSettings, JSContext, NSArray, NSString;
...
@property (nonatomic,readonly) OpaqueJSContextRef jsContextRef; 
