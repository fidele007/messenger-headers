...
@class MNMontageViewMessageWrapper, MNMontageNuxMessage, FBUserSession, FBLazyCreator, MNMontagePlaybackTimer, NSString;

@interface MNMontageNuxMessageController : NSObject <MNMontageNuxMessageViewDelegate, MNMontagePlaybackTimerDelegate, MNMontageMessageController> {
