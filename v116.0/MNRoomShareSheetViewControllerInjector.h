...
-(id)topContactsRetriever;
-(id)avatarImageDecorator;
-(id)threadSummaryUpdateService;
-(id)externalAppShareController;
-(id)providableStringWithIdentifier:(id)arg1 ;
-(id)groupsSearchModelAdapter;
-(id)messageForwardSender;
-(id)MNBroadcastFlowSuggestedContactsRetriever;
-(id)mobileConfigContextManager;
-(id)externalDataToForwardContentMapper;
