...
-(void)insertData:(id)arg1 key:(id)arg2 range:(NSRange)arg3 expectedContentLength:(unsigned long long)arg4 videoBasicData:(SCD_Struct_FB192)arg5;
-(void)insertBlock:(id)arg1 key:(id)arg2 blockIndex:(unsigned long long)arg3 videoBasicData:(SCD_Struct_FB192)arg4;
