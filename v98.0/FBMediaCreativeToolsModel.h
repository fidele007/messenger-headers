...
@interface FBMediaCreativeToolsModel : NSObject <NSCopying> {
	...
	NSMutableDictionary* _toolsSelectedIndexDictionary;
	NSArray* _filters;
	NSArray* _masks;
...
-(id)selectedEffectIndexForCreativeTool:(Class)arg1 ;
-(void)setSelectedEffectIndex:(id)arg1 forCreativeTool:(id)arg2 ;
