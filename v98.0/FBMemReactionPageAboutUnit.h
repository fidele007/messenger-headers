...
@interface FBMemReactionPageAboutUnit : FBWildeMemModelObject <FBQueriedEntityFieldsProtocol, FBQueriedNodeFieldsProtocol, FBQueriedReactionUnitFieldsProtocol>
@end
