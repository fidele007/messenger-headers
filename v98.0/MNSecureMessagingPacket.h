...
-(id)initWithVersion:(int)arg1 msg_to:(id)arg2 msg_from:(id)arg3 date_micros:(long long)arg4 type:(int)arg5 body:(id)arg6 nonce:(id)arg7 thread_fbid:(long long)arg8 ;
