...
@interface FBEditPageCategoryData : FBGraphQLInput {
...
@property (nonatomic,copy) NSString * pageCategory;                  //@synthesize pageCategory=_pageCategory - In the implementation block
