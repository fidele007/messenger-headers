...
@class NSString, UIColor, FBUserSession, MNComposerExtensionTrayPresentationStrategy, MNNavigationCoordinator, MNThreadNavigationCoordinator, FBMessengerPaymentsPlugin, FBMobileConfigContextManager, FBLazyCreator, MNPaymentsGroupCommerceDollarGlyphPromotionExperimentContext;
...
@interface MNComposerPaymentExtension : NSObject <FBPaymentsPeerToPeerFeatureGatingControllerListener, FBPaymentsPeerToPeerSendFlowControllerDelegate, FBPaymentsEventListener, FBClassProvidable, MNComposerExtension> {
	...
	MNPaymentsGroupCommerceDollarGlyphPromotionExperimentContext* _groupCommerceExperimentContext;
...
-(void)_modallyPresentSendMoneyViewControllerWithFlowId:(id)arg1 recipient:(id)arg2 invitees:(id)arg3 groupThreadKey:(id)arg4 introductionViewType:(long long)arg5 ;
