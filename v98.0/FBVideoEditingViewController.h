...
@interface FBVideoEditingViewController : UIViewController <FBVideoTrimViewDelegate, FBVideoEditingPlaybackViewDelegate, FBVideoVolumeControlViewDelegate, FBAudioSessionManagerClient, UIScrollViewDelegate, FBVideoCreativeToolsApplier, FBVideoFilterViewsUpdateProtocol, FBVideoScrubberViewDelegate> {
	...
	SCD_Struct_FB25 _videoMinLength;
	SCD_Struct_FB25 _videoMaxLength;
	SCD_Struct_FB25 _frameOffset;
	SCD_Struct_FB25 _keyTime;
...
@property (assign,nonatomic) SCD_Struct_FB25 keyTime;                                                                     //@synthesize keyTime=_keyTime - In the implementation block
...
@property (assign,nonatomic) SCD_Struct_FB25 frameOffset;                                                                 //@synthesize frameOffset=_frameOffset - In the implementation block
...
@property (assign,nonatomic) SCD_Struct_FB25 videoMinLength;                                                              //@synthesize videoMinLength=_videoMinLength - In the implementation block
@property (assign,nonatomic) SCD_Struct_FB25 videoMaxLength;                                                              //@synthesize videoMaxLength=_videoMaxLength - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_FB25 videoPosition; 
...
-(void)setKeyTime:(SCD_Struct_FB25)arg1 ;
-(SCD_Struct_FB25)keyTime;
-(void)setFrameOffset:(SCD_Struct_FB25)arg1 ;
...
-(void)playbackView:(id)arg1 didPlayToTime:(SCD_Struct_FB25)arg2 ;
...
-(void)_trimValueChanged:(id)arg1 autoplay:(BOOL)arg2 fromScrubTime:(SCD_Struct_FB25)arg3 ;
...
-(void)_continuePlayingAfterUserInteractionFromScrubTime:(SCD_Struct_FB25)arg1 ;
