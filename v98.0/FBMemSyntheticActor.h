...
@interface FBMemSyntheticActor : FBWildeMemModelObject <FBAvatarProtocol, FBQueriedActorFieldsProtocol, FBQueriedEntityFieldsProtocol, FBQueriedNodeFieldsProtocol>
-(id)entityURL;
@end
