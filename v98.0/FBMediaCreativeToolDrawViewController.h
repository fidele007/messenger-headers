...
@class FBMediaCreativeToolsModel, FBVideoCreativeToolsPreviewOverlayView, FBMediaCreativeToolbar, UIView, FBPanGestureRecognizer, NSIndexPath, FBMediaCreativeToolDrawView, NSString;
...
-(id)initWithCreativeToolsApplier:(id)arg1 model:(id)arg2 selectedIndex:(id)arg3 rawVideoSize:(CGSize)arg4 videoOverlayView:(id)arg5 logger:(id)arg6 extraLoggerBlock:(/*^block*/id)arg7 ;
