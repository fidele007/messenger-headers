...
@class FBMediaPickerSession, NSMutableDictionary, UICollectionView, FBMagicStoriesPreviewViewController, FBKVOController, UIView, FBPinchGestureRecognizer, FBAnimationPerformanceLogger, FBMagicStoryPickerCollectionDataSource, FBMediaPickerThumbnailDownloaderFactory, UILabel, FBScrollViewVideoCoordinator, NSMutableArray, UIImage, FBLibraryThumbnailView, FBAssetsRankedDataSource, NSArray, NSString;
