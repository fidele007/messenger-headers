...
@class FBMessengerPaymentsPlugin, FBUserSession, NSString;

@interface MNPaymentsAttachmentStyleViewModelCreator : NSObject <FBViewerContextClassProvidable, MNAttachmentStyleViewModelCreator> {
