...
-(void)authorizeUsingSystemAccountStore:(id)arg1 defaultAudience:(unsigned long long)arg2 FBAppAuth:(BOOL)arg3 safariAuth:(BOOL)arg4 fallback:(BOOL)arg5 isReauthorize:(BOOL)arg6 ;
