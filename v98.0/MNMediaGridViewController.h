...
@protocol MNPhotosDataSource, MNPhotosDataRequesting, MNMediaGridViewControllerDelegate;
@class MNCollectionViewUpdater, MNAssetsListController, MNMediaPickerAccessibilityLabelGenerator, PHAssetCollection, MNMultiAssetPickerViewController, MNMediaGridView, PHImageRequestOptions, NSString;
