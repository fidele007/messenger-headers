...
-(void)setVisibleOverlayAnnotations:(id)arg1 withAnimation:(SCD_Struct_FB40)arg2 ;
...
-(void)setVisibleOverlayAnnotations:(id)arg1 withAnimation:(SCD_Struct_FB40)arg2 completion:(/*^block*/id)arg3 ;
-(void)_animateUnderlayVisibility:(BOOL)arg1 completionBlock:(/*^block*/id)arg2 ;
-(void)setInterfaceOrientation:(long long)arg1 animationConfig:(SCD_Struct_FB40)arg2 ;
