...
@protocol FBProvider, MNModalPresentation, MNActionNuxPresenter;
@class MNAppleMediaPickerController, MNCameraViewController, ZRTariffedUxSentry, FBUserSession, MNUserSettings, MNImageRequester, MNImageUploadCandidateStore, FBLazyCreator, MNComposerCameraExtensionListenerAnnouncer, MNComposerCameraExtensionLogger, MNComposerExtensionInitiator, FBWebRTCDevice, NSString, UIColor;
...
-(id)initWithCameraViewControllerProvider:(id)arg1 userSession:(id)arg2 userSettings:(id)arg3 navigationCoordinator:(id)arg4 imageUploadCandidateStore:(id)arg5 imageRequester:(id)arg6 composerIconProvider:(id)arg7 webRTCDevice:(id)arg8 ;
