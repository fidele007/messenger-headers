...
@protocol FBProvider;
@class MNSecureThreadInterstitialController, NSString;

@interface MNSecureThreadInterstitialUrlHandler : NSObject <MNUrlHandlerExtending> {
...
-(BOOL)isPublic;
-(id)initWithSecureThreadInterstitialControllerProvider:(id)arg1 ;
@end
