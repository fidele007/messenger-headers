...
@interface FBUINavigationController : FBContainerViewController <FBAnimatedTransitionDelegate, FBAnimatedTransitionRunnerDelegate, UINavigationBarDelegate, FBUINavigationContainerViewDelegate, CAAnimationDelegate> {
	...
	BOOL _usesLegacySetViewControllers;
...
@property (assign,nonatomic) BOOL usesLegacySetViewControllers;                                       //@synthesize usesLegacySetViewControllers=_usesLegacySetViewControllers - In the implementation block
...
-(void)setUsesLegacySetViewControllers:(BOOL)arg1 ;
...
-(void)_olde_setViewControllers:(id)arg1 withDirection:(unsigned long long)arg2 animated:(BOOL)arg3 ;
...
-(BOOL)usesLegacySetViewControllers;
