...
@interface FBWebRTCScreenSensorCallListener : NSObject <FBWebRTCEngineListener> {
...
@property (nonatomic,retain) FBWebRTCEngine * engine;               //@synthesize engine=_engine - In the implementation block
...
-(void)setEngine:(FBWebRTCEngine *)arg1 ;
