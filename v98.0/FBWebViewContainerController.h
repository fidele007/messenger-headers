...
@protocol FBNuxBannerViewController, FBCancelable, FBBrowserSurface, FBMinimizableModalViewControllerDelegate_DEPRECATED, FBWebViewContainerControllerDelegate, FBBrowserScrollViewDelegate, FBWebViewContainerControllerBannerProvider, FBIntentHandler;
@class NSString, UIView, FBUserSession, FBPopoverActionSheet, FBPopoverController, FBPopoverInfo, UIViewController, FBNuxController, UIColor, FBBrowserLayoutView, NSMutableArray, FBPulseWebViewBannerProvider, FBSavedUrlNuxManager, NSURL, FBBrowserRelatedStoriesViewController, FBProgressAnimator, FBWebViewController, FBBrowserSaveConfig, FBBrowserShareNowConfig, FBBrowserLayoutConfig, FBAnalyticsInfo, FBMemFeedStory;
