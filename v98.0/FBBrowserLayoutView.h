...
@class UIView, UIScrollView, FBContentInsetTracker, FBBrowserHeaderView, FBBrowserFooterView, FBBrowserShareQuoteView, FBBrowserLayoutConfig, FBFeedToolbox, FBUserSession, NSValue, FBMemFeedStory, NSString, FBBrowserDebugOverlayCoordinator, UIButton;
...
-(id)initWithWebView:(id)arg1 scrollView:(id)arg2 webViewContentInsetTracker:(id)arg3 browserSurface:(id)arg4 layoutConfig:(id)arg5 browserLayoutViewDelegate:(id)arg6 feedStory:(id)arg7 session:(id)arg8 toolbox:(id)arg9 ;
