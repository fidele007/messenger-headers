...
@class MNSettingsView, NSArray, MNOmniMSuggestionModeSettingController, FBMobileConfigContextManager, MNOmniMSettingsStore, MNOmniMRidesPrefSettingController, NSString;
...
-(id)initWithOmniMSuggestionModeController:(id)arg1 omniMRidesPrefController:(id)arg2 configManager:(id)arg3 omniMSettingsStore:(id)arg4 ;
