...
-(id)initWithWaterfallID:(id)arg1 asset:(id)arg2 uploadConfig:(id)arg3 transcodeParams:(id)arg4 maxRetries:(unsigned long long)arg5 networkDispatcher:(id)arg6 kvObjectStore:(id)arg7 pkvStore:(id)arg8 delegate:(id)arg9 loggingInfo:(id)arg10 useFileStreaming:(BOOL)arg11 segmentationSizeMB:(unsigned long long)arg12 ;
-(void)_fetchedServerSettings:(SCD_Struct_FB313)arg1 ;
