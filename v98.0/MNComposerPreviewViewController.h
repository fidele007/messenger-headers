...
@protocol MNMediaCollectionFetching, MNViewPreviewingHandling, MNMediaCollectionViewControllerListener, MNComposerPreviewViewControllerDelegate;
@class MNMediaCollectionViewController, FBUserSession, MNPhotoViewImageDownloadController, FBMobileConfigContextManager, MNComposerPreviewView, MNComposerBigPreviewGestureHandler, MNMediaCollectionNullStateView, NSString, NSArray;
...
-(id)initWithSession:(id)arg1 photoDownloadController:(id)arg2 viewPreviewingHandler:(id)arg3 listener:(id)arg4 configManager:(id)arg5 showsHorizontalScrollIndicator:(BOOL)arg6 ;
