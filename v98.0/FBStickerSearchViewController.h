...
@class FBUserSession, FBStickerSearchView, FBTimeThrottler, FBStickerTagsDataSource, FBStickerSearchPerformer, FBStickerSearchTagsController, FBStickerSearchResultsController, FBMStickerManager, FBStickerPreviewGestureHandler, NSString, FBStickerPushedSearchResultsViewController, UIColor, UINavigationController;
