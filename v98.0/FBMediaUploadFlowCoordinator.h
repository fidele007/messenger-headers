...
-(void)startUploadFlowForAsset:(id)arg1 waterfallID:(id)arg2 uploadConfig:(id)arg3 transcodeParams:(id)arg4 maxRetries:(unsigned long long)arg5 priorityStatus:(int)arg6 loggingInfo:(id)arg7 useFileStreaming:(BOOL)arg8 segmentationSizeMB:(unsigned long long)arg9 ;
