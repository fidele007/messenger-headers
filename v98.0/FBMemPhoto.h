...
@interface FBMemPhoto : FBWildeMemModelObject <FBRichStoryEntityMediaProtocol, FBDisplayableMedia, FBFeedbackTargetProtocol, FBPhotoTaggingAssetProtocol, FBSearchPivotsSource, FBShareable, FBQueriedEntityFieldsProtocol, FBQueriedGoodwillThrowbackAccentImageFieldsProtocol, FBQueriedMediaFieldsProtocol, FBQueriedNodeFieldsProtocol, FBQueriedProfileOverlayableMediaFieldsProtocol, FBQueriedSearchCombinedResultFieldsProtocol, FBQueriedSearchResultFieldsProtocol>
