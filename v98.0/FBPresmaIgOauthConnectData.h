...
@interface FBPresmaIgOauthConnectData : FBGraphQLInput {
...
@property (nonatomic,copy) NSString * redirectURLString;              //@synthesize redirectURLString=_redirectURLString - In the implementation block
...
-(NSString *)actorId;
-(void)setRedirectURLString:(NSString *)arg1 ;
