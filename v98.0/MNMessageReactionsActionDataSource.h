...
@class NSObject, MNMessageReactionsActionModel, MNMessageReactionsActionDataSourceInjector, NSString;

@interface MNMessageReactionsActionDataSource : NSObject <FBClassInjectable> {

	NSObject*<OS_dispatch_queue> _queue;
	MNMessageReactionsActionModel* _messageReactionsActionModel;
