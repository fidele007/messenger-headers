...
@interface FBBrowserExtensionAutofillGroupBasicString : NSObject <FBBrowserExtensionAutofillGroup> {
...
-(BOOL)_joinStringIfNonEmpty:(id)arg1 withCommaToBaseString:(id)arg2 ;
