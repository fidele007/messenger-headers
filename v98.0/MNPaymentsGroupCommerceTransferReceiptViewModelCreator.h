...
@class FBUserSession, FBPaymentsPeerToPeerTransferStatusModelContainer, MNPaymentsPeerToPeerTransferReceiptViewModelCreator, NSString;

@interface MNPaymentsGroupCommerceTransferReceiptViewModelCreator : NSObject <MNPaymentsTransferReceiptViewModelCreator> {

	FBUserSession* _session;
	FBPaymentsPeerToPeerTransferStatusModelContainer* _transferStatusModelContainer;
	MNPaymentsPeerToPeerTransferReceiptViewModelCreator* _peerToPeerTransferReceiptViewModelCreator;
...
-(id)initWithSession:(id)arg1 transferStatusModelContainer:(id)arg2 transferReceiptViewModelCreator:(id)arg3 ;
@end
