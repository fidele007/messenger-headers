...
@class MNSecureMessagingRegisterResponsePayload, MNSecureMessagingLookupResponsePayload, MNSecureMessagingSendResultPayload, MNSecureMessagingCreateThreadResponsePayload, MNSecureMessagingBatchLookupResponsePayload, NSString;
...
-(id)initWithRegister_response_payload:(id)arg1 lookup_response_payload:(id)arg2 send_result_payload:(id)arg3 create_thread_response_payload:(id)arg4 batch_lookup_response_payload:(id)arg5 ;
