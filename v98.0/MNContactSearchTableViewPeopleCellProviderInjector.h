...
@class FBProviderMapData, MNPeopleCellFactory, MNThreadParticipantNameFormatter, NSString;

@interface MNContactSearchTableViewPeopleCellProviderInjector : NSObject <FBInjecting> {
