...
@class FBCLEventChannel, FBCLLocationCache, NSArray, FBCLLocationUpdaterDecider, FBUserSession, FBCLTickEventSource, FBCLPermissionManager, FBBackgroundTaskHandler, FBCLLocationLogger, FBCLLocationUpdateListenerAnnouncer, FBScenePath, FBLocationGraphRequestFactory, FBGeoFenceEventListener, FBGeoFenceLogger, FBCLLocationUpdateSender, NSString;
