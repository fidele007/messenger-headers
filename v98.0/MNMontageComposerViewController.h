...
@class FBLazyCreator, FBKeyboardObserver, FBUserSession, MNMontageBroadcastSender, MNImageUploadCandidateStore, MNSuggestedContactsRetrieverWithHoistedMontageContact, MNMontageAudienceNUXManager, FBMLoggedInUserInfoManager, FBMobileConfigContextManager, MNMontageComposerAnalyticsLogger, NSString, FBCameraRollWriter, MNMontageComposerState, MNMontageComposerEditingState, MNMontageCaptureInteractionController, MNMontageComposerDefaultState, MNMontageMediaPickerViewController;
...
-(id)initWithCameraViewControllerProvider:(id)arg1 mediaPickerViewControllerProvider:(id)arg2 broadcastViewControllerProvider:(id)arg3 artPickerViewControllerProvider:(id)arg4 montageAudienceSettingsViewControllerProvider:(id)arg5 contactsRetriever:(id)arg6 userSession:(id)arg7 montageBroadcastSender:(id)arg8 imageUploadCandidateStore:(id)arg9 montageAudienceNUXManagerProvider:(id)arg10 loggedInUserInfoManager:(id)arg11 configManager:(id)arg12 confirmationViewPresenter:(id)arg13 applicationName:(id)arg14 mediaSendSourcePrefix:(id)arg15 modalPresenter:(id)arg16 hudCoordinatorProvider:(id)arg17 composerDefaultState:(id)arg18 ;
