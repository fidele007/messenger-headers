...
-(id)initWithUserSession:(id)arg1 localeMap:(id)arg2 userLoginProvider:(id)arg3 mainAppCredentialsFetcher:(id)arg4 loginViewConfiguration:(id)arg5 loginErrorHandler:(id)arg6 loginCredentialsHandler:(id)arg7 ;
