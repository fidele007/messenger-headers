...
+(id)messengerExtensionTargetForNativeURL:(id)arg1 actionTriggeredTime:(double)arg2 browserDisplayHeightRatio:(double)arg3 attribution:(id)arg4 surface:(id)arg5 shouldHideBrowserBottomBar:(BOOL)arg6 ;
