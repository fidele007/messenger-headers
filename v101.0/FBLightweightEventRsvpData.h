...
@interface FBLightweightEventRsvpData : FBGraphQLInput {

	NSString* _clientMutationId;
	NSString* _actorId;
	NSString* _eventId;
	NSString* _guestListState;
...
@property (nonatomic,copy) NSString * guestListState;                //@synthesize guestListState=_guestListState - In the implementation block
...
-(NSString *)actorId;
-(NSString *)guestListState;
-(void)setGuestListState:(NSString *)arg1 ;
