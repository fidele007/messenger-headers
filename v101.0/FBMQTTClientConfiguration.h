...
-(id)initWithClientID:(id)arg1 regionPreference:(id)arg2 socketConfig:(id)arg3 clientType:(id)arg4 connectionMergeHost:(id)arg5 connectionMergeHostCname:(id)arg6 appID:(id)arg7 ;
