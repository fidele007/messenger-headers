...
@class FBProviderMapData, MNMessageLiveLocationConfigManager, FBUserSession, MNMessageLiveLocationThreadSummaryManager, MNUserSessionObservingCenter, MNPendingThreadRequestListeningAnnouncer, NSString;
