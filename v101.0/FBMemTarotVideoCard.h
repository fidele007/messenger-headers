...
#import <Messenger/FBQueriedTarotCardFieldsProtocol.h>

@interface FBMemTarotVideoCard : FBWildeMemModelObject <FBQueriedEntityFieldsProtocol, FBQueriedNodeFieldsProtocol, FBQueriedTarotCardFieldsProtocol>
@end
