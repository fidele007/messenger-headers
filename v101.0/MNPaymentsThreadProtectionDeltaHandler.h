...
@class FBPaymentsPINController, NSString;

@interface MNPaymentsThreadProtectionDeltaHandler : NSObject <FBPaymentsPeerToPeerSPDeltaHandler> {
...
-(id)initWithPinController:(id)arg1 ;
-(long long)type;
@end
