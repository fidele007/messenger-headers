...
#import <Messenger/MNCYMKContactAdditionListening.h>

@protocol MNViewModelUpdating;
@class NSString;

@interface MNCYMKViewModelUpdateMonitor : NSObject <MNViewModelUpdateMonitoring, MNCYMKContactAdditionListening> {
...
-(void)didAddContactForUserWithUserId:(id)arg1 ;
