...
@class MKMapView, MNMessageLiveLocationTrayMapViewModel, UIButton, CLLocation, MNLocationPickerMapGestureRecognizer, NSMutableSet, FBImageDownloader, MNMessageLiveLocationConfigManager, NSString;
...
-(void)_staticLocationButtonTapped:(id)arg1 ;
-(void)_downloadIconForLargeMapCollapseButton;
-(void)_largeMapCollapseButtonTapped:(id)arg1 ;
