...
@class MNAttachmentStyleRendererManager, MNAttachmentViewCachedFactory, NSString;

@interface MNVStackedAttachmentViewFactory : NSObject <FBViewerContextClassProvidable, MNAttachmentStyleViewFactory> {
