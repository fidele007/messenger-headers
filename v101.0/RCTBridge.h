...
@class NSURL, NSDictionary, RCTPerformanceLogger, NSLock, RCTImageLoader, RCTImageStoreManager, RCTNetworking, RCTAccessibilityManager, RCTDevMenu, RCTRedBox, RCTUIManager, NSArray, NSString;
