...
-(void)send360AnalyticsEvent:(id)arg1 forModule:(id)arg2 surface:(id)arg3 photoId:(id)arg4 ;
...
-(void)send360AnalyticsEvent:(id)arg1 forModule:(id)arg2 extra:(id)arg3 ;
-(void)send360AnalyticsEvent:(id)arg1 forModule:(id)arg2 composerSessionId:(id)arg3 ;
