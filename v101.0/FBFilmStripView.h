...
@interface FBFilmStripView : UIView <FBVideoFilmstripViewDataSource, FBVideoFilmstripViewDelegate> {
	...
	SCD_Struct_FB34 _videoTimeRange;
	double _videoAspect;
...
-(double)xPositionForTime:(SCD_Struct_FB33)arg1 inView:(id)arg2 ;
...
-(SCD_Struct_FB34)timeRangeForRect:(CGRect)arg1 ;
-(SCD_Struct_FB34)timeRangeOnScreen;
