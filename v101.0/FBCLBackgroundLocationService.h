...
@class FBCLEventChannel, FBCLLocationCache, NSArray, FBCLLocationUpdaterDecider, FBUserSession, FBCLTickEventSource, FBCLPermissionManager, FBBackgroundTaskHandler, FBCLLocationLogger, FBCLLocationUpdateListenerAnnouncer, FBScenePath, FBLocationGraphRequestFactory, FBCLLocationServiceSettingDataController, FBWifiMonitor, FBBatteryMonitor, FBCLLocationUpdateSender, NSString;
