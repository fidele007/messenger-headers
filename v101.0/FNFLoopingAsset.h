...
@interface FNFLoopingAsset : NSObject <AVAsynchronousKeyValueLoading, FNFAVAsset, FNFAVPlayerItem, FNFAssetForPlayer> {
	...
	SCD_Struct_FB33 _videoRealDuration;
...
@property (nonatomic,readonly) SCD_Struct_FB33 videoRealDuration;                                                                                                              //@synthesize videoRealDuration=_videoRealDuration - In the implementation block
...
-(SCD_Struct_FB33)videoRealDuration;
-(void)dealloc;
