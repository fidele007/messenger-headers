...
@class FBLocalContactsSearch, FBLocalGroupsSearch, FBServerContactsSearch, FBServerGroupsSearch, FBServerPagesSearch, FBServerVcEndpointsSearch, FBBlendedSearch, FBAddressBookContactsSearch, FBContactSearchQuery, FBAnalytics, NSString;
...
@interface FBCombinedContactsSearch : NSObject <FBContactsSearch, FBContactsSearchDelegate, FBClassProvidable> {
	...
	FBServerVcEndpointsSearch* _serverVcEndpointsSearch;
...
-(id)initWithServerContactsSearch:(id)arg1 localContactsSearch:(id)arg2 groupSearch:(id)arg3 localGroupSearch:(id)arg4 serverPagesSearch:(id)arg5 serverVcEndpointsSearch:(id)arg6 blendedSearch:(id)arg7 adressBookContactsSearch:(id)arg8 ;
