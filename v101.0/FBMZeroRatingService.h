...
@class ZRNetworkActivityDestroyer, FBMZeroRatingServiceInjector, NSString;

@interface FBMZeroRatingService : NSObject <FBClassInjectable, MNServiceControllable> {

	ZRNetworkActivityDestroyer* _zeroRatingNetworkActivityDestroyer;
	FBMZeroRatingServiceInjector* _injector;
