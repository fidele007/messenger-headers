...
@property (nonatomic,copy) NSString * eventCreateTime;                                      //@synthesize eventCreateTime=_eventCreateTime - In the implementation block
...
-(NSString *)eventCreateTime;
-(void)setEventCreateTime:(NSString *)arg1 ;
