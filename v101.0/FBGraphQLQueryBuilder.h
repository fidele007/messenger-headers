...
@class FBGraphQLQueryConfiguration, NSString, NSMutableDictionary, NSMutableSet;
...
+(void)initialize;
-(id)getResult;
-(id)handleWithService:(id)arg1 updateCallback:(/*^block*/id)arg2 failureCallback:(/*^block*/id)arg3 callbackQueue:(id)arg4 ;
...
-(shared_ptr<facebook::graphql::GraphQLQuery>*)buildOSSQuery;
-(id)configuration;
@end
