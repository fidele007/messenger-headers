...
@interface FBMobileConfigContextImpl : NSObject <FBMobileConfigContext> {
	...
	shared_ptr<mobileconfig::FBMobileConfigMmapHandleBase>* _config;
...
-(shared_ptr<mobileconfig::FBMobileConfigMmapHandleBase>*)getConfig;
...
-(BOOL)getBool:(unsigned long long)arg1 fromConfig:(shared_ptr<mobileconfig::FBMobileConfigMmapHandleBase>*)arg2 withDefault:(BOOL)arg3 ;
...
-(long long)getInt64:(unsigned long long)arg1 fromConfig:(shared_ptr<mobileconfig::FBMobileConfigMmapHandleBase>*)arg2 withDefault:(long long)arg3 ;
-(BOOL)hasIntOverrideForParam:(unsigned long long)arg1 ;
-(id)getString:(unsigned long long)arg1 fromConfig:(shared_ptr<mobileconfig::FBMobileConfigMmapHandleBase>*)arg2 withDefault:(id)arg3 ;
-(BOOL)hasStringOverrideForParam:(unsigned long long)arg1 ;
-(double)getDouble:(unsigned long long)arg1 fromConfig:(shared_ptr<mobileconfig::FBMobileConfigMmapHandleBase>*)arg2 withDefault:(double)arg3 ;
-(BOOL)hasDoubleOverrideForParam:(unsigned long long)arg1 ;
-(void)logConfigsIfNeeded;
-(id)initWithHandle:(shared_ptr<mobileconfig::FBMobileConfigMmapHandleBase>*)arg1 withConfigManager:(weak_ptr<mobileconfig::IFBMobileConfigManager>*)arg2 shadowRateLimiter:(shared_ptr<mobileconfig::FBRateLimiter<unsigned long long> >*)arg3 overrides:(shared_ptr<mobileconfig::FBMobileConfigOverridesTable>*)arg4 ;
