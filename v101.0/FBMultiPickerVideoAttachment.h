...
@interface FBMultiPickerVideoAttachment : NSObject <FBVideoAttachmentProtocol, NSCoding, NSCopying> {
	...
	NSURL* _trimmedURL;
	SCD_Struct_FB350 _editsValue;
	FBUFIButtonsComponentViewContextOptions _allowEditingValue;
...
@property (nonatomic,readonly) SCD_Struct_FB33 duration; 
...
-(void)exportVideoDataWithProgress:(/*^block*/id)arg1 completion:(/*^block*/id)arg2 baseURL:(id)arg3 videoExportConfig:(id)arg4 errorSimulation:(id)arg5 timeRange:(SCD_Struct_FB34)arg6 ;
...
-(CGSize)assetSize;
-(void)_exportVideoDataWithProgress:(/*^block*/id)arg1 completion:(/*^block*/id)arg2 fileURL:(id)arg3 videoExportConfig:(id)arg4 errorSimulation:(id)arg5 timeRange:(SCD_Struct_FB34)arg6 ;
