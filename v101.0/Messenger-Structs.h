...
@class NSString, UIColor, UIView<FBLoadingView>, UIView, UICollectionViewFlowLayout, <FBListViewKitScrollEventListener>, NSDictionary, <FBDisplayableMediaViewProvider>, NSMutableDictionary, FBNativeArticleController, FBMemModelObject<FBQueriedNodeFieldsProtocol>, NSError, CKComponent, FBInlineVoiceSwitcherViewModel, FBUFITheme, FBConnectionPageLoadLimits, UIImage, FBScenePath, NSArray, <FBWebImageViewLayoutDelegate>, FBDisplayableMediaViewProviderContext, CAMediaTimingFunction, FBVideoAssetEdits, FBVideoExportConfig, AVAssetReader, AVAssetTrack, AVAssetReaderOutput, AVAssetWriterInput, AVAssetWriter, NSURL, CKComponentScopeRoot, <NSObject>, UIFont, FBImageDownloader, NSAttributedString, NSCharacterSet, <NSLayoutManagerDelegate>, <MNServiceControllable>, NSURLRequest, NSData, FBRtmpSession, FBAACEncoder, <FBVideoEncoder>, FBAACPacketizer, FBH264Packetizer, FBDiskVideoRecorder, NSObject<OS_dispatch_queue>, AVAssetWriterInputPixelBufferAdaptor, FBSectionComponent, <FBComponentChangesetWriter>, NSNumber;
...
typedef union GLKMatrix4 {
	SCD_Struct_FB30 field1;
	float m[16];
} GLKMatrix4;

typedef struct {
	SCD_Struct_FB29 field1;
	SCD_Struct_FB29 field2;
} SCD_Struct_FB32;
...
typedef union GLKQuaternion {
	SCD_Struct_FB79 field1;
	SCD_Struct_FB80 field2;
	float q[4];
} GLKQuaternion;
...
typedef struct shared_ptr<facebook::multiway::RTCConferenceCall> {
	RTCConferenceCall __ptr_;
	__shared_weak_count __cntrl_;
} shared_ptr<facebook::multiway::RTCConferenceCall>;
...
typedef struct {
	SCD_Struct_FB337 top;
	SCD_Struct_FB337 left;
	SCD_Struct_FB337 bottom;
	SCD_Struct_FB337 right;
} SCD_Struct_FB338;
...
typedef union GLKVector2 {
	SCD_Struct_FB344 field1;
	SCD_Struct_FB344 field2;
	float v[2];
} GLKVector2;
...
typedef const struct shared_ptr<facebook::graphql::GraphQLService>* shared_ptr<facebook::graphql::GraphQLService>Ref;
...
typedef struct {
	SCD_Struct_AS406 field1;
	SCD_Struct_AS406 field2;
} SCD_Struct_AS407;
...
typedef struct shared_ptr<facebook::graphql::GraphQLConsistency> {
	GraphQLConsistency __ptr_;
	__shared_weak_count __cntrl_;
} shared_ptr<facebook::graphql::GraphQLConsistency>;
...
typedef struct shared_ptr<facebook::mobile::xplat::executor::DispatchQueueExecutor> {
	DispatchQueueExecutor __ptr_;
	__shared_weak_count __cntrl_;
} shared_ptr<facebook::mobile::xplat::executor::DispatchQueueExecutor>;
...
typedef struct shared_ptr<mobileconfig::FBMobileConfigMmapHandleBase> {
	FBMobileConfigMmapHandleBase __ptr_;
	__shared_weak_count __cntrl_;
} shared_ptr<mobileconfig::FBMobileConfigMmapHandleBase>;
...
typedef struct shared_ptr<compactdisk::experimental::Transform> {
	Transform __ptr_;
	__shared_weak_count __cntrl_;
} shared_ptr<compactdisk::experimental::Transform>;
...
typedef struct DiskCacheConfig {
	...
	shared_ptr<compactdisk::experimental::Transform> transform_;
} DiskCacheConfig;
...
typedef struct shared_ptr<facebook::mobile::xplat::executor::SerialExecutor> {
	SerialExecutor __ptr_;
	__shared_weak_count __cntrl_;
} shared_ptr<facebook::mobile::xplat::executor::SerialExecutor>;

typedef struct _compressed_pair<(anonymous namespace)::BatchStuff *, std::__1::default_delete<(anonymous namespace)::BatchStuff> > {
	BatchStuff __first_;
} compressed_pair<(anonymous namespace)::BatchStuff *, std::__1::default_delete<(anonymous namespace)::BatchStuff> >;

typedef struct unique_ptr<(anonymous namespace)::BatchStuff, std::__1::default_delete<(anonymous namespace)::BatchStuff> > {
	compressed_pair<(anonymous namespace)::BatchStuff *, std::__1::default_delete<(anonymous namespace)::BatchStuff> > __ptr_;
} unique_ptr<(anonymous namespace)::BatchStuff, std::__1::default_delete<(anonymous namespace)::BatchStuff> >;

typedef const struct shared_ptr<facebook::graphql::GraphQLQuery>* shared_ptr<facebook::graphql::GraphQLQuery>Ref;

typedef struct shared_ptr<facebook::mobile::graphstore::ServiceToken> {
	ServiceToken __ptr_;
	__shared_weak_count __cntrl_;
} shared_ptr<facebook::mobile::graphstore::ServiceToken>;
...
typedef struct Optional<glm::detail::tmat4x4<float> > {
	StorageTriviallyDestructible storage_;
} Optional<glm::detail::tmat4x4<float> >;
...
typedef struct {
	...
	FBAudioStreamingConfig audioConfig;
	FBVideoStreamingConfig videoConfig;
	SCD_Struct_FB878 networkConfig;
	FBHScrollComponentAlpha throughputMonitorConfig;
	FBAdaptiveBitrateConfig adaptiveBitrateConfig;
	SCD_Struct_FB910 maxBitrateConfig;
	SCD_Struct_FB911 diskRecordingConfig;
	BOOL recordOnDisk;
...
typedef struct {
	...
	F field4;
	BOOL field5;
	FBHScrollComponentAlpha field6;
	...
	SCD_Struct_FB878 field24;
	SCD_Struct_FB910 field25;
	SCD_Struct_FB911 field26;
	BOOL field27;
	int field28;
	BOOL field29;
} SCD_Struct_FB924;
...
typedef struct {
	SCD_Struct_FB33 field1;
	SCD_Struct_FB33 field2;
	SCD_Struct_FB33 field3;
} SCD_Struct_FB942;
...
typedef struct FNFPlayerState {
	...
	SCD_Struct_FB33 latestEnqueuedVideoPts;
	SCD_Struct_FB33 latestEnqueuedAudioPts;
	SCD_Struct_FB33 latestEnqueuedAudioDts;
	...
	SCD_Struct_FB33 backgroundPauseTime;
...
typedef struct _compressed_pair<CKComponentControllerAnimationData *, std::__1::default_delete<CKComponentControllerAnimationData> > {
	CKComponentControllerAnimationData __first_;
