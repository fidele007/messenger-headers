...
@class NSMutableDictionary, NSDictionary, UICollectionView, UICollectionViewFlowLayout, FBWebRTCSession, FBUserSession, MNUserStore, FBExperimentManager, MNCDNProfileImageDownloader, FBWebRTCCallButtonImageProvider, MNTooltipOverlayController, FBNuxTooltip, FBTimer, NSString;
...
-(id)initWithImageDownloader:(id)arg1 callButtonImageProvider:(id)arg2 userSession:(id)arg3 userStore:(id)arg4 experimentManager:(id)arg5 avatarImageDecoration:(id)arg6 presenceSubscriptionService:(id)arg7 isVideoConference:(BOOL)arg8 ;
