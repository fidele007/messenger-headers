...
@class NSObject, FBVideoNetworkerLogger, FBScenePath, FBVideoPrefetchManager, NSMutableData, NSSet, NSURL, NSString, NSMutableArray, FBNetworkerRangeRequest;
...
@interface FBVideoDownloader : NSObject <FBNetworkerRequestDelegate> {
	...
	SCD_Struct_FB251 _videoBasicData;
	...
	BOOL _bypassLigerForLive;
	BOOL _makeLiveRequestsHiPri;
	BOOL _pushOnDebugLog;
...
-(id)initWithURL:(id)arg1 prefetchURL:(id)arg2 dataKey:(id)arg3 videoID:(id)arg4 blockDataCache:(id)arg5 queue:(id)arg6 networker:(id)arg7 logger:(id)arg8 scenePath:(id)arg9 priority:(long long)arg10 experimentManager:(id)arg11 mobileConfigManager:(id)arg12 prefetchManager:(id)arg13 limitRequestLength:(BOOL)arg14 bypassCaching:(BOOL)arg15 enablePrefetchLookupWhenBypassCache:(BOOL)arg16 isAudio:(BOOL)arg17 analyticsTags:(id)arg18 ;
