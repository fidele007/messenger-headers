...
@interface FBVideoEditingViewController : UIViewController <FBVideoTrimViewDelegate, FBVideoEditingPlaybackViewDelegate, FBVideoVolumeControlViewDelegate, FBAudioSessionManagerClient, UIScrollViewDelegate, FBVideoCreativeToolsApplier, FBVideoFilterViewsUpdateProtocol, FBVideoScrubberViewDelegate> {
	...
	SCD_Struct_FB33 _videoMinLength;
	SCD_Struct_FB33 _videoMaxLength;
	SCD_Struct_FB33 _frameOffset;
	SCD_Struct_FB33 _keyTime;
...
@property (assign,nonatomic) SCD_Struct_FB33 keyTime;                                                                     //@synthesize keyTime=_keyTime - In the implementation block
...
@property (assign,nonatomic) SCD_Struct_FB33 frameOffset;                                                                 //@synthesize frameOffset=_frameOffset - In the implementation block
...
@property (assign,nonatomic) SCD_Struct_FB33 videoMinLength;                                                              //@synthesize videoMinLength=_videoMinLength - In the implementation block
@property (assign,nonatomic) SCD_Struct_FB33 videoMaxLength;                                                              //@synthesize videoMaxLength=_videoMaxLength - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_FB33 videoPosition; 
...
-(id)filterView;
-(void)setVideoMinLength:(SCD_Struct_FB33)arg1 ;
...
-(void)setKeyTime:(SCD_Struct_FB33)arg1 ;
-(SCD_Struct_FB33)keyTime;
-(void)setFrameOffset:(SCD_Struct_FB33)arg1 ;
...
-(SCD_Struct_FB33)videoMinLength;
-(SCD_Struct_FB33)videoMaxLength;
-(void)setVideoMaxLength:(SCD_Struct_FB33)arg1 ;
...
-(void)_trimValueChanged:(id)arg1 autoplay:(BOOL)arg2 fromScrubTime:(SCD_Struct_FB33)arg3 ;
...
-(void)_continuePlayingAfterUserInteractionFromScrubTime:(SCD_Struct_FB33)arg1 ;
-(void)_handleAudioChange:(BOOL)arg1 ;
-(void)playbackView:(id)arg1 didPlayToTime:(SCD_Struct_FB33)arg2 ;
