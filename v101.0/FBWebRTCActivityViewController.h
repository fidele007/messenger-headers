...
@class FBWebRTCSession, FBWebRTCActivityView, FBWebRTCAudioClipController, NSString;

@interface FBWebRTCActivityViewController : UIViewController <FBWebRTCAudioClipControllerDelegate, FBWebRTCActivityViewDelegate> {
