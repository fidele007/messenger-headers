...
@class FBLazyCreator, MNMontageCameraTooltipAutoHideHandler, MNMontageCameraVideoTooltipConfiguration, MNSoundController, FBTimer, FBUserSession, MNMontageCameraState, MNMontageCameraStateListenerAnnouncer, NSTimer, MNCameraDeviceCyclingController, MNCameraPermissionsLogger, MNCameraCapturedPhoto, MNCameraCapturedVideo, FBCameraRollWriter, MNMontageCaptureInteractionController, NSString;
