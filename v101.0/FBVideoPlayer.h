...
@property (assign,nonatomic) SCD_Struct_FB33 seekTime;                                   //@synthesize seekTime=_seekTime - In the implementation block
@property (nonatomic,retain) AVAsset * asset;                                            //@synthesize asset=_asset - In the implementation block
@property (nonatomic,readonly) double progress; 
@property (assign,nonatomic) SCD_Struct_FB33 startTime;                                  //@synthesize startTime=_startTime - In the implementation block
@property (assign,nonatomic) SCD_Struct_FB33 endTime; 
@property (nonatomic,readonly) SCD_Struct_FB33 currentTime; 
...
-(void)loadBufferAtItemTime:(SCD_Struct_FB33)arg1 ;
-(void)playFromTime:(SCD_Struct_FB33)arg1 ;
...
-(void)setStartTime:(SCD_Struct_FB33)arg1 ;
-(void)stop;
-(void)setDisplayLink:(CADisplayLink *)arg1 ;
-(CADisplayLink *)displayLink;
-(double)progress;
-(AVAsset *)asset;
-(SCD_Struct_FB33)startTime;
-(void)setAsset:(AVAsset *)arg1 ;
-(void)outputMediaDataWillChange:(id)arg1 ;
-(SCD_Struct_FB33)endTime;
-(void)setEndTime:(SCD_Struct_FB33)arg1 ;
...
-(SCD_Struct_FB33)seekTime;
-(AVPlayer *)player;
-(void)setPlayerItem:(AVPlayerItem *)arg1 ;
-(void)setSeekTime:(SCD_Struct_FB33)arg1 ;
-(BOOL)isMuted;
