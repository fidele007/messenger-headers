...
@class MNPendingRequestsStore, NSObject, NSString;

@interface MNInboxMessageRequestUnitViewModelLoader : NSObject <MNSingleViewModelLoading, MNViewModelUpdateMonitoring, MNPendingRequestsStoreListener> {
...
-(id)initWithPendingRequestsStore:(id)arg1 queue:(id)arg2 ;
-(void)_applyUpdate;
