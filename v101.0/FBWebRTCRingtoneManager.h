...
@class FBWebRTCEngine, FBRingingAudioSession, FBWebRTCCallModel, FBExperimentManager, FBMobileConfigContextManager, NSTimer, FBWebRTCInCallSoundEffect, NSString;
...
-(id)initWithExperimentManager:(id)arg1 configManager:(id)arg2 ringOnIncomingCall:(BOOL)arg3 ;
