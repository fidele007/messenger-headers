...
-(void)setCurrentElement:(id)arg1 withAnimation:(SCD_Struct_FB73)arg2 ;
...
-(void)_animateToSelectedElementCenterX:(double)arg1 withConfiguration:(SCD_Struct_FB73)arg2 completionBlock:(/*^block*/id)arg3 ;
