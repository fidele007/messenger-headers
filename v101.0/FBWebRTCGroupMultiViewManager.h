...
@class FBWebRTCEngine, FBWebRTCVideoView, FBWebRTCGroupMultiView, FBWebRTCGroupMultiViewModel, MNCDNProfileImageDownloader, MNThreadParticipantNameFormatter, NSString, FBMIndexedUserSet;

@interface FBWebRTCGroupMultiViewManager : NSObject <FBWebRTCGroupMultiViewModelDelegate, UICollectionViewDelegate, UICollectionViewDataSource, FBWebRTCVideoViewDelegate, FBWebRTCGroupMultiViewDelegate, FBWebRTCSessionListener> {
...
-(BOOL)_shouldShowLiveThumbnailForOtherParticipantsCount:(unsigned long long)arg1 ;
...
-(void)updateForCallModel:(id)arg1 ;
