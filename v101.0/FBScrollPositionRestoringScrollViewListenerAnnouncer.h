...
#import <Messenger/FBScrollPositionRestoringScrollViewListener.h>

@class NSString;

@interface FBScrollPositionRestoringScrollViewListenerAnnouncer : FBAnnouncerBase <FBScrollPositionRestoringScrollViewListener>
