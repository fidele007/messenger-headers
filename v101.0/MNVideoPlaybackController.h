...
@interface MNVideoPlaybackController : NSObject <FBAudioSessionManagerClient, MNVideoControllerProtocol> {
	...
	BOOL _muted;
	SCD_Struct_FB33 _startPosition;
	NSString* _videoID;
	NSURL* _videoURL;
...
@property (nonatomic,readonly) SCD_Struct_FB33 currentPlaybackTime; 
@property (nonatomic,readonly) SCD_Struct_FB33 duration;                               //@synthesize duration=_duration - In the implementation block
...
-(void)loadAssetResourcesAndPlay:(id)arg1 videoID:(id)arg2 startPosition:(SCD_Struct_FB33)arg3 ;
-(NSString *)videoID;
-(void)resumeFromPosition:(SCD_Struct_FB33)arg1 ;
...
-(NSURL *)videoURL;
-(BOOL)isPreparing;
-(void)_seekToTime:(SCD_Struct_FB33)arg1 ;
-(id)player;
-(SCD_Struct_FB33)currentPlaybackTime;
