...
@class FBProviderMapData, FBUserSession, FBMobileConfigContextManager, NSString;

@interface MNDiscoverySurfaceCoordinatorInjector : NSObject <FBViewerContextInjecting> {
