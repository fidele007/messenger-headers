...
@interface FNFPlayerLayer : CAEAGLLayer <FNFDecompressionSessionDelegate, FNFPlayerDisplayEngine, FNFAVPlayerLayer> {
	...
	SCD_Struct_FB33 _bufferTimes[60];
...
-(id)initWithConfigs:(SCD_Struct_FN974)arg1 ;
...
-(void)_addBuffer:(CVBufferRef)arg1 presentationTimeStamp:(SCD_Struct_FB33)arg2 iFrameEnqueued:(unsigned long long)arg3 ;
-(void)display:(CVBufferRef)arg1 presentationTimeStamp:(SCD_Struct_FB33)arg2 presentationDuration:(SCD_Struct_FB33)arg3 iFrameEnqueued:(unsigned long long)arg4 ;
...
-(BOOL)flushIfError;
-(void)yieldDecompressedBuffer:(CVBufferRef)arg1 presentationTimeStamp:(SCD_Struct_FB33)arg2 presentationDuration:(SCD_Struct_FB33)arg3 ;
