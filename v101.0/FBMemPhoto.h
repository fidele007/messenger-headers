...
-(id)shareableType;
-(BOOL)hasTiledCubemapEncodings;
-(id)tiledCubemapEncodingForSize:(unsigned long long)arg1 ;
-(BOOL)_hasEncodingsForProjectionType:(id)arg1 ;
-(id)_encodingForProjectionType:(id)arg1 size:(unsigned long long)arg2 ;
-(id)shareableText;
-(id)shareableTitle;
