...
@interface FBMemExternalUrl : FBWildeMemModelObject <FBQueriedEntityFieldsProtocol, FBQueriedNodeFieldsProtocol, FBQueriedSavableFieldsProtocol, FBQueriedSearchCombinedResultFieldsProtocol, FBQueriedSearchResultFieldsProtocol, FBQueriedSearchableFieldsProtocol>
@end
