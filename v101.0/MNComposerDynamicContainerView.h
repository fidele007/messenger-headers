...
@class MNNuxView, MNComposerContentViewPresenter, MNComposerBar, MNComposerConfiguration, MNComposerMoreDrawerBouncingAnimator, MNComposerMoreDrawerBouncingView, UIView, NSString, MNComposerTooltipView, MNComposerExtensionSegmentedControlView, UIPanGestureRecognizer, NSSet, MNComposerActionView;
