...
-(void)_produceData:(opaqueCMSampleBufferRef)arg1 presentationTime:(SCD_Struct_FB33)arg2 ;
-(void)_loadBufferAtItemTime:(SCD_Struct_FB33)arg1 frameDuration:(double)arg2 ;
-(void)_produceSampleBufferForPixelBuffer:(CVBufferRef)arg1 timingInfo:(SCD_Struct_FB942)arg2 ;
