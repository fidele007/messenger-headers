...
-(BOOL)isBannerAtTop;
-(id)initWithProcessPoolContainer:(id)arg1 frame:(CGRect)arg2 analytics:(id)arg3 alertHandler:(id)arg4 optimizeForBackgroundProcessing:(BOOL)arg5 enableAutomaticMediaPlayback:(BOOL)arg6 ;
