...
@property (nonatomic,copy,readonly) NSString * otherPersonName;                     //@synthesize otherPersonName=_otherPersonName - In the implementation block
-(NSString *)lightweightActionType;
-(NSString *)otherPersonName;
-(NSString *)lightweightActionState;
-(id)initWithLightweightActionType:(id)arg1 lightweightActionState:(id)arg2 otherPersonName:(id)arg3 ;
