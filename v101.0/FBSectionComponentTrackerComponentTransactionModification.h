...
@interface FBSectionComponentTrackerComponentTransactionModification : NSObject <FBSectionComponentTrackerStateModifying> {

	/*^block*/id _transactionBlock;
...
-(id)initWithTransactionBlock:(/*^block*/id)arg1 ;
