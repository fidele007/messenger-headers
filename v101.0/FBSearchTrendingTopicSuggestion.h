...
-(id)initWithText:(id)arg1 fbid:(id)arg2 semantic:(id)arg3 imageURLString:(id)arg4 relatedArticleTitle:(id)arg5 suggestionTypeText:(id)arg6 trendingTopicsQueryID:(id)arg7 uniqueKeyword:(id)arg8 contextPhotoURL:(id)arg9 isLive:(BOOL)arg10 numberOfLines:(unsigned long long)arg11 isProminent:(BOOL)arg12 tracking:(id)arg13 ;
