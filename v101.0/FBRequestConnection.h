...
#import <Messenger/FBURLConnectionDelegate.h>
#import <Messenger/FBRequestConnectionRetryManagerDelegate.h>
...
+(id)startForPlacesSearchAtCoordinate:(CLLocationCoordinate2D)arg1 radiusInMeters:(long long)arg2 resultsLimit:(long long)arg3 searchText:(id)arg4 completionHandler:(/*^block*/id)arg5 ;
