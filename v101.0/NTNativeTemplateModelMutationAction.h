...
@class NTNativeTemplateBaseContext, NSString, NSArray;

@interface NTNativeTemplateModelMutationAction : NSObject <NTAction> {

	NTNativeTemplateBaseContext* _context;
	NSString* _targetID;
	NSArray* _replacementChildren;
	NSString* _style;
