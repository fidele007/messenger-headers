...
@interface FBMemTaggedMediaOfFamilyMemberMediaSet : FBWildeMemModelObject <FBQueriedEntityFieldsProtocol, FBQueriedMediaSetFieldsProtocol, FBQueriedNodeFieldsProtocol>
-(id)canViewerEdit;
