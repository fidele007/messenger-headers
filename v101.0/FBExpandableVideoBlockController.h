...
-(void)interactiveMediaController:(id)arg1 willAnimateToKeyFrame:(id)arg2 interactionMode:(long long)arg3 previousInteractionMode:(long long)arg4 withAnimation:(SCD_Struct_FB73)arg5 ;
...
-(void)_setAnnotationsVisible:(BOOL)arg1 withAnimationConfiguration:(SCD_Struct_FB73)arg2 ;
...
-(void)_showLoadingIndicatorWithAnimationConfiguration:(SCD_Struct_FB73)arg1 ;
-(SCD_Struct_FB73)_fadeAnimationConfiguration;
-(double)_fadeDuration;
-(void)_didFadeOutAudio;
-(void)_logVideoPlayerFormatChangeFromPreviousPlayerSource:(unsigned long long)arg1 videoPlayerInitiationReason:(unsigned long long)arg2 ;
...
-(void)_hideLoadingIndicatorWithAnimationConfiguration:(SCD_Struct_FB73)arg1 ;
