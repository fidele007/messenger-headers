...
-(id)initWithDelegate:(id)arg1 clientSettings:(id)arg2 connParams:(id)arg3 clientFactory:(MQTTClientFactory*)arg4 dispatcher:(id)arg5 byteAggregator:(id)arg6 analyticsLogBlock:(/*^block*/id)arg7 foreground:(BOOL)arg8 ;
