...
#import <Messenger/MNMediaFilterAssetManagerProviding.h>

@class NSString;

@interface MNBlockMediaFilterAssetManagerProvider : NSObject <MNMediaFilterAssetManagerProviding> {
...
-(id)filterAssetManagerForMediaFilterDescriptor:(id)arg1 ;
-(id)providerBlock;
@end
