...
@protocol MNPeoplePickerSearchBarViewControllerDelegate, MNPeoplePickerSearchBarViewControllerActionButtonDelegate, MNPeoplePickerSearchBarViewControllerSearchBarDataSource;
@class MNPeoplePickerSearchBarView, NSMutableArray, UIView, MNPeopleCellActionButtonsStateCoordinator, MNPeoplePickerSearchBarViewControllerInjector, NSString;

@interface MNPeoplePickerSearchBarViewController : FBContainerViewController <MNPeoplePickerSearchBarViewDelegate, MNPeopleSuggestionsViewControllerDelegate, MNPeopleSearchViewControllerDelegate, MNPeopleSearchResultsDataSourceDelegate, MNPeopleSearchResultsDataSourceActionButtonDataSource, UISearchBarDelegate, MNPeopleCellActionButtonsStateCoordinatorListener> {
	...
	MNPeoplePickerSearchBarViewControllerInjector* _injector;
