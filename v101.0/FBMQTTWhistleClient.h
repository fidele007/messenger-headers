...
@class FBMQTTClientParameter, NSMutableDictionary, FBWhistleAdaptor, FBWhistleAdaptorFactory, FBMQTTClientSettings, FBMQTTClientByteAggregator, NSObject, NSString;
