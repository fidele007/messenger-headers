...
-(void)hideWithPopAnimationWithCompletion:(/*^block*/id)arg1 ;
-(void)_animateWhiteLayerViewOpacityToState:(unsigned long long)arg1 withCompletion:(/*^block*/id)arg2 ;
-(void)animateContextMenuAndReactionsBubbleToState:(unsigned long long)arg1 withCompletion:(/*^block*/id)arg2 ;
-(void)_showPopAnimationViewWithCompletion:(/*^block*/id)arg1 ;
-(void)_setReactionButton:(id)arg1 state:(unsigned long long)arg2 ;
-(void)_animateContexMenuAndCellToState:(unsigned long long)arg1 ;
...
-(id)initWithReactions:(id)arg1 contextMenuViewModel:(id)arg2 frame:(CGRect)arg3 ;
