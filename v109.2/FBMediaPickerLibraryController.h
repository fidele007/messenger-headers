...
@class FBMediaPickerSession, NSMutableDictionary, UICollectionView, FBMagicStoriesPreviewViewController, FBKVOController, UIView, FBPinchGestureRecognizer, FBAnimationPerformanceLogger, FBMagicStoryPickerCollectionDataSource, FBMediaPickerThumbnailDownloaderFactory, UILabel, FBScrollViewVideoCoordinator, NSMutableArray, FBCache, NSMutableSet, UIImage, FBLibraryThumbnailView, FBAssetsRankedDataSource, NSArray, NSString;
