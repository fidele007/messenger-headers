...
#import <Messenger/FBSwipeNavigationControllerInteractor.h>

@class FBSwipeNavigationController, UIPercentDrivenInteractiveTransition, FBDirectionalPanGestureRecognizer, UIView, NSString;

@interface FBSwipeNavigationControllerFullScreenInteractor : NSObject <UIViewControllerAnimatedTransitioning, FBSwipeNavigationControllerInteractor> {
