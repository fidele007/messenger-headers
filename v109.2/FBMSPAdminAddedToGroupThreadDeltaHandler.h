...
@interface FBMSPAdminAddedToGroupThreadDeltaHandler : NSObject <FBViewerContextClassProvidable, MNMessagesSyncIrisDeltaProcessing> {
...
-(void)_processAdminAddedDelta:(id)arg1 completion:(/*^block*/id)arg2 ;
