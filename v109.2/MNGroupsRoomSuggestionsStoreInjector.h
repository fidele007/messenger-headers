...
@class FBProviderMapData, FBUserSession, MNUserSettings, FBMobileConfigContextManager, NSString;

@interface MNGroupsRoomSuggestionsStoreInjector : NSObject <FBInjecting> {
