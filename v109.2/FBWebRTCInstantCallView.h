...
@interface FBWebRTCInstantCallView : UIView <VideoRenderInfoDelegate, FBWebRTCButtonPanelDelegate, FBWebRTCVideoViewDelegate, FBWebRTCStarRatingPresentingView> {
...
-(id)getExpressionIconName:(long long)arg1 ;
-(void)_redialTapped;
-(void)_dismissTapped;
...
-(void)setVoicemailDurationVisible:(BOOL)arg1 animated:(BOOL)arg2 ;
