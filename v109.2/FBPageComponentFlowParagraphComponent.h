...
@class FBMemParagraphScreenElement, FBPageComponentFlowComponentContext;

@interface FBPageComponentFlowParagraphComponent : CKCompositeComponent {

	FBMemParagraphScreenElement* _model;
	FBPageComponentFlowComponentContext* _context;

}
+(id)newWithModel:(id)arg1 context:(id)arg2 ;
-(void)didTapParagraph:(id)arg1 ;
@end
