...
@interface FBProfileDiscoveryIntentMutationData : FBGraphQLInput {

	NSString* _clientMutationId;
	NSString* _actorId;
	NSString* _profileId;
	NSString* _intentType;
	NSString* _initialIntentStatus;
...
@property (nonatomic,copy) NSString * initialIntentStatus;              //@synthesize initialIntentStatus=_initialIntentStatus - In the implementation block
-(NSString *)initialIntentStatus;
-(void)setInitialIntentStatus:(NSString *)arg1 ;
