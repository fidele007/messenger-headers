...
@interface FBFilmStripView : UIView <FBVideoFilmstripViewDataSource, FBVideoFilmstripViewDelegate> {
	...
	SCD_Struct_FB44 _videoTimeRange;
	double _videoAspect;
...
-(double)xPositionForTime:(SCD_Struct_FB43)arg1 inView:(id)arg2 ;
...
-(SCD_Struct_FB44)timeRangeForRect:(CGRect)arg1 ;
-(SCD_Struct_FB44)timeRangeOnScreen;
