...
@interface FBBrowserExtensionAutofillGroupTelephone : NSObject <FBBrowserExtensionAutofillGroup> {
...
-(BOOL)_joinStringIfNonEmpty:(id)arg1 withNothingToBaseString:(id)arg2 ;
