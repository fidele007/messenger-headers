...
@protocol MNAvatarImageDecorating, MNPresenceSubscribing, MNViewPreviewingHandling, FBWebRTCMessageThreadNavigator, FBWebRTCCallLogDetailViewControllerDelegate;
...
-(id)initWithAvatarImageDecoration:(id)arg1 dateFormatter:(id)arg2 callButtonImageProvider:(id)arg3 profileImageViewController:(id)arg4 threadImageManager:(id)arg5 callStarter:(id)arg6 audioCache:(id)arg7 webAudioManager:(id)arg8 presenceSubscription:(id)arg9 tableViewPreviewingHandler:(id)arg10 messageThreadNavigator:(id)arg11 ;
