...
@protocol FBPublishingBackgroundTaskScheduler;
@class NSMutableSet, NSString;

@interface FBPublishingBackgroundTaskTracker : NSObject <FBComposerPublisherStatusListener> {

	NSMutableSet* _currentlyPublishingPublicationIdentifiers;
	id<FBPublishingBackgroundTaskScheduler> _scheduler;
