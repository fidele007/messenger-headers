...
-(id)initWithAllowTagging:(BOOL)arg1 allowFaceDetection:(BOOL)arg2 maxPhotosSelected:(unsigned long long)arg3 requireSquarePhoto:(BOOL)arg4 allowFullScreenPhotoViewing:(BOOL)arg5 allowPhotoEditing:(BOOL)arg6 cpuFiltersEnabled:(BOOL)arg7 autoNavigationEnabled:(BOOL)arg8 longPressToBringUpGalleryView:(BOOL)arg9 postSelectionAction:(unsigned long long)arg10 actionButtonTitle:(id)arg11 maxVideoLength:(unsigned long long)arg12 maxVideoSize:(unsigned long long)arg13 stickersAllowed:(BOOL)arg14 textOnPhotosAllowed:(BOOL)arg15 doodlesOnPhotosAllowed:(BOOL)arg16 canSelectMultiplePhotosAndVideos:(BOOL)arg17 canShowMovies:(BOOL)arg18 minVideoResolution:(CGSize)arg19 allowVideoAutoplay:(BOOL)arg20 forceShowingCheckMarkForThumbnails:(BOOL)arg21 showPreviewForPhotoAfterCamera:(BOOL)arg22 hasMediaAttachmentsNotIncludedInMediaPicker:(BOOL)arg23 allowProductTagging:(BOOL)arg24 allowVideoEditing:(BOOL)arg25 lightWeightCropEnabled:(BOOL)arg26 canShowMagicStories:(BOOL)arg27 livePhotoAllowed:(BOOL)arg28 tapToBringUpGalleryView:(BOOL)arg29 initialToolForMediaGallery:(unsigned long long)arg30 forceHighQualityVideo:(BOOL)arg31 showCropAfterSelectingPhoto:(BOOL)arg32 allowFixedCropFrameForMediaGallery:(BOOL)arg33 showCropAfterCamera:(BOOL)arg34 showPreviewForVideoAfterCamera:(BOOL)arg35 analyticsSource:(id)arg36 usePushNavigationForCamera:(BOOL)arg37 capturePosition:(long long)arg38 support360Video:(BOOL)arg39 annotate360Photos:(BOOL)arg40 supports360Photos:(BOOL)arg41 supportsAnimatedGIFs:(BOOL)arg42 switchIconsForCameraButton:(BOOL)arg43 infinitelyLoopingIconsForCameraButton:(BOOL)arg44 multiSelectEnabled:(BOOL)arg45 showBackButton:(BOOL)arg46 shouldUseProfilePictureAsLoggerSource:(BOOL)arg47 ;
