...
#import <FBSharedFramework/MNMessageSendConversionContextAwareController.h>
...
@property (nonatomic,retain,readonly) MNMessageSendConversionLoggerManager * loggerManager;              //@synthesize loggerManager=_loggerManager - In the implementation block
...
-(MNMessageSendConversionLoggerManager *)loggerManager;
