...
@class NSString, MNTextAndAttachmentForwardContent, FBMSyncedThreadKey, NSArray, MNMediaPreviewActionSheetViewController, MNMediaPreviewActionSheetConfiguration, MNPhotoEditingPresenter, MNImageRequester;
