...
@interface MNThreadDetailsActionsController : NSObject <FBClassInjectable, MNThreadMutePickerDelegate, UIAlertViewDelegate, MNThreadMembersUpdaterDelegate, MNThreadPhotoEditControllerDelegate, MNThreadCustomizationModalPickerControllerDelegate, MNEphemeralMessageLifeTimePickerDelegate, MNThreadEphemeralitySetterDelegate, MNThreadDetailsSecureCodenameEditControllerDelegate, MNBookingRequestsViewControllerDelegate, MNThreadDetailsViewControllerDelegate, MNThreadDetailsContactViewControllerDelegate> {
