...
@class FBVideoProcessorFilterConfig, AVAsset, IGImageFilter, IGSurfaceView, UIImage, FBVideoPlayer, IGRenderer, NSString;
...
@property (assign,nonatomic) SCD_Struct_FB43 startTime; 
...
-(void)videoPlayerDidLoadPixelBuffer:(CVBufferRef)arg1 withTime:(SCD_Struct_FB43)arg2 ;
-(void)playFromStart;
