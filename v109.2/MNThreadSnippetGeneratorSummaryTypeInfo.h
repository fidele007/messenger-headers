...
@interface MNThreadSnippetGeneratorSummaryTypeInfo : NSObject <NSCopying> {
	...
	FBStringWithRedactedDescription* _groupMention_customName;
	BOOL _groupMention_attributeGroup;
	FBMThreadParticipationInfo* _nonGroup_otherUserParticipantInfo;
	BOOL _nonGroup_attributeUserText;

}
+(id)groupMentionWithCustomName:(id)arg1 attributeGroup:(BOOL)arg2 ;
...
-(void)matchGroup:(/*^block*/id)arg1 groupMention:(/*^block*/id)arg2 nonGroup:(/*^block*/id)arg3 ;
