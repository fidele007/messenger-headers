...
-(id)initWithBufferHandler:(id)arg1 sessionQueue:(id)arg2 useStandaloneAudioSession:(BOOL)arg3 ignoreHighPriorityClientNotification:(BOOL)arg4 automaticallyConfiguresApplicationAudioSession:(BOOL)arg5 ;
