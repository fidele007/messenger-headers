...
@interface FBFlowStateMutation : FBGraphQLInput {
...
@property (nonatomic,copy) NSNumber * operation;              //@synthesize operation=_operation - In the implementation block
...
-(NSNumber *)operation;
-(void)setOperation:(NSNumber *)arg1 ;
-(NSString *)key;
-(NSString *)value;
