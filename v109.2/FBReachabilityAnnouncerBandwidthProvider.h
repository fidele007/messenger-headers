...
#import <Messenger/FNFBandwidthProvider.h>

@class FBReachabilityAnnouncer;

@interface FBReachabilityAnnouncerBandwidthProvider : NSObject <FNFBandwidthProvider> {

	FBReachabilityAnnouncer* _delegate;
