...
@property (nonatomic,copy) NSArray * addedTags;                             //@synthesize addedTags=_addedTags - In the implementation block
@property (nonatomic,copy) NSArray * removedTags;                           //@synthesize removedTags=_removedTags - In the implementation block
...
-(NSArray *)addedTags;
-(void)setAddedTags:(NSArray *)arg1 ;
-(NSArray *)removedTags;
-(void)setRemovedTags:(NSArray *)arg1 ;
