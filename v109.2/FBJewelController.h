...
@interface FBJewelController : NSObject <FBNotificationsMQTTListener, FBAppService> {
	...
	FBJewelManager* _instagramNotificationsJewelManager;
	BOOL _running;
	...
	BOOL _instagramNotificationsBadgingEnabled;
...
@property (assign,nonatomic) BOOL instagramNotificationsBadgingEnabled;                                 //@synthesize instagramNotificationsBadgingEnabled=_instagramNotificationsBadgingEnabled - In the implementation block
...
@property (nonatomic,readonly) unsigned long long instagramNotificationsVisibleBadgeCount; 
...
@property (nonatomic,readonly) FBJewelManager * instagramNotificationsJewelManager;                     //@synthesize instagramNotificationsJewelManager=_instagramNotificationsJewelManager - In the implementation block
...
-(void)setInstagramNotificationsJewelBadgeCount:(unsigned long long)arg1 ;
...
-(void)clearInstagramNotificationsJewelBadgeCount;
-(void)_instagramNotificationsBadgingDidEnable;
-(void)_instagramNotificationsBadgingDidDisable;
-(void)clearFriendJewelBadgeCount;
-(void)setMessagesBadgingEnabled:(BOOL)arg1 ;
-(void)setVideoHomeBadgingEnabled:(BOOL)arg1 ;
-(void)setInstagramNotificationsBadgingEnabled:(BOOL)arg1 ;
...
-(long long)_instagramNotificationsBadgeValue;
...
-(BOOL)instagramNotificationsBadgingEnabled;
...
-(FBJewelManager *)instagramNotificationsJewelManager;
