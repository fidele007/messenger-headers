...
@protocol FBCaptureCameraControllerFBCaptureSessionController, MNProfilePicturePreviewDataSourceDelegate;
@class UIImage, MNCameraPreviewLayerWrapperView, UITapGestureRecognizer, FBCameraFocusIndicator, NSString;
