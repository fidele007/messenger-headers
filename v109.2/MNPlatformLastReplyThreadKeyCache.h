...
@interface MNPlatformLastReplyThreadKeyCache : NSObject <FBViewerContextClassProvidable> {
...
-(id)lastReplyThreadKeyForAppId:(id)arg1 ;
-(void)setLastReplyThreadKey:(id)arg1 forAppId:(id)arg2 ;
