...
@interface MNNavigationCoordinator : NSObject <UITabBarControllerDelegate, UINavigationControllerDelegate, UISplitViewControllerDelegate, UIPopoverControllerDelegate, FBPopoverControllerDelegate, MNSettingsViewControllerDelegate, MNActionSheetViewControllerDelegate, FBWebRTCCallTabViewControllerDelegate, MNMontageComposerStackViewControllerDelegate, FBViewerContextClassProvidable, MNAlertControllerPresenting, MNMinimizableModalsPresentation, MNModalPresentation, MNViewControllerNavigation, MNConfirmationViewPresenting, MNApplicationRootViewControllerGetting, MNMontageComposerPresenting, MNMontageComposerTooltipPresenting, MNMainTabPresentation> {
	...
	MNBotsViewController* _botsViewController;
...
-(BOOL)isViewingInbox;
-(id)initWithStackViewControllerProvider:(id)arg1 tabBarControllerProvider:(id)arg2 userSettings:(id)arg3 session:(id)arg4 inboxTabViewControllerProvider:(id)arg5 inboxNavigationHandlerProvider:(id)arg6 inboxTabBadgeUpdater:(id)arg7 groupsTabManagerProvider:(id)arg8 gameHubViewControllerProvider:(id)arg9 peopleTabViewControllerProvider:(id)arg10 meTabViewControllerProvider:(id)arg11 callTabViewControllerProvider:(id)arg12 discoveryTabViewControllerProvider:(id)arg13 montageComposerStackViewControllerProvider:(id)arg14 globalToastNavigationStack:(id)arg15 keyboardResettingTracker:(id)arg16 navigationAnnouncer:(id)arg17 recentTabConfiguration:(id)arg18 peopleTabConfiguration:(id)arg19 tabsConfiguration:(id)arg20 appThemeConfiguration:(id)arg21 tabBarIconDecorator:(id)arg22 splitViewPlaceholderConfiguration:(id)arg23 splitViewControllerProvider:(id)arg24 settingsTabNameConfiguration:(id)arg25 botsViewController:(id)arg26 activityTabViewControllerProvider:(id)arg27 montageStackedComposerEnabled:(BOOL)arg28 keyboardAwareContainerEnabled:(BOOL)arg29 topTabInboxVariantEnabled:(BOOL)arg30 scrollAwayNavigationBarEnabled:(BOOL)arg31 ;
