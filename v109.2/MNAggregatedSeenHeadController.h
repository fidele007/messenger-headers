...
@class MNAggregatedSeenHeadView, NSString;

@interface MNAggregatedSeenHeadController : NSObject <MNMessageCellElementController> {

	MNAggregatedSeenHeadView* _aggregatedSeenHeadView;
