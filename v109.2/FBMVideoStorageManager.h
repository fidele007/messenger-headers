...
@protocol OS_dispatch_queue, MNSecureVideoRequesting;
@class FBUserSession, NSObject, FBMessageVideoStorageProvider, FBPreferences, MNAppMessageAttachmentUtils, FBMMessageSendListeningAnnouncer, NSString;
...
@interface FBMVideoStorageManager : NSObject <FBViewerContextClassProvidable, FBMMessageSendListening, MNVideoUploadListener> {
	...
	FBMessageVideoStorageProvider* _storageProvider;
