...
@class FBProviderMapData, FBUserSession, MNUserStore, NSString;

@interface MNMessageReactionsDetailViewControllerInjector : NSObject <FBInjecting> {
...
-(id)nonCachedListViewController;
