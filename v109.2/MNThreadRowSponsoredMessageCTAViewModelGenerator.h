...
@class FBMobileConfigContextManager, MNBusinessCTAFactory, NSString;

@interface MNThreadRowSponsoredMessageCTAViewModelGenerator : NSObject <FBClassProvidable, MNThreadRowCTAViewModelGenerating> {
