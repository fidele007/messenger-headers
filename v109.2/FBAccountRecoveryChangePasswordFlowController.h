...
#import <Messenger/FBAccountRecoveryChangePasswordFlowControlling.h>
...
@class FBAccountRecoveryFlowData, NSString;

@interface FBAccountRecoveryChangePasswordFlowController : NSObject <FBAccountRecoveryChangePasswordFlowControlling, FBAuthRecoveryControlling> {
...
-(void)didContinueWithUserID:(id)arg1 password:(id)arg2 ;
