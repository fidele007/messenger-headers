...
@class FBUserSession, MNThreadViewModel, NSArray, MNBotComposerViewModel, MNMessageSendNotEligibleAlertController, MNMessageSendService, FBKeyboardObserver, MNBotComposerUserInvalidatorManager, MNBusinessCTAFactory, FBMobileConfigContextManager, MNBotComposerLocationPickerCoordinator, FBMMessageSendConversionLoggingService, MNBotComposerViewController, MNMessageSendConversionContext, NSString;
