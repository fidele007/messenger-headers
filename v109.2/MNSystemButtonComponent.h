...
@interface MNSystemButtonComponent : CKComponent
+(id)newWithButtonOptions:(MNSystemButtonOptions)arg1 action:(const CKTypedComponentAction<UIEvent *>*)arg2 size:(const CKComponentSize*)arg3 attributes:(const unordered_map<CKComponentViewAttribute, CKBoxedValue, std::__1::hash<CKComponentViewAttribute>, std::__1::equal_to<CKComponentViewAttribute>, std::__1::allocator<std::__1::pair<const CKComponentViewAttribute, CKBoxedValue> > >*)arg4 accessibilityConfiguration:(CKButtonComponentAccessibilityConfiguration)arg5 ;
@end
