...
@interface FBMSPRTCCallDataDeltaHandler : NSObject <FBViewerContextClassProvidable, MNMessagesSyncIrisDeltaProcessing> {
...
-(void)_processCallData:(id)arg1 completion:(/*^block*/id)arg2 ;
