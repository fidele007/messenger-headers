...
@class FBMemDocumentFontResource, FBFontResource, NSString;

@interface FBDocumentFontResourceAdapter : NSObject <FBViewModelAdapter> {

	FBMemDocumentFontResource* _documentFontResource;
...
-(id)initWithDocumentFontResource:(id)arg1 ;
-(id)viewModel;
@end
