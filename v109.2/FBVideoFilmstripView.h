...
@interface FBVideoFilmstripView : UIScrollView <FBVideoFilmstripViewGeometryDelegate, FBVideoFilmstripFrameViewDelegate, UIScrollViewDelegate, FBVideoFilmstripThumbnailStoreSource, FBVideoFilmstripScrubGestureRecognizerDelegate> {
	...
	SCD_Struct_FB672 _scrollState;
	SCD_Struct_FB673 _filmDelegateMethods;
...
-(SCD_Struct_FB44)timeRangeForBounds;
-(SCD_Struct_FB44)timeRangeForRect:(CGRect)arg1 ;
-(double)xPositionForTime:(SCD_Struct_FB43)arg1 ;
...
-(BOOL)_computeTimesForHorizontalPoints:(const double*)arg1 count:(unsigned long long)arg2 into:(SCD_Struct_FB43*)arg3 ;
-(double)effectivePointsPerSecond;
-(void)_recycleStripFrameViews;
-(SCD_Struct_FB43)_scrubberTimeForGestureRecognizer:(id)arg1 ;
