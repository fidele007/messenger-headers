...
@class FBUserSession, FBMobileConfigContextManager, MNMessageSendNotEligibleAlertController, MNMessageSendService, MNBotComposerUserInvalidatorManager, MNBusinessCTAFactory, MNBotComposerLocationPickerCoordinator, MNThreadViewModel, NSArray, FBMMessageSendConversionLoggingService, MNBotComposerQuickRepliesViewController, MNMessageSendConversionContext, NSString;
