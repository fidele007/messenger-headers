...
-(void)processMediaItemWithUploadSettings:(SCD_Struct_FB71)arg1 completion:(/*^block*/id)arg2 ;
...
-(void)encodeVideoAndContinueWithSettings:(SCD_Struct_FB71)arg1 ;
...
-(void)_encodeUsingTranscoderWithProgressBlock:(/*^block*/id)arg1 segmentCompletionBlock:(/*^block*/id)arg2 completionBlock:(/*^block*/id)arg3 outputURL:(id)arg4 settings:(SCD_Struct_FB71)arg5 ;
