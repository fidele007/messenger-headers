...
-(void)detectFacesWithScenePath:(id)arg1 shouldStartFaceRecognition:(BOOL)arg2 faceDetectionCompletion:(/*^block*/id)arg3 ;
...
-(void)_startRecognize:(id)arg1 withFaceboxesEdges:(id)arg2 ;
