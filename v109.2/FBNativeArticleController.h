...
@class NSArray, FBUserSession, FBNativeArticleDisplayConfiguration, FBNativeArticlePreloadCoordinator, FBRichStoryBlockControllerRegistry, FBNativeArticleInteractionRegistry, FBNativeArticleResourceBundle, FBNativeArticleTransitionDriver, FBNativeArticleTransitionCache, NSMutableDictionary, FBNativeArticlePreloadHandler, FBReusePoolController, FBNAPinnedOverlayController, FBAnimationPerformanceLogger, FBNativeArticleBlockVPVLogger, FBNABlockBasedScrollDepthTracker, FBNativeArticleRendererController, ASDisplayNode, FBRichStoryViewModel, NSString, FBNativeArticleScrollHandler, FBNativeArticleScrollView, FBRichStoryRendererController, NSDictionary;
...
@interface FBNativeArticleController : NSObject <FBAnalyticsTrackingCodesDataSource, FBDescribable, FBModalPresentationSource, FBNativeArticleOrientationSwitch, FBNativeArticlePopoverHostingViewProvider, FBNativeArticlePreloadHandlerDelegate, FBNativeArticleScrollHandlerDelegate, FBNativeArticleScrollViewGestureHandling, FBNativeArticleTransitionDriverDelegate, _FBNativeArticleScrollNodeDelegate, FBNativeArticleTransitionLayoutGenerator, FBNAPinnedOverlayControllerDelegate, FBNANavigationCoordinatorProvider, UIScrollViewDelegate, FBRichStoryRendererControllerDelegate, FBCardVisibility, FBIntentHandler> {
	...
	SCD_Struct_FB54 _delegateMethods;

}

@property (assign,nonatomic) SCD_Struct_FB54 delegateMethods;                                    //@synthesize delegateMethods=_delegateMethods - In the implementation block
...
-(void)setDelegateMethods:(SCD_Struct_FB54)arg1 ;
...
-(SCD_Struct_MN14)_transitioningBlockControllerMethodsForBlock:(id)arg1 ;
...
-(SCD_Struct_FB54)delegateMethods;
...
-(void)transitionDriver:(id)arg1 willFinishTransitionToPresentationAttributes:(id)arg2 forStoryBlock:(id)arg3 animationConfiguration:(SCD_Struct_FB51)arg4 ;
