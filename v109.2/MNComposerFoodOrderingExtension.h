...
@class MNComposerFoodOrderingExtensionInjector, NSString;

@interface MNComposerFoodOrderingExtension : MNAbstractComposerTrayExtension <FBClassInjectable> {

	MNComposerFoodOrderingExtensionInjector* _injector;
