...
@class MNBadgeCountUpdateService, NSString;

@interface MNBadgeCountDebugReporterService : NSObject <MNServiceControllable> {
...
-(id)initWithBadgeCountUpdateService:(id)arg1 ;
-(void)handleIdle;
-(void)stop;
-(void)start:(id)arg1 ;
@end
