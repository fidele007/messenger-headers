...
@interface MNViewPreviewingHandler : NSObject <FBClassInjectable, MNPhotoPreviewViewControllerDelegate, MNVideoPreviewViewControllerDelegate, MNSaveAttachmentListener, MNProfilePreviewViewControllerDelegate, MNLinkPreviewViewControllerDelegate, MNStickerPreviewViewControllerDelegate, MNThreadPreviewViewControllerDelegate, MNViewPreviewingHandling, FBClassProvidable> {
