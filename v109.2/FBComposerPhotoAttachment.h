...
@property (nonatomic,readonly) id<FBPhotoAttachmentProtocol> attachment;              //@synthesize attachment=_attachment - In the implementation block
...
-(id<FBPhotoAttachmentProtocol>)attachment;
@end
