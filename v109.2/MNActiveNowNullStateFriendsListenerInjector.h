...
@class FBProviderMapData, MNUserStore, FBMobileConfigContextManager, NSString;

@interface MNActiveNowNullStateFriendsListenerInjector : NSObject <FBViewerContextInjecting> {
...
-(id)nonCachedPresenceSubscriptionService;
