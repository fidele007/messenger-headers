...
@interface MNPaymentsPagesCommerceCheckoutConfirmationConfiguration : NSObject <FBPaymentsCheckoutConfirmationConfiguration> {
...
-(id)initWithSession:(id)arg1 paymentMethod:(id)arg2 ;
@end
