...
@class NSObject, FBBackgroundingAnnouncer, FBMBackgroundDataProcessingEventDispatcher, FBMQTTExperiments, FBUserSession, NSUserDefaults, MNActiveParticipantMQTTPublisher, UIApplication, NSNotificationCenter, NSArray, FBMMQTTSender, MNOnlineStatusManager, MNMQTTSender, MNOnlineStatusMQTTSender, FBMobileConfigContextManager, MNSyncProtocolPublisher, MNMessagingRegionProvider, NSString;
