...
@class FBProviderMapData, FBUserSession, FBMobileConfigContextManager, MNThreadParticipantNameFormatter, NSString;

@interface MNGroupChatUserBannerCoordinatorInjector : NSObject <FBInjecting> {
