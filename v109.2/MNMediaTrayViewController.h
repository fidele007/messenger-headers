...
@class MNMediaTrayView, MNMediaTraySelectedImageGenerator, MNMediaTrayVisibilityListeningAnnouncer, MNPermissionsViewController, MNLocalAssetAccessibilityLabelGenerator, FBAssetsLibrary, NSString, NSIndexPath, MNMediaTrayConfiguration, FBViewStateDebouncer, NSArray, NSDate;
...
-(void)_setSelectionStyleForCell:(id)arg1 ;
