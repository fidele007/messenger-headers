...
@class NSString, FBComposerEntryPointAnalyticsContext, NSDictionary, FBPublishingAnalyticsPayload;
...
-(id)initWithSourceType:(id)arg1 contentOrigin:(id)arg2 entryPointAnalyticsContext:(id)arg3 composerEntryPicker:(id)arg4 extraDataToIncludeInInitEvent:(id)arg5 extraDataToIncludeInPostEvent:(id)arg6 extraDataToIncludeInCancelEvent:(id)arg7 publishingAnalyticsPayload:(id)arg8 ;
