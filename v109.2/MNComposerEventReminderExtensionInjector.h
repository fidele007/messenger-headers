...
@class FBProviderMapData, MNEventsReminderActionHandler, FBMobileConfigContextManager, NSString;

@interface MNComposerEventReminderExtensionInjector : NSObject <FBInjecting> {
