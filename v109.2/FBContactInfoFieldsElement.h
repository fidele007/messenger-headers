...
@class NSString, FBContactInfoFieldsElementFields;

@interface FBContactInfoFieldsElement : FBGraphQLInput {

	NSString* _formFieldId;
	NSString* _disableAutofill;
	FBContactInfoFieldsElementFields* _value;
...
@property (nonatomic,copy) FBContactInfoFieldsElementFields * value;              //@synthesize value=_value - In the implementation block
...
-(FBContactInfoFieldsElementFields *)value;
-(void)setValue:(FBContactInfoFieldsElementFields *)arg1 ;
@end
