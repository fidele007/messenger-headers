...
@class FBUserSession, FBRichStoryBlockDisplayContext, FBSphericalVideoGuidedTour, FB360MediaContainerNode, FB360VideoPlayerNode, FB360VideoControlsOverlayNode, NSTimer, FBTimer, FB360VideoOverlayController, FBDeviceOrientationSensor, FBSphericalVideoGuidedTourKeyframe, NSString;
...
@interface FB360VideoBlockController : FBNA360MediaBlockController <FB360VideoPlayerNodeDelegate, FBNativeArticleVideoScrubberDelegate, FBDeviceOrientationSensorDelegate, FBAudioSessionManagerClient> {
	...
	BOOL _guideModeEnabled;
	FBDeviceOrientationSensor* _deviceOrientationSensor;
	FBSphericalVideoGuidedTourKeyframe* _currentGuideKeyFrame;
...
@property (assign,nonatomic) BOOL guideModeEnabled;                                                  //@synthesize guideModeEnabled=_guideModeEnabled - In the implementation block
@property (nonatomic,retain) FBSphericalVideoGuidedTourKeyframe * currentGuideKeyFrame;              //@synthesize currentGuideKeyFrame=_currentGuideKeyFrame - In the implementation block
...
-(BOOL)guideModeEnabled;
-(void)setGuideModeEnabled:(BOOL)arg1 ;
...
-(void)setCurrentGuideKeyFrame:(FBSphericalVideoGuidedTourKeyframe *)arg1 ;
...
-(FBSphericalVideoGuidedTourKeyframe *)currentGuideKeyFrame;
