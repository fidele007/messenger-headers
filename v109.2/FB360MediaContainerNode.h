...
-(void)setControlsOrientation:(long long)arg1 withAnimationConfig:(SCD_Struct_FB51)arg2 ;
-(void)willTransitionToSize:(CGSize)arg1 withAnimationConfig:(SCD_Struct_FB51)arg2 ;
