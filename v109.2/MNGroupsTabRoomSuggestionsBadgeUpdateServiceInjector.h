...
@class FBProviderMapData, MNGroupsRoomsModelController, MNNavigationCoordinator, MNUserSettings, FBMobileConfigContextManager, NSString;

@interface MNGroupsTabRoomSuggestionsBadgeUpdateServiceInjector : NSObject <FBInjecting> {
