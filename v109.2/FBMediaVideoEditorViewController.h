...
#import <Messenger/FBVideoPickThumbnailViewControllerDelegate.h>
...
@interface FBMediaVideoEditorViewController : UINavigationController <FBVideoEditingViewControllerDelegate, FBCancellableVideoEditingViewControllerDelegate, FBVideoPickThumbnailViewControllerDelegate, FBMediaViewControllerProtocol> {
...
@property (assign,nonatomic) SCD_Struct_FB43 videoMinLength; 
@property (assign,nonatomic) SCD_Struct_FB43 videoMaxLength; 
...
-(void)videoPickThumbnailViewControllerFinished:(id)arg1 withEdits:(id)arg2 isCancelled:(BOOL)arg3 ;
