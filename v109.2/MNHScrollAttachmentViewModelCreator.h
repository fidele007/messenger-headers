...
@class MNAttachmentStyleRendererManager, NSString;

@interface MNHScrollAttachmentViewModelCreator : NSObject <FBViewerContextClassProvidable, MNAttachmentStyleViewModelCreator> {
