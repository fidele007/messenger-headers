...
@class FBMemHeadingScreenElement, FBPageComponentFlowComponentContext;

@interface FBPageComponentFlowHeadingComponent : CKCompositeComponent {

	FBMemHeadingScreenElement* _model;
	FBPageComponentFlowComponentContext* _context;

}
+(id)newWithModel:(id)arg1 context:(id)arg2 ;
-(void)didTapHeading:(id)arg1 ;
@end
