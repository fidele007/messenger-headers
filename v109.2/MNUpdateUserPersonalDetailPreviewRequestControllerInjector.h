...
@class FBProviderMapData, FBUserSession, FBAnalytics, NSString;

@interface MNUpdateUserPersonalDetailPreviewRequestControllerInjector : NSObject <FBViewerContextInjecting> {
