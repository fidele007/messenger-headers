...
@property (assign,nonatomic) long long reactLayoutDirection;              //@synthesize reactLayoutDirection=_reactLayoutDirection - In the implementation block
