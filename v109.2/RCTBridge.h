...
#import <Messenger/RCTReloadListener.h>
#import <Messenger/RCTInvalidating.h>

@protocol RCTBridgeDelegate;
@class NSURL, NSDictionary, JSContext, RCTPerformanceLogger, NSLock, RCTImageLoader, RCTImageStoreManager, RCTNetworking, RCTAccessibilityManager, RCTDevMenu, RCTRedBox, RCTUIManager, RCTDevSettings, NSArray, NSString;
...
@property (nonatomic,__weak,readonly) JSContext * jsContext;                                //@synthesize jsContext=_jsContext - In the implementation block
