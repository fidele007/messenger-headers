...
@interface FBAnnotationDynamicSizingReactionComponent : CKComponent {

	NSArray* _reactionComponentPermutations;

}
+(id)newWithFeedback:(id)arg1 tapAction:(CKTypedComponentAction<>)arg2 session:(id)arg3 ;
