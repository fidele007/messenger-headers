...
+(id)_layoutDescriptionForAnnotationsByPosition:(id)arg1 stacks:(inout id*)arg2 presentationAttributes:(id)arg3 displayContext:(id)arg4 overlayLayout:(id)arg5 ;
