...
@required
-(Either<NSError *, FBDiskVideoRecorderDiskResults *>*)diskRecordingResult;
...
@interface FBVideoBroadcastSessionResult : NSObject <FBVideoBroadcastSessionResult> {
	...
	Either<NSError *, FBDiskVideoRecorderDiskResults *> _diskRecordingResult;
...
-(FBVideoBroadcastSessionLoggingInfo)loggingInfo;
-(id)sendEndOfStreamError;
-(id)initWithDiskRecordingResult:(Either<NSError *, FBDiskVideoRecorderDiskResults *>)arg1 sendEndOfStreamError:(id)arg2 loggingInfo:(FBVideoBroadcastSessionLoggingInfo)arg3 ;
@end
