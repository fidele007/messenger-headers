...
@class FBUserSession, FBFeedbackReactionSettingsUpdateManager, NSString;

@interface FBFeedbackReactionSettingsFetchService : NSObject <FBAppService> {

	FBUserSession* _session;
	FBFeedbackReactionSettingsUpdateManager* _updateManager;
