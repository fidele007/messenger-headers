...
@class FBUserSession, MNProfServicesPlugin, NSString;

@interface FBServicesBookingAttachmentViewFactory : NSObject <MNAttachmentStyleViewFactory, FBViewerContextClassProvidable> {

	FBUserSession* _session;
	MNProfServicesPlugin* _plugin;
	BOOL _actsAsAdmin;
