...
@class FBFallbackIntentHandler, MNPaymentsIntentHandler, MNCommerceIntentHandler, MNRideServiceIntentHandler, MNForwardMessageIntentHandler, MNQuicksilverGameIntentHandler, MNRidePromoIntentHandler, MNRideServiceLiveMapIntentHandler, MNBotsGetStartedIntentHandler, MNBrowserExtensionIntentHandler, MNInboxAdReportingIntentHandler, MNNavigationCoordinator, MNBusinessBottomSheetViewController, MNWebViewControllerShareOptionsDelegate, MNWebViewContainerController, FBUserSession, ZRTariffedUrlBoundary, ZRTariffedUxSessionManager, FBMobileConfigContextManager, MNWebViewControllerThemeConfigurer, MNAppThemeConfiguration, MNIntentHandlerConfiguration, FBAnalytics, FBMLoggedInUserInfoManager, MNInstantArticleIntentHandler, MNBrowserSurfaceProvider, MNBusinessWebShareHandler, MNBusinessShareIntentHandler, MNBusinessFavoritesIntentHandler, MNOmniMIntentHandler, MNPageComponentFlowIntentHandler, MNFBGroupIntentHandler, MNSharedPageIntentHandler, NSString;
...
-(void)_openWebViewForURL:(id)arg1 actionTriggeredTime:(double)arg2 browserDisplayHeightRatio:(double)arg3 shouldHideWebviewShareButton:(BOOL)arg4 attribution:(id)arg5 browserSurfaces:(id)arg6 ;
-(id)_webViewContainerControllerForURL:(id)arg1 shouldHideWebviewShareButton:(BOOL)arg2 ;
...
-(BOOL)_isWebViewContainerControllerEnabled;
-(id)_webViewContainerControllerForURL:(id)arg1 isModal:(BOOL)arg2 shouldHideWebviewShareButton:(BOOL)arg3 attribution:(id)arg4 browserSurfaces:(id)arg5 ;
