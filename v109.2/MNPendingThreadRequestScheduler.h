...
-(id)initWithCreateWithMessageAPIRequester:(id)arg1 createAsGroupAPIRequester:(id)arg2 createAsMontageAPIRequester:(id)arg3 threadCreatorExtensionController:(id)arg4 messageSendScheduler:(id)arg5 pendingThreadStore:(id)arg6 clock:(id)arg7 listener:(id)arg8 attachmentProgressListener:(id)arg9 queue:(id)arg10 ;
