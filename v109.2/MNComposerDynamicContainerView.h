...
@class MNNuxView, MNComposerContentViewPresenter, MNComposerBar, MNComposerMoreDrawerBouncingAnimator, MNComposerMoreDrawerBouncingView, NSMutableArray, NSString, MNComposerTooltipView, UIView, MNComposerExtensionSegmentedControlView, UIPanGestureRecognizer, NSSet, MNComposerActionView;
...
@interface MNComposerDynamicContainerView : UIView <MNComposerBarDelegate, MNComposerDismissableDelegate, MNComposerContaining, MNComposerMoreDrawerBouncing, MNComposerPrimaryExtensionViewing, MNComposerTooltipPresenting> {
	...
	BOOL _multiplePreviewsSupported;
	BOOL _showTooltips;
