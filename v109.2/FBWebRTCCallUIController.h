...
@protocol FBProvider, MNAuthenticationManager, MNAvatarImageDecorating, FBWebRTCHostApplication, FBWebRTCCallFeatureConfiguration;
@class FBExperimentManager, FBMobileConfigContextManager, FBWebRTCSession, FBWebRTCCallViewModel, FBWebRTCRingtoneManager, FBWebRTCScreenSensorCallListener, FBWebRTCKeyboardBoundsManager, FBWebRTCIncomingCallNotification, FBWebRTCEndCallInfo, MNUserSettings, FBWebRTCViewController, FBWebRTCCallStatusBarViewController, FBWebRTCInstantOverlayViewController, FBWebRTCInstantVideoAdminMessagePublisher, FBWebRTCUIDisplayCoordinator, MNThreadStore, MNUserStore, FBWebRTCUserFetch, FBWebRTCNetworkAvailability, FBWebRTCDeviceRequestFailureController, MNThreadParticipantNameFormatter, MNBatchProfileImageFetcher, FBWebRTCVideoChatHeadsUsageTracker, FBTimer, FBWebRTCCallKitManager, FBWebRTCCallRecordPublisher, FBWebRtcCampOnManager, FBWebRTCPostCallController, FBWebRTCVoicemailHandler, FBWebRTCGroupCallRingingManager, MNMessageSendService, NSString;

@interface FBWebRTCCallUIController : NSObject <FBWebRTCSessionListener, FBWebRTCViewControllerDelegate, FBWebRTCCallStatusBarViewControllerDelegate, FBWebRTCInstantOverlayViewControllerDelegate, FBWebRTCSurveyViewControllerDelegate, RTCVideoCaptureSessionListener, FBWebRTCCallKitManagerDelegate, FBWebRTCVoicemailDelegate, FBWebRTCGroupCallRingingManagerDelegate, FBWebRTCPostCallControllerDelegate, FBClassProvidable> {
	...
	MNMessageSendService* _messageSendService;
...
-(void)_sendAttachment:(id)arg1 toThreadKey:(id)arg2 ;
