...
@protocol FBIntentHandler, MNAuthenticationManager;
@class FBUserSession, MNPaymentsPaymentPlatformAttachmentActionHandler, NSString;

@interface MNPaymentsPaymentPlatformAttachmentViewFactory : NSObject <MNAttachmentStyleViewFactory, FBViewerContextClassProvidable> {
