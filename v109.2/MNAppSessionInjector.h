...
@protocol FBMAppInitializedListening, FBMAppUserSetupListening, MNAuthenticationManager;
@class FBProviderMapData, UIApplication, MNNavigationCoordinator, MNThreadNavigationCoordinator, MNUserSetUpStatePersister, MNUserSetUpFlowViewControllerProvider, FBMAppProperties, OrcaPushRegistrar, FBAPISessionStore, FBUserSession, MNAppNotificationHandler, MNUserSettings, FBMMessagingStoreRestoreStateListeningAnnouncer, MNApplicationShortcutItemHandler, FBExceptionHandler, MNAuthenticationCompletionListenerAnnouncer, MNLigerAdapter, FBMLoggedInUserFetcher, FBMLoggedInUserInfoManager, MNAppThemeConfiguration, MNUserSessionObservingCenter, NSString;
...
@interface MNAppSessionInjector : NSObject <FBViewerContextInjecting> {
	...
	FBMMessagingStoreRestoreStateListeningAnnouncer* _messagingStoreRestoreListenerAnnouncer;
...
@property (nonatomic,readonly) FBMMessagingStoreRestoreStateListeningAnnouncer * messagingStoreRestoreListenerAnnouncer;              //@synthesize messagingStoreRestoreListenerAnnouncer=_messagingStoreRestoreListenerAnnouncer - In the implementation block
...
-(FBMMessagingStoreRestoreStateListeningAnnouncer *)messagingStoreRestoreListenerAnnouncer;
