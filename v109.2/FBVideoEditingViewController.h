...
@interface FBVideoEditingViewController : UIViewController <FBVideoTrimViewDelegate, FBVideoEditingPlaybackViewDelegate, FBVideoVolumeControlViewDelegate, FBAudioSessionManagerClient, UIScrollViewDelegate, FBVideoCreativeToolsApplier, FBVideoFilterViewsUpdateProtocol, FBVideoScrubberViewDelegate> {
	...
	SCD_Struct_FB43 _videoMinLength;
	SCD_Struct_FB43 _videoMaxLength;
	SCD_Struct_FB43 _frameOffset;
	SCD_Struct_FB43 _keyTime;
...
@property (assign,nonatomic) SCD_Struct_FB43 keyTime;                                                                     //@synthesize keyTime=_keyTime - In the implementation block
...
@property (assign,nonatomic) SCD_Struct_FB43 frameOffset;                                                                 //@synthesize frameOffset=_frameOffset - In the implementation block
...
@property (assign,nonatomic) SCD_Struct_FB43 videoMinLength;                                                              //@synthesize videoMinLength=_videoMinLength - In the implementation block
@property (assign,nonatomic) SCD_Struct_FB43 videoMaxLength;                                                              //@synthesize videoMaxLength=_videoMaxLength - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_FB43 videoPosition; 
...
-(id)filterView;
-(void)setVideoMinLength:(SCD_Struct_FB43)arg1 ;
...
-(double)keyPosition;
-(void)setKeyTime:(SCD_Struct_FB43)arg1 ;
-(void)setKeyPosition:(double)arg1 ;
-(void)setFrameOffset:(SCD_Struct_FB43)arg1 ;
...
-(SCD_Struct_FB43)videoMinLength;
-(SCD_Struct_FB43)videoMaxLength;
-(void)setVideoMaxLength:(SCD_Struct_FB43)arg1 ;
...
-(void)_trimValueChanged:(id)arg1 autoplay:(BOOL)arg2 fromScrubTime:(SCD_Struct_FB43)arg3 ;
...
-(void)_continuePlayingAfterUserInteractionFromScrubTime:(SCD_Struct_FB43)arg1 ;
-(void)_handleAudioChange:(BOOL)arg1 ;
-(void)playbackView:(id)arg1 didPlayToTime:(SCD_Struct_FB43)arg2 ;
